...
theorem th0 :
  ...
  let let38 := (Not let19)
(Eq let10 let2) → (Eq let15 let14) → (Eq let19 let18) → (Eq let21 let9) → (Eq let25 let24) → (Eq let13 let5) → (Eq let27 let26) → (Eq let28 let20) → (Eq let30 let2) → (Eq let31 let4) → (Eq let14 let32) → (Eq let36 let35) → (Eq let12 let11) → (Eq let37 let2) → (Not (Eq f1 f2)) → let38 → let36 → let36 → False :=
  let let1 := (Int.ofNat 1)
  let let2 := (binrel% GE.ge f3 let1)
  let let3 := (Int.ofNat 4)
  let let4 := (binrel% HMul.hMul let3 f3)
...
have lean_s34 : let29 := by timed eqResolve lean_a17 lean_s33
