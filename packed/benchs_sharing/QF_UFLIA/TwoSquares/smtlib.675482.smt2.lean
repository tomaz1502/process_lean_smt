...
(Eq let8 let7) → (Eq let9 let5) → (Eq let7 let10) → (Eq let13 let11) → (Eq let16 let15) → (Eq let3 let2) → (Eq let20 let20) → (Eq let22 let11) → (Eq let23 let12) → (Eq let6 let21) → (Eq let19 let25) → (Eq let28 let27) → (Not (Eq f1 f2)) → let30 → let20 → False :=
  let let1 := (Int.ofNat 1)
  let let2 := (Neg.neg let1)
  let let3 := (binrel% HMul.hMul let2 let1)
  let let4 := (Int.ofNat 4)
...
have lean_s33 : let31 := by timed eqResolve lean_a14 lean_s32
