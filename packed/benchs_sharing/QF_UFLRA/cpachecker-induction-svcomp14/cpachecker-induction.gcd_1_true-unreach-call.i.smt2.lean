...
theorem th0 :
x5f211 → x5f2 → (Eq x5f7 (Rat.ofInt 0)) → (Eq x5f22 (Rat.ofInt 1)) → (Eq x5f113 gcdx5ftestx3ax3aax401) → (Eq x5f119 gcdx5ftestx3ax3atx401) → (Eq x5f203 mainx3ax3ayx401) → (Eq x5f204 (binrel% LE.le x5f22 x5f203)) → (Eq x5f205 (binrel% LE.le x5f7 x5f113)) → (Eq x5f206 (Not x5f205)) → (Eq x5f207 (Eq x5f113 x5f119)) → (Eq x5f208 (Not x5f207)) → (Eq x5f209 (And x5f206 x5f208)) → (Eq x5f210 (Not x5f209)) → (Eq x5f211 (And x5f204 x5f210)) → (Eq x5f2 False) → False :=
fun lean_a0 : x5f211 =>
fun lean_a1 : x5f2 =>
