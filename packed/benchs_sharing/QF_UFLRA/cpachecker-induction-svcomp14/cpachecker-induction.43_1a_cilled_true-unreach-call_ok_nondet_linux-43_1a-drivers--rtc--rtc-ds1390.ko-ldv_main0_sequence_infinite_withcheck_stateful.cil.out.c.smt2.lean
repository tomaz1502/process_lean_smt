...
theorem th0 :
x5f2715 → x5f2 → (Eq x5f7 (Rat.ofInt 0)) → (Eq x5f1303 mainx3ax3aldvx5fsx5fds1390x5fdriverx5fspix5fdriverx401) → (Eq x5f1304 (Eq x5f1303 x5f7)) → (Eq x5f2713 ldvx5fspinx401) → (Eq x5f2714 (Eq x5f2713 x5f7)) → (Eq x5f2715 (And x5f1304 x5f2714)) → (Eq x5f2 False) → False :=
fun lean_a0 : x5f2715 =>
fun lean_a1 : x5f2 =>
