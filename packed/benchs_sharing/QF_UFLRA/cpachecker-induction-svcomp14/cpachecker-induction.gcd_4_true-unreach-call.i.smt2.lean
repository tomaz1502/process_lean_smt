...
theorem th0 :
x5f151 → x5f2 → (Eq x5f19 (Rat.ofInt 63)) → (Eq x5f23 (Rat.ofInt 18)) → (Eq x5f147 mainx3ax3ayx401) → (Eq x5f148 (Eq x5f147 x5f23)) → (Eq x5f149 mainx3ax3axx401) → (Eq x5f150 (Eq x5f149 x5f19)) → (Eq x5f151 (And x5f148 x5f150)) → (Eq x5f2 False) → False :=
fun lean_a0 : x5f151 =>
fun lean_a1 : x5f2 =>
