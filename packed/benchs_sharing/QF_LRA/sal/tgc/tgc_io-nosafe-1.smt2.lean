...
theorem th0 :
  ...
  let let10 := (Not xx5f5)
  let let11 := (Not xx5f4)
  let let12 := (Or let11 let10)
  let let13 := (Not xx5f0)
  let let14 := (And (And let13 xx5f1) let12)
  let let15 := (Not xx5f13)
  let let16 := (Not xx5f12)
  let let17 := (Or let16 let15)
  let let18 := (Not xx5f16)
  let let19 := (And (And let18 xx5f17) let17)
  let let20 := (Or let19 let14)
  let let21 := (Eq xx5f20 xx5f21)
  let let22 := (Eq xx5f13 xx5f5)
  let let23 := (Eq xx5f12 xx5f4)
  let let24 := (And let23 let22)
  let let25 := (Rat.ofInt 0)
  let let26 := (Eq xx5f15 let25)
  let let27 := (Not xx5f14)
  let let28 := (Rat.ofInt 5)
  let let29 := (Eq xx5f31 let28)
  let let30 := (And (And (And (And (And (And let29 let27) let6) xx5f11) let26) let24) let21)
  let let31 := (binrel% HAdd.hAdd let25 xx5f6)
  let let32 := (Eq xx5f15 let31)
  let let33 := (Rat.ofInt 2)
  let let34 := (binrel% LE.le let31 let33)
  let let35 := (Or let12 let34)
  let let36 := (Rat.ofInt 1)
  let let37 := (binrel% LE.le let31 let36)
  let let38 := (Or (Or let11 xx5f5) let37)
  let let39 := (Rat.ofInt 4)
  let let40 := (Eq xx5f31 let39)
  let let41 := (And (And (And (And (And (And let40 xx5f14) let38) let35) let32) let24) let21)
  let let42 := (binrel% LT.lt let25 let36)
  let let43 := (Not let42)
  let let44 := (Rat.ofInt 3)
  let let45 := (Eq xx5f31 let44)
  let let46 := (And (And (And (And (And (And (And (And let45 let27) xx5f4) xx5f5) let43) let16) let15) let21) let26)
  let let47 := (Eq xx5f31 let33)
  let let48 := (And (And (And (And (And (And (And (And (And let47 let27) let11) xx5f5) xx5f10) let7) xx5f12) xx5f13) let26) let21)
  let let49 := (Eq xx5f31 let36)
  let let50 := (And (And (And (And (And (And (And let49 let27) xx5f4) let10) let16) xx5f13) let21) let26)
  let let51 := (Eq xx5f31 let25)
  let let52 := (And (And (And (And (And (And (And (And (And let51 let27) let11) let10) let6) let7) xx5f12) let15) let26) let21)
  let let53 := (Or (Or (Or (Or (Or let52 let50) let48) let46) let41) let30)
  let let54 := (Eq xx5f9 xx5f3)
  let let55 := (Eq xx5f8 xx5f2)
  let let56 := (And let55 let54)
  let let57 := (And let6 xx5f11)
  let let58 := (Eq xx5f19 let25)
  let let59 := (Eq xx5f28 let28)
  let let60 := (And (And (And (And (And (And let59 let27) let3) xx5f23) let58) let57) let56)
  let let61 := (Eq xx5f11 xx5f30)
  let let62 := (Eq xx5f10 xx5f29)
  let let63 := (Eq xx5f19 let31)
  let let64 := (Not xx5f3)
  let let65 := (Not xx5f2)
  let let66 := (Or (Or let65 let64) let37)
  let let67 := (Or (Or let65 xx5f3) let37)
  let let68 := (Eq xx5f28 let39)
  let let69 := (And (And (And (And (And (And (And let68 xx5f14) let67) let66) let63) let62) let61) let56)
  let let70 := (Not xx5f9)
  let let71 := (Not xx5f8)
  let let72 := (Eq xx5f28 let44)
  let let73 := (And (And (And (And (And (And (And (And let72 let27) xx5f2) xx5f3) xx5f10) let7) let71) let70) let58)
  let let74 := (Eq xx5f28 let33)
  let let75 := (And (And (And (And (And (And (And (And (And let74 let27) let65) xx5f3) xx5f22) let4) let57) xx5f8) xx5f9) let58)
  let let76 := (Eq let25 let36)
  let let77 := (Eq xx5f28 let36)
  let let78 := (And (And (And (And (And (And (And (And (And let77 let27) xx5f2) let64) let76) let6) let7) let71) xx5f9) let58)
  let let79 := (Eq xx5f28 let25)
  let let80 := (And (And (And (And (And (And (And (And (And let79 let27) let65) let64) let3) let4) let57) xx5f8) let70) let58)
  let let81 := (Or (Or (Or (Or (Or let80 let78) let75) let73) let69) let60)
  let let82 := (Eq xx5f17 xx5f1)
  let let83 := (Eq xx5f16 xx5f0)
  let let84 := (And let83 let82)
  let let85 := (And let3 xx5f23)
  let let86 := (Eq xx5f18 let25)
  let let87 := (Eq xx5f25 let28)
  let let88 := (And (And (And (And let87 let27) let86) let85) let84)
  let let89 := (Eq xx5f23 xx5f27)
  let let90 := (Eq xx5f22 xx5f26)
  let let91 := (Eq xx5f18 let31)
  let let92 := (binrel% LE.le let31 let28)
  let let93 := (Not xx5f1)
  let let94 := (Or (Or let13 let93) let92)
  let let95 := (Or (Or xx5f0 let93) let92)
  let let96 := (Or (Or let13 xx5f1) let92)
  let let97 := (Eq xx5f25 let39)
  let let98 := (And (And (And (And (And (And (And (And let97 xx5f14) let96) let95) let94) let91) let90) let89) let84)
  let let99 := (Not xx5f17)
  let let100 := (Eq xx5f25 let44)
  let let101 := (And (And (And (And (And (And (And (And let100 let27) xx5f0) xx5f1) xx5f22) let4) let18) let99) let86)
  let let102 := (Eq xx5f25 let33)
  let let103 := (And (And (And (And (And (And (And let102 let27) let13) xx5f1) let85) xx5f16) xx5f17) let86)
  let let104 := (binrel% LE.le let25 let33)
  let let105 := (Not let104)
  let let106 := (Eq xx5f25 let36)
  let let107 := (And (And (And (And (And (And (And (And let106 let27) xx5f0) let93) let105) let85) let18) xx5f17) let86)
  let let108 := (Eq xx5f25 let25)
  let let109 := (And (And (And (And (And (And (And (And let108 let27) let13) let93) let3) let4) xx5f16) let99) let86)
  let let110 := (Or (Or (Or (Or (Or let109 let107) let103) let101) let98) let88)
  let let111 := (Eq xx5f24 (smtIte xx5f14 let25 let36 Rat))
  let let112 := (binrel% LT.lt xx5f6 let25)
  let let113 := (Not let112)
  let let114 := (binrel% LT.lt xx5f7 let25)
  let let115 := (Not let114)
  let let116 := (binrel% GE.ge xx5f24 let25)
  let let117 := (binrel% LE.le xx5f24 let36)
  let let118 := (And let117 (And let116 (And let13 (And let93 (And let65 (And let64 (And let11 (And let10 (And let115 (And let113 (And let111 (And let110 (And let81 (And let53 (And let20 let9)))))))))))))))
  let let119 := (And (And (And (And (And (And (And (And (And (And (And (And (And (And (And let117 let116) (And let13 let93)) (And let65 let64)) (And let11 let10)) let115) let113) let111) let110) let81) let53) let20) let8) let5) let2) let1)
  ...
  let let124 := (And let68 (And xx5f14 (And let67 (And let66 (And let63 (And let62 (And let61 let56)))))))
  let let125 := (binrel% GE.ge xx5f6 let122)
  let let126 := (Not let125)
  let let127 := (Not let126)
  let let128 := (Or let65 (Or xx5f3 let37))
  let let129 := (Eq xx5f3 xx5f9)
  let let130 := (And let26 let21)
  let let131 := (And let51 (And let27 (And let11 (And let10 (And let6 (And let7 (And xx5f12 (And let15 let130))))))))
  let let132 := (And let21 let26)
  let let133 := (And let16 (And let15 let132))
  let let134 := (And let45 (And let27 (And xx5f4 (And xx5f5 (And False let133)))))
  let let135 := (And let59 (And let27 (And let3 (And xx5f23 (And let58 (And let6 (And xx5f11 let56)))))))
  let let136 := (And let18 (And xx5f17 let17))
  let let137 := (And xx5f17 let86)
  let let138 := (And let3 (And xx5f23 (And let18 let137)))
  let let139 := (And let106 (And let27 (And xx5f0 (And let93 (And let105 let138)))))
  let let140 := (Eq xx5f2 xx5f8)
  let let141 := (And let140 let129)
  let let142 := (And let59 (And let27 (And let3 (And xx5f23 (And let58 (And let6 (And xx5f11 let141)))))))
  let let143 := (Eq xx5f6 xx5f19)
  ...
  let let148 := (And let68 (And xx5f14 (And let147 (And let146 (And let143 (And let62 (And let61 let141)))))))
  let let149 := (And let70 let58)
  let let150 := (And let72 (And let27 (And xx5f2 (And xx5f3 (And xx5f10 (And let7 (And let71 let149)))))))
  let let151 := (And xx5f9 let58)
  let let152 := (And let74 (And let27 (And let65 (And xx5f3 (And xx5f22 (And let4 (And let6 (And xx5f11 (And xx5f8 let151)))))))))
  let let153 := (Or let152 (Or let150 (Or let148 let142)))
  let let154 := (And let79 (And let27 (And let65 (And let64 (And let3 (And let4 (And let6 (And xx5f11 (And xx5f8 let149)))))))))
  let let155 := (Or let154 let153)
  let let156 := (Or let154 (Or False let153))
  let let157 := (Eq xx5f5 xx5f13)
  let let158 := (Eq xx5f4 xx5f12)
  let let159 := (And let158 (And let157 let21))
  let let160 := (And let29 (And let27 (And let6 (And xx5f11 (And let26 let159)))))
  let let161 := (Eq xx5f6 xx5f15)
  let let162 := (binrel% GE.ge let144 (Neg.neg (Int.ofNat 2)))
  let let163 := (Or let11 (Or let10 let162))
  let let164 := (Or let11 (Or xx5f5 let145))
  let let165 := (And let40 (And xx5f14 (And let164 (And let163 (And let161 let159)))))
  let let166 := (Or let165 let160)
  let let167 := (And let47 (And let27 (And let11 (And xx5f5 (And xx5f10 (And let7 (And xx5f12 (And xx5f13 let130))))))))
  let let168 := (And let49 (And let27 (And xx5f4 (And let10 (And let16 (And xx5f13 let132))))))
  let let169 := (Or let131 (Or let168 (Or let167 let166)))
  let let170 := (Or let131 (Or let168 (Or let167 (Or False let166))))
  let let171 := (Eq xx5f6 xx5f18)
  let let172 := (Eq xx5f18 xx5f6)
  let let173 := (Eq xx5f1 xx5f17)
  let let174 := (Eq xx5f0 xx5f16)
  let let175 := (And let174 let173)
  let let176 := (And let87 (And let27 (And let86 (And let3 (And xx5f23 let175)))))
  let let177 := (binrel% GE.ge let144 (Neg.neg (Int.ofNat 5)))
  let let178 := (Or let93 let177)
  let let179 := (Or let13 let178)
  let let180 := (Or xx5f0 let178)
  let let181 := (Or let13 (Or xx5f1 let177))
  let let182 := (And let97 (And xx5f14 (And let181 (And let180 (And let179 (And let171 (And let90 (And let89 let175))))))))
  let let183 := (And let99 let86)
  let let184 := (And let100 (And let27 (And xx5f0 (And xx5f1 (And xx5f22 (And let4 (And let18 let183)))))))
  let let185 := (And let102 (And let27 (And let13 (And xx5f1 (And let3 (And xx5f23 (And xx5f16 let137)))))))
  let let186 := (Or let185 (Or let184 (Or let182 let176)))
  let let187 := (And let108 (And let27 (And let13 (And let93 (And let3 (And let4 (And xx5f16 let183)))))))
  let let188 := (Or let187 let186)
  let let189 := (Or let187 (Or False let186))
  let let190 := (Eq xx5f19 xx5f6)
  let let191 := (And let6 (And let7 (And let71 let151)))
  let let192 := (And let77 (And let27 (And xx5f2 (And let64 (And False let191)))))
  let let193 := (And let45 (And let27 (And xx5f4 (And xx5f5 (And let43 let133)))))
  let let194 := (Or let52 (Or let50 (Or let48 (Or let46 (Or let41 let30)))))
  let let195 := (And let23 (And let22 let21))
  let let196 := (And let40 (And xx5f14 (And let38 (And let35 (And let32 let195)))))
  let let197 := (Eq xx5f15 xx5f6)
  let let198 := (Not True)
  let let199 := (And let13 (And xx5f1 let12))
  let let200 := (binrel% LE.le xx5f6 let36)
  let let201 := (And let77 (And let27 (And xx5f2 (And let64 (And let76 let191)))))
  let let202 := (binrel% LE.le xx5f6 let33)
  let let203 := (Or let80 (Or let78 (Or let75 (Or let73 (Or let69 let60)))))
  let let204 := (And let87 (And let27 (And let86 (And let3 (And xx5f23 let84)))))
  let let205 := (Or let65 (Or let64 let37))
  let let206 := (Or let11 (Or xx5f5 let37))
  let let207 := (binrel% LE.le xx5f6 let28)
  let let208 := (binrel% GE.ge xx5f6 let25)
  let let209 := (Or let93 let92)
  let let210 := (Or xx5f0 let209)
  let let211 := (Or let13 let209)
  let let212 := (binrel% GE.ge xx5f7 let122)
  let let213 := (Not let212)
  let let214 := (Not let213)
  let let215 := (Or let13 (Or xx5f1 let92))
  let let216 := (And let97 (And xx5f14 (And let96 (And let95 (And let94 (And let91 (And let90 (And let89 let84))))))))
  let let217 := (And let29 (And let27 (And let6 (And xx5f11 (And let26 let195)))))
  let let218 := (And let106 (And let27 (And xx5f0 (And let93 (And False let138)))))
  let let219 := (Or let11 (Or let10 let34))
  let let220 := (Or let109 (Or let107 (Or let103 (Or let101 (Or let98 let88)))))
  let let221 := (Not let208)
  let let222 := (binrel% GE.ge xx5f7 let25)
  ...
  let let229 := (And let121 (And let123 (And let13 (And let93 (And let65 (And let64 (And let11 (And let10 (And let212 (And let125 (And let111 (And let188 (And let155 (And let169 (And let228 let9)))))))))))))))
...
(Eq let119 let118) → (Eq let117 let121) → (Eq let116 let123) → (Eq let69 let124) → (Eq let127 let125) → (Eq let67 let128) → (Eq let54 let129) → (Eq let52 let131) → (Eq let104 True) → (Eq let134 False) → (Eq let60 let135) → (Eq let19 let136) → (Eq let107 let139) → (Eq let156 let155) → (Eq let170 let169) → (Eq let172 let171) → (Eq let189 let188) → (Eq let190 let143) → (Eq let192 False) → (Eq let42 True) → (Eq let22 let157) → (Eq let103 let185) → (Eq let23 let158) → (Eq let46 let193) → (Eq let31 xx5f6) → (Eq let82 let173) → (Eq let53 let194) → (Eq let41 let196) → (Eq let197 let161) → (Eq let48 let167) → (Eq let76 False) → (Eq let50 let168) → (Eq let198 False) → (Eq let14 let199) → (Eq let200 let145) → (Eq let80 let154) → (Eq let73 let150) → (Eq let75 let152) → (Eq let78 let201) → (Eq let202 let162) → (Eq let81 let203) → (Eq let83 let174) → (Eq let55 let140) → (Eq let88 let204) → (Eq let66 let205) → (Eq let38 let206) → (Eq let207 let177) → (Eq let208 let125) → (Eq let95 let210) → (Eq let94 let211) → (Eq let214 let212) → (Eq let96 let215) → (Eq let98 let216) → (Eq let30 let217) → (Eq let101 let184) → (Eq let218 False) → (Eq let35 let219) → (Eq let109 let187) → (Eq let110 let220) → (Eq let112 let221) → (Eq let222 let212) → (Eq let114 let223) → let119 → False :=
  let let1 := (Or (Not xx5f30) (Not xx5f29))
  let let2 := (Or (Not xx5f27) (Not xx5f26))
  let let3 := (Not xx5f22)
  let let4 := (Not xx5f23)
...
fun lean_r11 : (Eq let19 let136) => -- THEORY_REWRITE_BOOL
...
fun lean_r33 : (Eq let14 let199) => -- THEORY_REWRITE_BOOL
...
fun lean_r45 : (Eq let38 let206) => -- THEORY_REWRITE_BOOL
...
have lean_s3 : (Eq let13 let13) := by timed rfl
...
have lean_s11 : (Eq let11 let11) := by timed rfl
...
have lean_s40 : (Eq let3 let3) := by timed rfl
...
have lean_s44 : (Eq let18 let18) := by timed rfl
...
have lean_s73 : (Eq let28 let28) := by timed rfl
...
have lean_s148 : (Eq let6 let6) := by timed rfl
let lean_s149 := by timed congr lean_s140 lean_s148
have lean_s150 : (Eq let7 let7) := by timed rfl
...
have lean_s180 : (Eq let36 let36) := by timed rfl
have lean_s181 : (Eq let37 let200) := by timed congr lean_s179 lean_s180
have lean_s182 : (Eq let37 let145) := by timed Eq.trans lean_s181 lean_r34
...
have lean_s257 : (Eq let16 let16) := by timed rfl
let lean_s258 := by timed congr lean_s246 lean_s257
have lean_s259 : (Eq let15 let15) := by timed rfl
let lean_s260 := by timed congr lean_s246 lean_s259
have lean_s261 : (Eq let21 let21) := by timed rfl
let lean_s262 := by timed congr lean_s246 lean_s261
have lean_s263 : (Eq let26 let26) := by timed rfl
...
have lean_s276 : (Eq let40 let40) := by timed rfl
...
have lean_s284 : (Eq let38 let164) := by timed Eq.trans lean_r45 lean_s283
...
have lean_s290 : (Eq let33 let33) := by timed rfl
have lean_s291 : (Eq let34 let202) := by timed congr lean_s289 lean_s290
have lean_s292 : (Eq let34 let162) := by timed Eq.trans lean_s291 lean_r39
let lean_s293 := by timed congr lean_s288 lean_s292
have lean_s294 : (Eq let219 let163) := by timed congr lean_s287 lean_s293
have lean_s295 : (Eq let35 let163) := by timed Eq.trans lean_r56 lean_s294
...
have lean_s299 : (Eq let32 let197) := by timed congr lean_s298 lean_r24
have lean_s300 : (Eq let32 let161) := by timed Eq.trans lean_s299 lean_r28
...
have lean_s311 : (Eq let41 let165) := by timed Eq.trans lean_r27 lean_s310
let lean_s312 := by timed congr lean_s242 lean_s311
have lean_s313 : let230 := by timed rfl
have lean_s314 : (Eq let29 let29) := by timed rfl
...
have lean_s329 : (Eq let30 let160) := by timed Eq.trans lean_r53 lean_s328
...
have lean_s339 : (Eq let20 let228) := by timed congr lean_s338 lean_r33
...
have lean_s370 : (Or let235 xx5f16) := by timed @cnfAndPos [let108, let27, let13, let93, let3, let4, xx5f16, let99, let86] 6
have lean_s371 : let229 := by timed eqResolve lean_a62 lean_s366
have lean_s372 : let228 := by andElim lean_s371, 14
have lean_s373 : (Or let227 xx5f1) := by timed @cnfAndPos [let13, xx5f1, let12] 1
...
have lean_s378 : let18 := by andElim lean_s377, 0
have lean_s379 : let235 := by R1 lean_s370, lean_s378, xx5f16, [(- 1), 0]
let lean_s380 := by R1 lean_s369, lean_s379, let187, [(- 1), 0]
have lean_s381 : (Or let234 xx5f1) := by timed @cnfAndPos [let102, let27, let13, xx5f1, let3, xx5f23, xx5f16, xx5f17, let86] 3
...
have lean_s385 : (Or let233 xx5f0) := by timed @cnfAndPos [let100, let27, xx5f0, xx5f1, xx5f22, let4, let18, let99, let86] 2
have lean_s386 : let229 := by timed eqResolve lean_a62 lean_s366
have lean_s387 : let13 := by andElim lean_s386, 2
have lean_s388 : let233 := by R1 lean_s385, lean_s387, xx5f0, [(- 1), 0]
let lean_s389 := by R1 lean_s384, lean_s388, let184, [(- 1), 0]
have lean_s390 : (Or let232 let173) := by timed @cnfAndPos [let97, xx5f14, let181, let180, let179, let171, let90, let89, let174, let173] 9
...
have lean_s396 : let226 := by R2 lean_s393, lean_s395, xx5f17, [(- 1), 0]
have lean_s397 : let232 := by R1 lean_s390, lean_s396, let173, [(- 1), 0]
let lean_s398 := by R1 lean_s389, lean_s397, let182, [(- 1), 0]
have lean_s399 : (Or let225 let173) := by timed @cnfAndPos [let87, let27, let86, let3, xx5f23, let174, let173] 6
let lean_s400 := by R1 lean_s391, lean_s392, xx5f1, [(- 1), 0]
have lean_s401 : let226 := by R2 lean_s400, lean_s395, xx5f17, [(- 1), 0]
