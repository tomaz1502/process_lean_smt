...
theorem th0 :
  ...
  let let21 := (binrel% GE.ge (binrel% HAdd.hAdd xI1 (binrel% HMul.hMul let20 x1)) let19)
  ...
  let let29 := (binrel% GE.ge (binrel% HAdd.hAdd xI2 (binrel% HMul.hMul let20 x2)) let19)
  ...
  let let34 := (binrel% GE.ge (binrel% HAdd.hAdd V (binrel% HMul.hMul let20 v2)) let19)
  let let35 := (Not let30)
  let let36 := (binrel% GE.ge (binrel% HAdd.hAdd (binrel% HMul.hMul let20 v1) V) let19)
  let let37 := (Not let33)
  let let38 := (binrel% GE.ge v1 let19)
  let let39 := (Or let14 let12)
  let let40 := (Implies let16 let39)
  let let41 := (Not let40)
  let let42 := (Not let22)
  let let43 := (Not let27)
  let let44 := (Not let32)
  let let45 := (Not let29)
  let let46 := (Not let21)
  let let47 := (And let14 (And let46 (And let12 (And let45 (And let44 (And let38 (And let36 (And let31 (And let34 (And let28 (And let43 let42)))))))))))
  let let48 := (Implies let47 let39)
  let let49 := (Not let48)
(Eq let16 let15) → (Eq let13 let18) → (Eq let17 let21) → (Eq let23 let22) → (Eq let3 let25) → (Eq let2 let26) → (Eq let24 let27) → (Eq let4 let28) → (Eq let30 let29) → (Eq let6 let31) → (Eq let33 let32) → (Eq let5 let34) → (Eq let10 let35) → (Eq let7 let36) → (Eq let9 let37) → (Eq let8 let38) → let41 → False :=
  let let1 := (Rat.ofInt 0)
  let let2 := (binrel% GT.gt ep let1)
  let let3 := (binrel% GT.gt V let1)
  let let4 := (binrel% GE.ge A let1)
...
have lean_s3 : (Eq let18 let46) := by timed flipCongrArg lean_r2 [Not]
have lean_s4 : (Eq let13 let46) := by timed Eq.trans lean_r1 lean_s3
...
have lean_s8 : (Eq let35 let45) := by timed flipCongrArg lean_r8 [Not]
have lean_s9 : (Eq let10 let45) := by timed Eq.trans lean_r12 lean_s8
let lean_s10 := by timed congr lean_s0 lean_s9
have lean_s11 : (Eq let37 let44) := by timed flipCongrArg lean_r10 [Not]
have lean_s12 : (Eq let9 let44) := by timed Eq.trans lean_r14 lean_s11
...
have lean_s19 : (Eq let25 let43) := by timed flipCongrArg lean_r6 [Not]
have lean_s20 : (Eq let3 let43) := by timed Eq.trans lean_r4 lean_s19
let lean_s21 := by timed congr lean_s0 lean_s20
have lean_s22 : (Eq let26 let42) := by timed flipCongrArg lean_r3 [Not]
have lean_s23 : (Eq let2 let42) := by timed Eq.trans lean_r5 lean_s22
...
have lean_s34 : (Eq let15 let47) := by timed congr lean_s2 lean_s33
have lean_s35 : (Eq let16 let47) := by timed Eq.trans lean_r0 lean_s34
let lean_s36 := by timed flipCongrArg lean_s35 [Implies]
have lean_s37 : (Eq let39 let39) := by timed rfl
have lean_s38 : (Eq let40 let48) := by timed congr lean_s36 lean_s37
have lean_s39 : (Eq let41 let49) := by timed flipCongrArg lean_s38 [Not]
have lean_s40 : let49 := by timed eqResolve lean_a16 lean_s39
have lean_s41 : let47 := by timed notImplies1 lean_s40
have lean_s42 : let14 := by andElim lean_s41, 0
have lean_s43 : let49 := by timed eqResolve lean_a16 lean_s39
have lean_s44 : (Not let39) := by timed notImplies2 lean_s43
have lean_s45 : (Not let14) := by notOrElim lean_s44, 0
