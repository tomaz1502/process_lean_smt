...
theorem th0 :
  ...
  let let23 := (binrel% HMul.hMul let10 skoY)
  let let24 := (binrel% HMul.hMul let2 skoY)
  let let25 := (binrel% HAdd.hAdd let24 let23)
  let let26 := (binrel% GE.ge let25 let22)
  let let27 := (Not let26)
  let let28 := (binrel% LT.lt let25 let22)
  let let29 := (binrel% GE.ge (binrel% HAdd.hAdd skoY (binrel% HAdd.hAdd skoZ skoX)) let4)
  ...
  let let50 := (binrel% LE.le let6 skoY)
  let let51 := (binrel% HAdd.hAdd let2 (binrel% HAdd.hAdd let16 let30))
  let let52 := (Not let8)
  let let53 := (binrel% GE.ge (binrel% HMul.hMul let15 skoZ) let34)
  let let54 := (binrel% LE.le skoZ let19)
  let let55 := (binrel% HMul.hMul let10 let5)
  let let56 := (Eq let55 let6)
  let let57 := (binrel% GE.ge skoX let44)
  let let58 := (binrel% LE.le let46 skoX)
  let let59 := (Not True)
  let let60 := (binrel% HDiv.hDiv let10 (Rat.ofInt 2))
  let let61 := (Not let58)
  let let62 := (Not let49)
  let let63 := (Not let47)
  let let64 := (binrel% LE.le skoX let37)
  let let65 := (Not let64)
  let let66 := (binrel% LE.le skoY let37)
  let let67 := (Not let66)
  let let68 := (binrel% LE.le skoZ let37)
  let let69 := (Not let68)
  let let70 := (binrel% LE.le let14 skoZ)
  let let71 := (Not let70)
  let let72 := (binrel% LE.le let60 skoY)
  let let73 := (Not let72)
  let let74 := (And let73 (And let71 (And let69 (And let67 (And let65 (And let63 (And let62 let61)))))))
  let let75 := (Not let35)
  let let76 := (Not let75)
  let let77 := (binrel% HAdd.hAdd let6 let34)
  let let78 := (binrel% HAdd.hAdd skoY let30)
  let let79 := (Not let36)
  let let80 := (binrel% GT.gt skoY let19)
  let let81 := (Not let57)
  let let82 := (Not let48)
  let let83 := (Not let45)
  let let84 := (Not let38)
  let let85 := (Not let53)
  let let86 := (Not let29)
  let let87 := (And let8 (And let86 (And let85 (And let75 (And let84 (And let83 (And let82 let81)))))))
  let let88 := (Eq let74 let87)
  let let89 := (Or let7 let35)
  let let90 := (Or let52 let76)
  let let91 := (binrel% LT.lt let23 let20)
  let let92 := (And let40 let80)
  let let93 := (binrel% LT.lt let24 let21)
  let let94 := (And let3 let9)
(Eq let3 True) → (Eq let9 let8) → (Eq let14 let13) → let17 → (Eq let10 let10) → (Eq let28 let27) → (Eq let32 let29) → let33 → (Eq let36 let35) → (Eq let37 let19) → (Eq let39 let38) → (Eq let40 True) → (Eq let43 True) → (Eq let47 let45) → (Eq let49 let48) → (Eq let50 let7) → (Eq let51 let31) → (Eq let52 let7) → (Eq let21 let6) → (Eq let54 let53) → let56 → (Eq let58 let57) → (Eq let59 False) → (Eq let60 let55) → (Eq let74 let74) → (Eq let76 let35) → (Eq let20 let34) → (Eq let77 let41) → (Eq let78 let42) → (Eq let23 let30) → (Eq let24 skoY) → (Eq let80 let79) → let74 → False :=
  let let1 := (Int.ofNat 0)
  let let2 := (Rat.ofInt 1)
  let let3 := (binrel% GT.gt let2 let1)
  let let4 := (Int.ofNat 1)
...
fun lean_r22 : (Eq let59 False) => -- THEORY_REWRITE_BOOL
fun lean_r23 : (Eq let60 let55) => -- THEORY_REWRITE_ARITH
fun lean_r24 : (Eq let74 let74) => -- THEORY_REWRITE_BOOL
fun lean_r25 : (Eq let76 let35) => -- THEORY_REWRITE_BOOL
fun lean_r26 : (Eq let20 let34) => -- THEORY_REWRITE_ARITH
fun lean_r27 : (Eq let77 let41) => -- THEORY_REWRITE_ARITH
fun lean_r28 : (Eq let78 let42) => -- THEORY_REWRITE_ARITH
fun lean_r29 : (Eq let23 let30) => -- THEORY_REWRITE_ARITH
fun lean_r30 : (Eq let24 skoY) => -- THEORY_REWRITE_ARITH
fun lean_r31 : (Eq let80 let79) => -- THEORY_REWRITE_ARITH
fun lean_a32 : let74 => by
have lean_s0 : (Or let52 (Or let76 False)) :=
  (scope (fun lean_a33 : let8 =>
    (scope (fun lean_a34 : let75 =>
      ...
      have lean_s3 : let94 := by timed And.intro lean_s0 lean_s2
      have lean_s4 : (Implies let94 let93) := by arithMulPos [skoY, let6, let2], 0
      have lean_s5 : let93 := by timed modusPonens lean_s3 lean_s4
      have lean_s6 : let40 := by timed trueElim lean_r11
      have lean_s7 : (Eq let79 let75) := by timed flipCongrArg lean_r8 [Not]
      have lean_s8 : (Eq let80 let75) := by timed Eq.trans lean_r31 lean_s7
      have lean_s9 : (Eq let75 let80) := by timed Eq.symm lean_s8
      have lean_s10 : let80 := by timed eqResolve lean_a34 lean_s9
      have lean_s11 : let92 := by timed And.intro lean_s6 lean_s10
      have lean_s12 : (Implies let92 let91) := by arithMulNeg [skoY, let19, let10], 2
      have lean_s13 : let91 := by timed modusPonens lean_s11 lean_s12
      have lean_s14 : let28 := by sumBounds [lean_s5, lean_s13]
      let lean_s15 := by timed flipCongrArg lean_r30 [HAdd.hAdd]
      have lean_s16 : (Eq let25 let78) := by timed congr lean_s15 lean_r29
      ...
      have lean_s20 : (Eq let22 let77) := by timed congr lean_s19 lean_r26
      ...
      have lean_s24 : (Eq let27 let59) := by timed flipCongrArg lean_s23 [Not]
...
have lean_s1 : (Not (And let8 let75)) := by liftOrNToNeg lean_s0
have lean_s2 : let90 := by timed flipNotAnd lean_s1 [let8, let75]
let lean_s3 := by timed flipCongrArg lean_r17 [Or]
have lean_s4 : (Eq let90 let89) := by timed congr lean_s3 lean_r25
have lean_s5 : let89 := by timed eqResolve lean_s2 lean_s4
...
have lean_s10 : let56 := by timed Eq.trans lean_s9 lean_r20
have lean_s11 : (Eq let60 let6) := by timed Eq.trans lean_r23 lean_s10
let lean_s12 := by timed flipCongrArg lean_s11 [LE.le]
have lean_s13 : (Eq skoY skoY) := by timed rfl
have lean_s14 : (Eq let72 let50) := by timed congr lean_s12 lean_s13
have lean_s15 : (Eq let72 let7) := by timed Eq.trans lean_s14 lean_r15
...
have lean_s24 : (Eq let11 let11) := by timed congr lean_s23 lean_r4
have lean_s25 : let33 := by timed Eq.trans lean_s24 lean_r7
let lean_s26 := by timed congrHAdd lean_s22 lean_s25
have lean_s27 : (Eq let13 let51) := by timed congrHAdd lean_s18 lean_s26
have lean_s28 : (Eq let13 let31) := by timed Eq.trans lean_s27 lean_r16
have lean_s29 : (Eq let14 let31) := by timed Eq.trans lean_r2 lean_s28
let lean_s30 := by timed flipCongrArg lean_s29 [LE.le]
have lean_s31 : (Eq skoZ skoZ) := by timed rfl
have lean_s32 : (Eq let70 let32) := by timed congr lean_s30 lean_s31
have lean_s33 : (Eq let70 let29) := by timed Eq.trans lean_s32 lean_r6
have lean_s34 : (Eq let71 let86) := by timed flipCongrArg lean_s33 [Not]
let lean_s35 := by timed congr lean_s6 lean_s34
let lean_s36 := by timed flipCongrArg lean_s31 [LE.le]
have lean_s37 : (Eq let68 let54) := by timed congr lean_s36 lean_r9
have lean_s38 : (Eq let68 let53) := by timed Eq.trans lean_s37 lean_r19
have lean_s39 : (Eq let69 let85) := by timed flipCongrArg lean_s38 [Not]
let lean_s40 := by timed congr lean_s6 lean_s39
let lean_s41 := by timed flipCongrArg lean_s13 [LE.le]
have lean_s42 : (Eq let66 let36) := by timed congr lean_s41 lean_r9
have lean_s43 : (Eq let66 let35) := by timed Eq.trans lean_s42 lean_r8
have lean_s44 : (Eq let67 let75) := by timed flipCongrArg lean_s43 [Not]
let lean_s45 := by timed congr lean_s6 lean_s44
let lean_s46 := by timed flipCongrArg lean_s19 [LE.le]
have lean_s47 : (Eq let64 let39) := by timed congr lean_s46 lean_r9
have lean_s48 : (Eq let64 let38) := by timed Eq.trans lean_s47 lean_r10
have lean_s49 : (Eq let65 let84) := by timed flipCongrArg lean_s48 [Not]
let lean_s50 := by timed congr lean_s6 lean_s49
have lean_s51 : (Eq let63 let83) := by timed flipCongrArg lean_r13 [Not]
let lean_s52 := by timed congr lean_s6 lean_s51
have lean_s53 : (Eq let62 let82) := by timed flipCongrArg lean_r14 [Not]
let lean_s54 := by timed congr lean_s6 lean_s53
have lean_s55 : (Eq let61 let81) := by timed flipCongrArg lean_r21 [Not]
...
have lean_s62 : let88 := by timed congr lean_s17 lean_s61
have lean_s63 : let88 := by timed Eq.trans lean_r24 lean_s62
have lean_s64 : let87 := by timed eqResolve lean_a32 lean_s63
have lean_s65 : let75 := by andElim lean_s64, 3
let lean_s66 := by R1 lean_s5, lean_s65, let35, [(- 1), 0]
