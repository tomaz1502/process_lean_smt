...
theorem th0 :
  ...
  let let14 := (binrel% GE.ge (binrel% HAdd.hAdd let13 (binrel% HMul.hMul let12 skoY)) let1)
  let let15 := (Not let14)
  ...
  let let24 := (And let23 (And (Not (And let23 (binrel% GE.ge skoY let1))) let22))
  let let25 := (Rat.ofInt 0)
  let let26 := (Not (Eq skoY let25))
  ...
  let let58 := (binrel% HAdd.hAdd let5 (binrel% HAdd.hAdd let8 skoY))
  ...
  let let66 := (binrel% LE.le let60 skoY)
  ...
  let let74 := (binrel% HMul.hMul let31 skoY)
...
(Eq let27 let24) → (Eq let30 let29) → (Eq let32 True) → (Eq let46 let46) → (Eq let45 let23) → (Eq let33 let6) → (Eq let50 let49) → (Eq let51 True) → (Eq let52 let20) → (Eq let39 let16) → (Eq let55 let54) → let55 → (Eq let56 let17) → (Eq let57 let25) → (Eq let28 let9) → (Eq let58 let25) → (Eq let61 let60) → (Eq let42 let19) → let63 → (Eq let48 let6) → (Eq let65 True) → (Eq let66 let14) → (Eq let67 let5) → (Eq let68 let25) → (Eq let69 True) → (Eq let70 False) → (Eq let63 let71) → (Eq let72 True) → (Eq let73 let25) → (Eq let35 let59) → (Eq let74 skoY) → (Eq let75 let8) → (Eq let80 let79) → let46 → False :=
  let let1 := (Int.ofNat 0)
  let let2 := (Int.ofNat 1)
  let let3 := (Neg.neg let2)
  let let4 := (binrel% HMul.hMul let3 skoY)
...
fun lean_r30 : (Eq let74 skoY) => -- THEORY_REWRITE_ARITH
      ...
      (scope (fun lean_a36 : let7 =>
        ...
        have lean_s4 : (Or let85 False) :=
          (scope (fun lean_a37 : let50 =>
            ...
            have lean_s19 : (Implies let87 let86) := by arithMulPos [skoY, let25, let31], 1
