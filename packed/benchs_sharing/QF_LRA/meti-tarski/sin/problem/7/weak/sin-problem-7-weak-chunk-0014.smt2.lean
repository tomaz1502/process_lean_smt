...
theorem th0 :
  ...
  let let3 := (Not let2)
  let let4 := (binrel% LT.lt skoY let1)
  ...
  let let23 := (binrel% HAdd.hAdd (binrel% HMul.hMul let15 skoY) skoX)
  ...
  let let29 := (binrel% LE.le let1 skoY)
  ...
  let let34 := (binrel% GE.ge (binrel% HAdd.hAdd let33 (binrel% HMul.hMul let32 skoY)) let5)
  ...
  let let80 := (binrel% HAdd.hAdd let23 (binrel% HAdd.hAdd let16 skoY))
...
fun lean_r36 : (Eq let12 skoY) => -- THEORY_REWRITE_ARITH
      ...
      (scope (fun lean_a40 : let59 =>
        ...
        have lean_s4 : (Or let89 False) :=
          (scope (fun lean_a41 : let79 =>
            ...
            have lean_s21 : (Implies let91 let90) := by arithMulPos [skoY, let1, let7], 0
...
have lean_s45 : (Eq skoY skoY) := by timed rfl
