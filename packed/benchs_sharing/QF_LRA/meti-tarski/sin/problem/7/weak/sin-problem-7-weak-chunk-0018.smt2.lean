...
theorem th0 :
  ...
  let let21 := (Not let20)
  let let22 := (binrel% LE.le skoY let5)
  ...
  let let30 := (binrel% HAdd.hAdd let29 (binrel% HAdd.hAdd let26 skoY))
  ...
  let let35 := (binrel% HMul.hMul let2 skoY)
  let let36 := (binrel% HMul.hMul let3 skoX)
  let let37 := (binrel% HAdd.hAdd skoY let26)
  ...
  let let51 := (binrel% GE.ge (binrel% HAdd.hAdd let50 (binrel% HMul.hMul let49 skoY)) let1)
...
(Eq let4 True) → (Eq let8 let7) → (Eq let9 True) → (Eq let23 let23) → (Eq let6 let27) → (Eq let30 let5) → (Eq let16 let31) → (Eq let42 let41) → (Eq let44 let43) → let48 → (Eq let54 let51) → (Eq let55 True) → (Eq let12 let52) → (Eq let58 let57) → (Eq let59 let53) → (Eq let19 let60) → let63 → (Eq let56 let45) → (Eq let22 let64) → (Eq let10 let45) → (Eq let48 let65) → (Eq let33 let5) → (Eq let67 let66) → (Eq let68 True) → (Eq let69 False) → (Eq let63 let70) → (Eq let71 True) → (Eq let72 let5) → (Eq let32 let5) → (Eq let35 skoY) → (Eq let36 let26) → (Eq let38 let29) → let23 → False :=
  let let1 := (Int.ofNat 0)
  let let2 := (Rat.ofInt 1)
  let let3 := (Neg.neg let2)
  let let4 := (binrel% LT.lt let3 let1)
...
fun lean_r29 : (Eq let35 skoY) => -- THEORY_REWRITE_ARITH
      ...
      (scope (fun lean_a35 : let46 =>
        ...
        have lean_s4 : (Or let82 False) :=
          (scope (fun lean_a36 : let58 =>
            ...
            have lean_s19 : (Implies let84 let83) := by arithMulPos [skoY, let5, let2], 1
