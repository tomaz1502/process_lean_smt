...
theorem th0 :
  ...
  let let32 := (binrel% GE.ge (binrel% HAdd.hAdd let31 (binrel% HMul.hMul let24 skoA)) let1)
  let let33 := (binrel% LE.le let26 skoA)
  ...
  let let47 := (Not let8)
  let let48 := (Not let47)
  let let49 := (binrel% GE.ge (binrel% HAdd.hAdd skoX (binrel% HMul.hMul let21 skoA)) let1)
  let let50 := (binrel% LE.le skoA skoX)
  ...
  let let59 := (binrel% LE.le let58 skoA)
  let let60 := (Not let59)
  let let61 := (Not let50)
  let let62 := (Not let53)
...
have lean_s18 : (Eq skoA skoA) := by timed rfl
