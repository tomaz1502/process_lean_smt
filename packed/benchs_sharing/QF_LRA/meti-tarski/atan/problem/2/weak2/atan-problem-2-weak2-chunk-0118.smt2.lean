...
theorem th0 :
  ...
  let let30 := (binrel% GE.ge (binrel% HAdd.hAdd skoB let14) let1)
  let let31 := (binrel% LE.le skoT skoB)
  let let32 := (binrel% HMul.hMul let13 skoB)
  let let33 := (binrel% GE.ge (binrel% HAdd.hAdd let32 skoA) let1)
  ...
  let let46 := (Not let8)
  let let47 := (Not let46)
  let let48 := (binrel% GE.ge (binrel% HAdd.hAdd let32 let21) let1)
