...
fun lean_a126 : (And (And (And (And (And (Or (Or (Or (Or (Or let844 (Eq let838 e1)) (Eq let832 e2)) (Eq let826 e3)) (Eq let820 e4)) (Eq let814 e5)) (Or (Or (Or (Or (Or (Eq let843 e0) let837) (Eq let831 e2)) (Eq let825 e3)) (Eq let819 e4)) (Eq let813 e5))) (Or (Or (Or (Or (Or (Eq let842 e0) (Eq let836 e1)) let830) (Eq let824 e3)) (Eq let818 e4)) (Eq let812 e5))) (Or (Or (Or (Or (Or (Eq let841 e0) (Eq let835 e1)) (Eq let829 e2)) let823) (Eq let817 e4)) (Eq let811 e5))) (Or (Or (Or (Or (Or (Eq let840 e0) (Eq let834 e1)) (Eq let828 e2)) (Eq let822 e3)) let816) (Eq let810 e5))) (Or (Or (Or (Or (Or (Eq let839 e0) (Eq let833 e1)) (Eq let827 e2)) (Eq let821 e3)) (Eq let815 e4)) let809)) =>
fun lean_a127 : (And (And (And (And (And (And (And (And (And (And (Or let249 let808) (Or (Not let212) let807)) (Or (Not let178) let806)) (Or (Not let141) let805)) (Or (Not let104) let804)) (Or (Not let67) let803)) (And (And (And (And (And (Or (Not let14) let802) (Or let246 let801)) (Or (Not let172) let800)) (Or (Not let135) let799)) (Or (Not let98) let798)) (Or (Not let61) let797))) (And (And (And (And (And (Or (Not let228) let796) (Or (Not let203) let795)) (Or let244 let794)) (Or (Not let129) let793)) (Or (Not let92) let792)) (Or (Not let55) let791))) (And (And (And (And (And (Or (Not let20) let790) (Or (Not let197) let789)) (Or (Not let160) let788)) (Or let242 let787)) (Or (Not let86) let786)) (Or (Not let49) let785))) (And (And (And (And (And (Or (Not let24) let784) (Or (Not let191) let783)) (Or (Not let154) let782)) (Or (Not let117) let781)) (Or let239 let780)) (Or (Not let43) let779))) (And (And (And (And (And (Or (Not let28) let778) (Or (Not let185) let777)) (Or (Not let148) let776)) (Or (Not let111) let775)) (Or (Not let74) let774)) (Or let236 let773))) =>
fun lean_a128 : let252 =>
fun lean_a129 : let363 =>
fun lean_a130 : (And (And (And (And (And (And (And (And (And (And (And (And (And (And (And (And (And (And (And (And (Not (Eq let5 let11)) (Not (Eq let5 let224))) (Not (Eq let5 let17))) (Not (Eq let5 let21))) (Not (Eq let5 let25))) (Not (Eq let11 let224))) (Not (Eq let11 let17))) (Not (Eq let11 let21))) (Not (Eq let11 let25))) (Not (Eq let224 let17))) (Not (Eq let224 let21))) (Not (Eq let224 let25))) (Not (Eq let17 let21))) (Not (Eq let17 let25))) (Not (Eq let21 let25))) (And (And (And (And (And (And (And (And (And (And (And (And (And (And (Not (Eq let208 let29)) (Not (Eq let208 let199))) (Not (Eq let208 let193))) (Not (Eq let208 let187))) (Not (Eq let208 let181))) (Not (Eq let29 let199))) (Not (Eq let29 let193))) (Not (Eq let29 let187))) (Not (Eq let29 let181))) (Not (Eq let199 let193))) (Not (Eq let199 let187))) (Not (Eq let199 let181))) (Not (Eq let193 let187))) (Not (Eq let193 let181))) (Not (Eq let187 let181)))) (And (And (And (And (And (And (And (And (And (And (And (And (And (And (Not (Eq let174 let168)) (Not (Eq let174 let162))) (Not (Eq let174 let156))) (Not (Eq let174 let150))) (Not (Eq let174 let144))) (Not (Eq let168 let162))) (Not (Eq let168 let156))) (Not (Eq let168 let150))) (Not (Eq let168 let144))) (Not (Eq let162 let156))) (Not (Eq let162 let150))) (Not (Eq let162 let144))) (Not (Eq let156 let150))) (Not (Eq let156 let144))) (Not (Eq let150 let144)))) (And (And (And (And (And (And (And (And (And (And (And (And (And (And (Not (Eq let137 let131)) (Not (Eq let137 let125))) (Not (Eq let137 let119))) (Not (Eq let137 let113))) (Not (Eq let137 let107))) (Not (Eq let131 let125))) (Not (Eq let131 let119))) (Not (Eq let131 let113))) (Not (Eq let131 let107))) (Not (Eq let125 let119))) (Not (Eq let125 let113))) (Not (Eq let125 let107))) (Not (Eq let119 let113))) (Not (Eq let119 let107))) (Not (Eq let113 let107)))) (And (And (And (And (And (And (And (And (And (And (And (And (And (And (Not (Eq let100 let94)) (Not (Eq let100 let88))) (Not (Eq let100 let82))) (Not (Eq let100 let76))) (Not (Eq let100 let70))) (Not (Eq let94 let88))) (Not (Eq let94 let82))) (Not (Eq let94 let76))) (Not (Eq let94 let70))) (Not (Eq let88 let82))) (Not (Eq let88 let76))) (Not (Eq let88 let70))) (Not (Eq let82 let76))) (Not (Eq let82 let70))) (Not (Eq let76 let70)))) (And (And (And (And (And (And (And (And (And (And (And (And (And (And (Not (Eq let63 let57)) (Not (Eq let63 let51))) (Not (Eq let63 let45))) (Not (Eq let63 let39))) (Not (Eq let63 let33))) (Not (Eq let57 let51))) (Not (Eq let57 let45))) (Not (Eq let57 let39))) (Not (Eq let57 let33))) (Not (Eq let51 let45))) (Not (Eq let51 let39))) (Not (Eq let51 let33))) (Not (Eq let45 let39))) (Not (Eq let45 let33))) (Not (Eq let39 let33)))) (And (And (And (And (And (And (And (And (And (And (And (And (And (And (And (And (And (And (And (Not (Eq let5 let208)) (Not (Eq let5 let174))) (Not (Eq let5 let137))) (Not (Eq let5 let100))) (Not (Eq let5 let63))) (Not (Eq let208 let174))) (Not (Eq let208 let137))) (Not (Eq let208 let100))) (Not (Eq let208 let63))) (Not (Eq let174 let137))) (Not (Eq let174 let100))) (Not (Eq let174 let63))) (Not (Eq let137 let100))) (Not (Eq let137 let63))) (Not (Eq let100 let63))) (And (And (And (And (And (And (And (And (And (And (And (And (And (And (Not (Eq let11 let29)) (Not (Eq let11 let168))) (Not (Eq let11 let131))) (Not (Eq let11 let94))) (Not (Eq let11 let57))) (Not (Eq let29 let168))) (Not (Eq let29 let131))) (Not (Eq let29 let94))) (Not (Eq let29 let57))) (Not (Eq let168 let131))) (Not (Eq let168 let94))) (Not (Eq let168 let57))) (Not (Eq let131 let94))) (Not (Eq let131 let57))) (Not (Eq let94 let57)))) (And (And (And (And (And (And (And (And (And (And (And (And (And (And (Not (Eq let224 let199)) (Not (Eq let224 let162))) (Not (Eq let224 let125))) (Not (Eq let224 let88))) (Not (Eq let224 let51))) (Not (Eq let199 let162))) (Not (Eq let199 let125))) (Not (Eq let199 let88))) (Not (Eq let199 let51))) (Not (Eq let162 let125))) (Not (Eq let162 let88))) (Not (Eq let162 let51))) (Not (Eq let125 let88))) (Not (Eq let125 let51))) (Not (Eq let88 let51)))) (And (And (And (And (And (And (And (And (And (And (And (And (And (And (Not (Eq let17 let193)) (Not (Eq let17 let156))) (Not (Eq let17 let119))) (Not (Eq let17 let82))) (Not (Eq let17 let45))) (Not (Eq let193 let156))) (Not (Eq let193 let119))) (Not (Eq let193 let82))) (Not (Eq let193 let45))) (Not (Eq let156 let119))) (Not (Eq let156 let82))) (Not (Eq let156 let45))) (Not (Eq let119 let82))) (Not (Eq let119 let45))) (Not (Eq let82 let45)))) (And (And (And (And (And (And (And (And (And (And (And (And (And (And (Not (Eq let21 let187)) (Not (Eq let21 let150))) (Not (Eq let21 let113))) (Not (Eq let21 let76))) (Not (Eq let21 let39))) (Not (Eq let187 let150))) (Not (Eq let187 let113))) (Not (Eq let187 let76))) (Not (Eq let187 let39))) (Not (Eq let150 let113))) (Not (Eq let150 let76))) (Not (Eq let150 let39))) (Not (Eq let113 let76))) (Not (Eq let113 let39))) (Not (Eq let76 let39)))) (And (And (And (And (And (And (And (And (And (And (And (And (And (And (Not (Eq let25 let181)) (Not (Eq let25 let144))) (Not (Eq let25 let107))) (Not (Eq let25 let70))) (Not (Eq let25 let33))) (Not (Eq let181 let144))) (Not (Eq let181 let107))) (Not (Eq let181 let70))) (Not (Eq let181 let33))) (Not (Eq let144 let107))) (Not (Eq let144 let70))) (Not (Eq let144 let33))) (Not (Eq let107 let70))) (Not (Eq let107 let33))) (Not (Eq let70 let33))))) =>
fun lean_a131 : let398 => by
have lean_s0 : (Or let1000 (Or let997 let998)) := by timed cnfAndNeg [let333, let27]
have lean_s1 : let999 :=
  (scope (fun lean_a132 : let333 =>
    (scope (fun lean_a133 : let27 =>
      have lean_s1 : let851 := by timed rfl
      let lean_s2 := by timed flipCongrArg lean_s1 [op]
      have lean_s3 : let28 := by timed Eq.symm lean_a133
      have lean_s4 : let27 := by timed Eq.symm lean_s3
      let lean_s5 := by timed flipCongrArg lean_s1 [op]
      have lean_s6 : let587 := by timed Eq.symm lean_a132
      ...
      have lean_s10 : let402 := by timed Eq.trans lean_a132 lean_s9
      show let402 from lean_s10
  ))))
have lean_s2 : (Implies let1000 let402) := by liftOrNToImp lean_s1, 2
have lean_s3 : (Or (Not let1000) let402) := by timed impliesElim lean_s2
have lean_s4 : let999 := by R1 lean_s0, lean_s3, let1000, [(- 1), (- 1)]
have lean_s5 : (Or let998 (Or let402 let997)) := by permutateOr lean_s4, [1, 2, 0], (- 1)
have lean_s6 : (Or let996 let27) := by timed @cnfAndPos [let27, let500] 0
have lean_s7 : (Or let27 let996) := by permutateOr lean_s6, [1, 0], (- 1)
have lean_s8 : let849 := by timed rfl
have lean_s9 : (Eq let249 let540) := by timed flipCongrArg lean_r2 [Not]
let lean_s10 := by timed flipCongrArg lean_s9 [Or]
have lean_s11 : (Eq let250 let960) := by timed congr lean_s10 lean_r83
...
have lean_s15 : (Eq let247 let959) := by timed congr lean_s14 lean_r0
...
have lean_s19 : (Eq let245 let958) := by timed congr lean_s18 lean_r1
...
have lean_s23 : (Eq let243 let957) := by timed congr lean_s22 lean_r29
...
have lean_s27 : (Eq let240 let956) := by timed congr lean_s26 lean_r16
...
have lean_s31 : (Eq let237 let955) := by timed congr lean_s30 lean_r18
let lean_s32 := by timed congr lean_s8 lean_s31
have lean_s33 : let848 := by timed rfl
let lean_s34 := by timed flipCongrArg lean_r2 [And]
have lean_s35 : (Eq let232 let952) := by timed flipCongrArg lean_r3 [Not]
have lean_s36 : (Eq let233 let953) := by timed congr lean_s34 lean_s35
let lean_s37 := by timed congr lean_s33 lean_s36
let lean_s38 := by timed flipCongrArg lean_r4 [And]
have lean_s39 : (Eq let230 let950) := by timed flipCongrArg lean_r5 [Not]
have lean_s40 : (Eq let231 let951) := by timed congr lean_s38 lean_s39
let lean_s41 := by timed congr lean_s33 lean_s40
let lean_s42 := by timed flipCongrArg lean_r109 [And]
have lean_s43 : (Eq let226 let948) := by timed flipCongrArg lean_r92 [Not]
have lean_s44 : (Eq let229 let949) := by timed congr lean_s42 lean_s43
let lean_s45 := by timed congr lean_s33 lean_s44
let lean_s46 := by timed flipCongrArg lean_r6 [And]
have lean_s47 : (Eq let222 let946) := by timed flipCongrArg lean_r87 [Not]
have lean_s48 : (Eq let223 let947) := by timed congr lean_s46 lean_s47
let lean_s49 := by timed congr lean_s33 lean_s48
let lean_s50 := by timed flipCongrArg lean_r7 [And]
have lean_s51 : (Eq let219 let944) := by timed flipCongrArg lean_r77 [Not]
have lean_s52 : (Eq let220 let945) := by timed congr lean_s50 lean_s51
let lean_s53 := by timed congr lean_s33 lean_s52
let lean_s54 := by timed flipCongrArg lean_r8 [And]
have lean_s55 : (Eq let216 let942) := by timed flipCongrArg lean_r54 [Not]
have lean_s56 : (Eq let217 let943) := by timed congr lean_s54 lean_s55
...
have lean_s61 : (Eq let276 let954) := by timed congr lean_s37 lean_s60
have lean_s62 : (Eq let234 let954) := by timed Eq.trans lean_r34 lean_s61
let lean_s63 := by timed congr lean_s8 lean_s62
have lean_s64 : let848 := by timed rfl
let lean_s65 := by timed flipCongrArg lean_r52 [And]
have lean_s66 : (Eq let210 let939) := by timed flipCongrArg lean_r56 [Not]
have lean_s67 : (Eq let213 let940) := by timed congr lean_s65 lean_s66
let lean_s68 := by timed congr lean_s64 lean_s67
let lean_s69 := by timed flipCongrArg lean_r9 [And]
have lean_s70 : (Eq let206 let937) := by timed flipCongrArg lean_r11 [Not]
have lean_s71 : (Eq let207 let938) := by timed congr lean_s69 lean_s70
let lean_s72 := by timed congr lean_s64 lean_s71
let lean_s73 := by timed flipCongrArg lean_r12 [And]
have lean_s74 : (Eq let201 let935) := by timed flipCongrArg lean_r85 [Not]
have lean_s75 : (Eq let204 let936) := by timed congr lean_s73 lean_s74
let lean_s76 := by timed congr lean_s64 lean_s75
let lean_s77 := by timed flipCongrArg lean_r13 [And]
have lean_s78 : (Eq let195 let933) := by timed flipCongrArg lean_r14 [Not]
have lean_s79 : (Eq let198 let934) := by timed congr lean_s77 lean_s78
let lean_s80 := by timed congr lean_s64 lean_s79
let lean_s81 := by timed flipCongrArg lean_r15 [And]
have lean_s82 : (Eq let189 let931) := by timed flipCongrArg lean_r17 [Not]
have lean_s83 : (Eq let192 let932) := by timed congr lean_s81 lean_s82
let lean_s84 := by timed congr lean_s64 lean_s83
let lean_s85 := by timed flipCongrArg lean_r19 [And]
have lean_s86 : (Eq let183 let929) := by timed flipCongrArg lean_r20 [Not]
have lean_s87 : (Eq let186 let930) := by timed congr lean_s85 lean_s86
...
have lean_s92 : (Eq let552 let941) := by timed congr lean_s68 lean_s91
have lean_s93 : (Eq let214 let941) := by timed Eq.trans lean_r114 lean_s92
let lean_s94 := by timed congr lean_s8 lean_s93
have lean_s95 : let848 := by timed rfl
let lean_s96 := by timed flipCongrArg lean_r21 [And]
have lean_s97 : (Eq let176 let926) := by timed flipCongrArg lean_r22 [Not]
have lean_s98 : (Eq let179 let927) := by timed congr lean_s96 lean_s97
let lean_s99 := by timed congr lean_s95 lean_s98
let lean_s100 := by timed flipCongrArg lean_r23 [And]
have lean_s101 : (Eq let170 let924) := by timed flipCongrArg lean_r24 [Not]
have lean_s102 : (Eq let173 let925) := by timed congr lean_s100 lean_s101
let lean_s103 := by timed congr lean_s95 lean_s102
let lean_s104 := by timed flipCongrArg lean_r25 [And]
have lean_s105 : (Eq let164 let922) := by timed flipCongrArg lean_r26 [Not]
have lean_s106 : (Eq let167 let923) := by timed congr lean_s104 lean_s105
let lean_s107 := by timed congr lean_s95 lean_s106
let lean_s108 := by timed flipCongrArg lean_r70 [And]
have lean_s109 : (Eq let158 let920) := by timed flipCongrArg lean_r61 [Not]
have lean_s110 : (Eq let161 let921) := by timed congr lean_s108 lean_s109
let lean_s111 := by timed congr lean_s95 lean_s110
let lean_s112 := by timed flipCongrArg lean_r49 [And]
have lean_s113 : (Eq let152 let918) := by timed flipCongrArg lean_r47 [Not]
have lean_s114 : (Eq let155 let919) := by timed congr lean_s112 lean_s113
let lean_s115 := by timed congr lean_s95 lean_s114
let lean_s116 := by timed flipCongrArg lean_r27 [And]
have lean_s117 : (Eq let146 let916) := by timed flipCongrArg lean_r28 [Not]
have lean_s118 : (Eq let149 let917) := by timed congr lean_s116 lean_s117
...
have lean_s123 : (Eq let545 let928) := by timed congr lean_s99 lean_s122
have lean_s124 : (Eq let180 let928) := by timed Eq.trans lean_r104 lean_s123
let lean_s125 := by timed congr lean_s8 lean_s124
have lean_s126 : let848 := by timed rfl
let lean_s127 := by timed flipCongrArg lean_r31 [And]
have lean_s128 : (Eq let139 let913) := by timed flipCongrArg lean_r32 [Not]
have lean_s129 : (Eq let142 let914) := by timed congr lean_s127 lean_s128
let lean_s130 := by timed congr lean_s126 lean_s129
let lean_s131 := by timed flipCongrArg lean_r33 [And]
have lean_s132 : (Eq let133 let911) := by timed flipCongrArg lean_r35 [Not]
have lean_s133 : (Eq let136 let912) := by timed congr lean_s131 lean_s132
let lean_s134 := by timed congr lean_s126 lean_s133
let lean_s135 := by timed flipCongrArg lean_r36 [And]
have lean_s136 : (Eq let127 let909) := by timed flipCongrArg lean_r37 [Not]
have lean_s137 : (Eq let130 let910) := by timed congr lean_s135 lean_s136
let lean_s138 := by timed congr lean_s126 lean_s137
let lean_s139 := by timed flipCongrArg lean_r89 [And]
have lean_s140 : (Eq let121 let907) := by timed flipCongrArg lean_r38 [Not]
have lean_s141 : (Eq let124 let908) := by timed congr lean_s139 lean_s140
let lean_s142 := by timed congr lean_s126 lean_s141
let lean_s143 := by timed flipCongrArg lean_r45 [And]
have lean_s144 : (Eq let115 let905) := by timed flipCongrArg lean_r39 [Not]
have lean_s145 : (Eq let118 let906) := by timed congr lean_s143 lean_s144
let lean_s146 := by timed congr lean_s126 lean_s145
let lean_s147 := by timed flipCongrArg lean_r79 [And]
have lean_s148 : (Eq let109 let903) := by timed flipCongrArg lean_r40 [Not]
have lean_s149 : (Eq let112 let904) := by timed congr lean_s147 lean_s148
...
have lean_s154 : (Eq let272 let915) := by timed congr lean_s130 lean_s153
have lean_s155 : (Eq let143 let915) := by timed Eq.trans lean_r30 lean_s154
let lean_s156 := by timed congr lean_s8 lean_s155
have lean_s157 : let848 := by timed rfl
let lean_s158 := by timed flipCongrArg lean_r42 [And]
have lean_s159 : (Eq let102 let900) := by timed flipCongrArg lean_r119 [Not]
have lean_s160 : (Eq let105 let901) := by timed congr lean_s158 lean_s159
let lean_s161 := by timed congr lean_s157 lean_s160
let lean_s162 := by timed flipCongrArg lean_r118 [And]
have lean_s163 : (Eq let96 let898) := by timed flipCongrArg lean_r116 [Not]
have lean_s164 : (Eq let99 let899) := by timed congr lean_s162 lean_s163
let lean_s165 := by timed congr lean_s157 lean_s164
let lean_s166 := by timed flipCongrArg lean_r113 [And]
have lean_s167 : (Eq let90 let896) := by timed flipCongrArg lean_r112 [Not]
have lean_s168 : (Eq let93 let897) := by timed congr lean_s166 lean_s167
let lean_s169 := by timed congr lean_s157 lean_s168
let lean_s170 := by timed flipCongrArg lean_r64 [And]
have lean_s171 : (Eq let84 let894) := by timed flipCongrArg lean_r44 [Not]
have lean_s172 : (Eq let87 let895) := by timed congr lean_s170 lean_s171
let lean_s173 := by timed congr lean_s157 lean_s172
let lean_s174 := by timed flipCongrArg lean_r108 [And]
have lean_s175 : (Eq let78 let892) := by timed flipCongrArg lean_r111 [Not]
have lean_s176 : (Eq let81 let893) := by timed congr lean_s174 lean_s175
let lean_s177 := by timed congr lean_s157 lean_s176
let lean_s178 := by timed flipCongrArg lean_r74 [And]
have lean_s179 : (Eq let72 let890) := by timed flipCongrArg lean_r63 [Not]
have lean_s180 : (Eq let75 let891) := by timed congr lean_s178 lean_s179
...
have lean_s185 : (Eq let329 let902) := by timed congr lean_s161 lean_s184
have lean_s186 : (Eq let106 let902) := by timed Eq.trans lean_r66 lean_s185
let lean_s187 := by timed congr lean_s8 lean_s186
have lean_s188 : let848 := by timed rfl
let lean_s189 := by timed flipCongrArg lean_r93 [And]
have lean_s190 : (Eq let65 let887) := by timed flipCongrArg lean_r75 [Not]
have lean_s191 : (Eq let68 let888) := by timed congr lean_s189 lean_s190
let lean_s192 := by timed congr lean_s188 lean_s191
let lean_s193 := by timed flipCongrArg lean_r88 [And]
have lean_s194 : (Eq let59 let885) := by timed flipCongrArg lean_r106 [Not]
have lean_s195 : (Eq let62 let886) := by timed congr lean_s193 lean_s194
let lean_s196 := by timed congr lean_s188 lean_s195
let lean_s197 := by timed flipCongrArg lean_r78 [And]
have lean_s198 : (Eq let53 let883) := by timed flipCongrArg lean_r73 [Not]
have lean_s199 : (Eq let56 let884) := by timed congr lean_s197 lean_s198
let lean_s200 := by timed congr lean_s188 lean_s199
let lean_s201 := by timed flipCongrArg lean_r55 [And]
have lean_s202 : (Eq let47 let881) := by timed flipCongrArg lean_r68 [Not]
have lean_s203 : (Eq let50 let882) := by timed congr lean_s201 lean_s202
let lean_s204 := by timed congr lean_s188 lean_s203
let lean_s205 := by timed flipCongrArg lean_r81 [And]
have lean_s206 : (Eq let41 let879) := by timed flipCongrArg lean_r103 [Not]
have lean_s207 : (Eq let44 let880) := by timed congr lean_s205 lean_s206
let lean_s208 := by timed congr lean_s188 lean_s207
let lean_s209 := by timed flipCongrArg lean_r99 [And]
have lean_s210 : (Eq let35 let877) := by timed flipCongrArg lean_r101 [Not]
have lean_s211 : (Eq let38 let878) := by timed congr lean_s209 lean_s210
...
have lean_s216 : (Eq let549 let889) := by timed congr lean_s192 lean_s215
have lean_s217 : (Eq let69 let889) := by timed Eq.trans lean_r110 lean_s216
...
have lean_s228 : (Eq let251 let961) := by timed congr lean_s12 lean_s227
have lean_s229 : (Eq let252 let961) := by timed Eq.trans lean_r10 lean_s228
have lean_s230 : let849 := by timed rfl
have lean_s231 : let974 := by timed rfl
let lean_s232 := by timed flipCongrArg lean_s231 [Or]
let lean_s233 := by timed flipCongrArg lean_a129 [Eq]
have lean_s234 : let362 := by timed rfl
have lean_s235 : let860 := by timed congr lean_s233 lean_s234
have lean_s236 : (Eq let960 let967) := by timed congr lean_s232 lean_s235
let lean_s237 := by timed congr lean_s230 lean_s236
have lean_s238 : let973 := by timed rfl
let lean_s239 := by timed flipCongrArg lean_s238 [Or]
let lean_s240 := by timed flipCongrArg lean_a129 [Eq]
have lean_s241 : let859 := by timed rfl
have lean_s242 : let858 := by timed congr lean_s240 lean_s241
have lean_s243 : (Eq let959 let966) := by timed congr lean_s239 lean_s242
let lean_s244 := by timed congr lean_s230 lean_s243
have lean_s245 : let972 := by timed rfl
let lean_s246 := by timed flipCongrArg lean_s245 [Or]
let lean_s247 := by timed flipCongrArg lean_a129 [Eq]
have lean_s248 : let857 := by timed rfl
have lean_s249 : let856 := by timed congr lean_s247 lean_s248
have lean_s250 : (Eq let958 let965) := by timed congr lean_s246 lean_s249
...
let lean_s254 := by timed flipCongrArg lean_a129 [Eq]
have lean_s255 : let855 := by timed rfl
have lean_s256 : let854 := by timed congr lean_s254 lean_s255
have lean_s257 : (Eq let957 let964) := by timed congr lean_s253 lean_s256
let lean_s258 := by timed congr lean_s230 lean_s257
have lean_s259 : let970 := by timed rfl
let lean_s260 := by timed flipCongrArg lean_s259 [Or]
let lean_s261 := by timed flipCongrArg lean_a129 [Eq]
have lean_s262 : let853 := by timed rfl
have lean_s263 : let852 := by timed congr lean_s261 lean_s262
have lean_s264 : (Eq let956 let963) := by timed congr lean_s260 lean_s263
let lean_s265 := by timed congr lean_s230 lean_s264
have lean_s266 : let969 := by timed rfl
let lean_s267 := by timed flipCongrArg lean_s266 [Or]
let lean_s268 := by timed flipCongrArg lean_a129 [Eq]
have lean_s269 : let851 := by timed rfl
have lean_s270 : let850 := by timed congr lean_s268 lean_s269
have lean_s271 : (Eq let955 let962) := by timed congr lean_s267 lean_s270
let lean_s272 := by timed congr lean_s230 lean_s271
have lean_s273 : let848 := by timed rfl
have lean_s274 : (Eq let7 let7) := by timed rfl
let lean_s275 := by timed flipCongrArg lean_s274 [And]
let lean_s276 := by timed flipCongrArg lean_a129 [Eq]
have lean_s277 : let808 := by timed rfl
have lean_s278 : (Eq let9 let343) := by timed congr lean_s276 lean_s277
have lean_s279 : (Eq let952 let515) := by timed flipCongrArg lean_s278 [Not]
have lean_s280 : (Eq let953 let516) := by timed congr lean_s275 lean_s279
...
let lean_s284 := by timed flipCongrArg lean_a129 [Eq]
have lean_s285 : (Eq let11 let11) := by timed rfl
have lean_s286 : (Eq let15 let512) := by timed congr lean_s284 lean_s285
have lean_s287 : (Eq let950 let513) := by timed flipCongrArg lean_s286 [Not]
have lean_s288 : (Eq let951 let514) := by timed congr lean_s283 lean_s287
...
let lean_s292 := by timed flipCongrArg lean_a129 [Eq]
have lean_s293 : (Eq let224 let224) := by timed rfl
have lean_s294 : (Eq let377 let508) := by timed congr lean_s292 lean_s293
have lean_s295 : (Eq let948 let509) := by timed flipCongrArg lean_s294 [Not]
have lean_s296 : (Eq let949 let511) := by timed congr lean_s291 lean_s295
...
let lean_s300 := by timed flipCongrArg lean_a129 [Eq]
have lean_s301 : (Eq let17 let17) := by timed rfl
have lean_s302 : (Eq let370 let505) := by timed congr lean_s300 lean_s301
have lean_s303 : (Eq let946 let506) := by timed flipCongrArg lean_s302 [Not]
have lean_s304 : (Eq let947 let507) := by timed congr lean_s299 lean_s303
...
let lean_s308 := by timed flipCongrArg lean_a129 [Eq]
have lean_s309 : (Eq let21 let21) := by timed rfl
have lean_s310 : (Eq let356 let502) := by timed congr lean_s308 lean_s309
have lean_s311 : (Eq let944 let503) := by timed flipCongrArg lean_s310 [Not]
have lean_s312 : (Eq let945 let504) := by timed congr lean_s307 lean_s311
...
let lean_s316 := by timed flipCongrArg lean_a129 [Eq]
have lean_s317 : (Eq let25 let25) := by timed rfl
have lean_s318 : (Eq let307 let499) := by timed congr lean_s316 lean_s317
have lean_s319 : (Eq let942 let500) := by timed flipCongrArg lean_s318 [Not]
have lean_s320 : (Eq let943 let501) := by timed congr lean_s315 lean_s319
...
have lean_s325 : (Eq let954 let517) := by timed congr lean_s281 lean_s324
let lean_s326 := by timed congr lean_s230 lean_s325
have lean_s327 : let848 := by timed rfl
have lean_s328 : (Eq let303 let303) := by timed rfl
let lean_s329 := by timed flipCongrArg lean_s328 [And]
let lean_s330 := by timed flipCongrArg lean_a129 [Eq]
have lean_s331 : (Eq let208 let208) := by timed rfl
have lean_s332 : (Eq let309 let495) := by timed congr lean_s330 lean_s331
have lean_s333 : (Eq let939 let496) := by timed flipCongrArg lean_s332 [Not]
have lean_s334 : (Eq let940 let497) := by timed congr lean_s329 lean_s333
...
let lean_s338 := by timed flipCongrArg lean_a129 [Eq]
have lean_s339 : let801 := by timed rfl
have lean_s340 : (Eq let253 let492) := by timed congr lean_s338 lean_s339
have lean_s341 : (Eq let937 let493) := by timed flipCongrArg lean_s340 [Not]
have lean_s342 : (Eq let938 let494) := by timed congr lean_s337 lean_s341
...
let lean_s346 := by timed flipCongrArg lean_a129 [Eq]
have lean_s347 : (Eq let199 let199) := by timed rfl
have lean_s348 : (Eq let367 let489) := by timed congr lean_s346 lean_s347
have lean_s349 : (Eq let935 let490) := by timed flipCongrArg lean_s348 [Not]
have lean_s350 : (Eq let936 let491) := by timed congr lean_s345 lean_s349
...
let lean_s354 := by timed flipCongrArg lean_a129 [Eq]
have lean_s355 : (Eq let193 let193) := by timed rfl
have lean_s356 : (Eq let256 let486) := by timed congr lean_s354 lean_s355
have lean_s357 : (Eq let933 let487) := by timed flipCongrArg lean_s356 [Not]
have lean_s358 : (Eq let934 let488) := by timed congr lean_s353 lean_s357
...
let lean_s362 := by timed flipCongrArg lean_a129 [Eq]
have lean_s363 : (Eq let187 let187) := by timed rfl
have lean_s364 : (Eq let259 let483) := by timed congr lean_s362 lean_s363
have lean_s365 : (Eq let931 let484) := by timed flipCongrArg lean_s364 [Not]
have lean_s366 : (Eq let932 let485) := by timed congr lean_s361 lean_s365
...
let lean_s370 := by timed flipCongrArg lean_a129 [Eq]
have lean_s371 : (Eq let181 let181) := by timed rfl
have lean_s372 : (Eq let262 let480) := by timed congr lean_s370 lean_s371
have lean_s373 : (Eq let929 let481) := by timed flipCongrArg lean_s372 [Not]
have lean_s374 : (Eq let930 let482) := by timed congr lean_s369 lean_s373
...
have lean_s379 : (Eq let941 let498) := by timed congr lean_s335 lean_s378
let lean_s380 := by timed congr lean_s230 lean_s379
have lean_s381 : let848 := by timed rfl
have lean_s382 : (Eq let263 let263) := by timed rfl
let lean_s383 := by timed flipCongrArg lean_s382 [And]
let lean_s384 := by timed flipCongrArg lean_a129 [Eq]
have lean_s385 : (Eq let174 let174) := by timed rfl
have lean_s386 : (Eq let264 let476) := by timed congr lean_s384 lean_s385
have lean_s387 : (Eq let926 let477) := by timed flipCongrArg lean_s386 [Not]
have lean_s388 : (Eq let927 let478) := by timed congr lean_s383 lean_s387
...
let lean_s392 := by timed flipCongrArg lean_a129 [Eq]
have lean_s393 : (Eq let168 let168) := by timed rfl
have lean_s394 : (Eq let266 let473) := by timed congr lean_s392 lean_s393
have lean_s395 : (Eq let924 let474) := by timed flipCongrArg lean_s394 [Not]
have lean_s396 : (Eq let925 let475) := by timed congr lean_s391 lean_s395
...
let lean_s400 := by timed flipCongrArg lean_a129 [Eq]
have lean_s401 : let794 := by timed rfl
have lean_s402 : (Eq let268 let470) := by timed congr lean_s400 lean_s401
have lean_s403 : (Eq let922 let471) := by timed flipCongrArg lean_s402 [Not]
have lean_s404 : (Eq let923 let472) := by timed congr lean_s399 lean_s403
...
let lean_s408 := by timed flipCongrArg lean_a129 [Eq]
have lean_s409 : (Eq let156 let156) := by timed rfl
have lean_s410 : (Eq let321 let467) := by timed congr lean_s408 lean_s409
have lean_s411 : (Eq let920 let468) := by timed flipCongrArg lean_s410 [Not]
have lean_s412 : (Eq let921 let469) := by timed congr lean_s407 lean_s411
...
let lean_s416 := by timed flipCongrArg lean_a129 [Eq]
have lean_s417 : (Eq let150 let150) := by timed rfl
have lean_s418 : (Eq let292 let464) := by timed congr lean_s416 lean_s417
have lean_s419 : (Eq let918 let465) := by timed flipCongrArg lean_s418 [Not]
have lean_s420 : (Eq let919 let466) := by timed congr lean_s415 lean_s419
...
let lean_s424 := by timed flipCongrArg lean_a129 [Eq]
have lean_s425 : (Eq let144 let144) := by timed rfl
have lean_s426 : (Eq let270 let461) := by timed congr lean_s424 lean_s425
have lean_s427 : (Eq let916 let462) := by timed flipCongrArg lean_s426 [Not]
have lean_s428 : (Eq let917 let463) := by timed congr lean_s423 lean_s427
...
have lean_s433 : (Eq let928 let479) := by timed congr lean_s389 lean_s432
let lean_s434 := by timed congr lean_s230 lean_s433
have lean_s435 : let848 := by timed rfl
have lean_s436 : (Eq let273 let273) := by timed rfl
let lean_s437 := by timed flipCongrArg lean_s436 [And]
let lean_s438 := by timed flipCongrArg lean_a129 [Eq]
have lean_s439 : (Eq let137 let137) := by timed rfl
have lean_s440 : (Eq let274 let457) := by timed congr lean_s438 lean_s439
have lean_s441 : (Eq let913 let458) := by timed flipCongrArg lean_s440 [Not]
have lean_s442 : (Eq let914 let459) := by timed congr lean_s437 lean_s441
...
let lean_s446 := by timed flipCongrArg lean_a129 [Eq]
have lean_s447 : (Eq let131 let131) := by timed rfl
have lean_s448 : (Eq let277 let454) := by timed congr lean_s446 lean_s447
have lean_s449 : (Eq let911 let455) := by timed flipCongrArg lean_s448 [Not]
have lean_s450 : (Eq let912 let456) := by timed congr lean_s445 lean_s449
...
let lean_s454 := by timed flipCongrArg lean_a129 [Eq]
have lean_s455 : (Eq let125 let125) := by timed rfl
have lean_s456 : (Eq let279 let451) := by timed congr lean_s454 lean_s455
have lean_s457 : (Eq let909 let452) := by timed flipCongrArg lean_s456 [Not]
have lean_s458 : (Eq let910 let453) := by timed congr lean_s453 lean_s457
...
let lean_s462 := by timed flipCongrArg lean_a129 [Eq]
have lean_s463 : let787 := by timed rfl
have lean_s464 : (Eq let280 let448) := by timed congr lean_s462 lean_s463
have lean_s465 : (Eq let907 let449) := by timed flipCongrArg lean_s464 [Not]
have lean_s466 : (Eq let908 let450) := by timed congr lean_s461 lean_s465
...
let lean_s470 := by timed flipCongrArg lean_a129 [Eq]
have lean_s471 : (Eq let113 let113) := by timed rfl
have lean_s472 : (Eq let281 let445) := by timed congr lean_s470 lean_s471
have lean_s473 : (Eq let905 let446) := by timed flipCongrArg lean_s472 [Not]
have lean_s474 : (Eq let906 let447) := by timed congr lean_s469 lean_s473
...
let lean_s478 := by timed flipCongrArg lean_a129 [Eq]
have lean_s479 : (Eq let107 let107) := by timed rfl
have lean_s480 : (Eq let282 let442) := by timed congr lean_s478 lean_s479
have lean_s481 : (Eq let903 let443) := by timed flipCongrArg lean_s480 [Not]
have lean_s482 : (Eq let904 let444) := by timed congr lean_s477 lean_s481
...
have lean_s487 : (Eq let915 let460) := by timed congr lean_s443 lean_s486
let lean_s488 := by timed congr lean_s230 lean_s487
have lean_s489 : let848 := by timed rfl
have lean_s490 : (Eq let285 let285) := by timed rfl
let lean_s491 := by timed flipCongrArg lean_s490 [And]
let lean_s492 := by timed flipCongrArg lean_a129 [Eq]
have lean_s493 : (Eq let100 let100) := by timed rfl
have lean_s494 : (Eq let556 let438) := by timed congr lean_s492 lean_s493
have lean_s495 : (Eq let900 let439) := by timed flipCongrArg lean_s494 [Not]
have lean_s496 : (Eq let901 let440) := by timed congr lean_s491 lean_s495
...
let lean_s500 := by timed flipCongrArg lean_a129 [Eq]
have lean_s501 : (Eq let94 let94) := by timed rfl
have lean_s502 : (Eq let554 let434) := by timed congr lean_s500 lean_s501
have lean_s503 : (Eq let898 let435) := by timed flipCongrArg lean_s502 [Not]
have lean_s504 : (Eq let899 let437) := by timed congr lean_s499 lean_s503
...
let lean_s508 := by timed flipCongrArg lean_a129 [Eq]
have lean_s509 : (Eq let88 let88) := by timed rfl
have lean_s510 : (Eq let551 let430) := by timed congr lean_s508 lean_s509
have lean_s511 : (Eq let896 let431) := by timed flipCongrArg lean_s510 [Not]
have lean_s512 : (Eq let897 let433) := by timed congr lean_s507 lean_s511
...
let lean_s516 := by timed flipCongrArg lean_a129 [Eq]
have lean_s517 : (Eq let82 let82) := by timed rfl
have lean_s518 : (Eq let288 let427) := by timed congr lean_s516 lean_s517
have lean_s519 : (Eq let894 let428) := by timed flipCongrArg lean_s518 [Not]
have lean_s520 : (Eq let895 let429) := by timed congr lean_s515 lean_s519
...
let lean_s524 := by timed flipCongrArg lean_a129 [Eq]
have lean_s525 : let780 := by timed rfl
have lean_s526 : (Eq let550 let423) := by timed congr lean_s524 lean_s525
have lean_s527 : (Eq let892 let424) := by timed flipCongrArg lean_s526 [Not]
have lean_s528 : (Eq let893 let426) := by timed congr lean_s523 lean_s527
...
let lean_s532 := by timed flipCongrArg lean_a129 [Eq]
have lean_s533 : (Eq let70 let70) := by timed rfl
have lean_s534 : (Eq let324 let420) := by timed congr lean_s532 lean_s533
have lean_s535 : (Eq let890 let421) := by timed flipCongrArg lean_s534 [Not]
have lean_s536 : (Eq let891 let422) := by timed congr lean_s531 lean_s535
...
have lean_s541 : (Eq let902 let441) := by timed congr lean_s497 lean_s540
let lean_s542 := by timed congr lean_s230 lean_s541
have lean_s543 : let848 := by timed rfl
have lean_s544 : (Eq let378 let378) := by timed rfl
let lean_s545 := by timed flipCongrArg lean_s544 [And]
let lean_s546 := by timed flipCongrArg lean_a129 [Eq]
have lean_s547 : (Eq let63 let63) := by timed rfl
have lean_s548 : (Eq let353 let416) := by timed congr lean_s546 lean_s547
have lean_s549 : (Eq let887 let417) := by timed flipCongrArg lean_s548 [Not]
have lean_s550 : (Eq let888 let418) := by timed congr lean_s545 lean_s549
...
let lean_s554 := by timed flipCongrArg lean_a129 [Eq]
have lean_s555 : (Eq let57 let57) := by timed rfl
have lean_s556 : (Eq let547 let413) := by timed congr lean_s554 lean_s555
have lean_s557 : (Eq let885 let414) := by timed flipCongrArg lean_s556 [Not]
have lean_s558 : (Eq let886 let415) := by timed congr lean_s553 lean_s557
...
let lean_s562 := by timed flipCongrArg lean_a129 [Eq]
have lean_s563 : (Eq let51 let51) := by timed rfl
have lean_s564 : (Eq let351 let410) := by timed congr lean_s562 lean_s563
have lean_s565 : (Eq let883 let411) := by timed flipCongrArg lean_s564 [Not]
have lean_s566 : (Eq let884 let412) := by timed congr lean_s561 lean_s565
...
let lean_s570 := by timed flipCongrArg lean_a129 [Eq]
have lean_s571 : (Eq let45 let45) := by timed rfl
have lean_s572 : (Eq let332 let407) := by timed congr lean_s570 lean_s571
have lean_s573 : (Eq let881 let408) := by timed flipCongrArg lean_s572 [Not]
have lean_s574 : (Eq let882 let409) := by timed congr lean_s569 lean_s573
...
let lean_s578 := by timed flipCongrArg lean_a129 [Eq]
have lean_s579 : (Eq let39 let39) := by timed rfl
have lean_s580 : (Eq let544 let404) := by timed congr lean_s578 lean_s579
have lean_s581 : (Eq let879 let405) := by timed flipCongrArg lean_s580 [Not]
have lean_s582 : (Eq let880 let406) := by timed congr lean_s577 lean_s581
...
let lean_s586 := by timed flipCongrArg lean_a129 [Eq]
have lean_s587 : let773 := by timed rfl
have lean_s588 : (Eq let543 let400) := by timed congr lean_s586 lean_s587
have lean_s589 : (Eq let877 let401) := by timed flipCongrArg lean_s588 [Not]
have lean_s590 : (Eq let878 let403) := by timed congr lean_s585 lean_s589
...
have lean_s595 : (Eq let889 let419) := by timed congr lean_s551 lean_s594
...
have lean_s606 : (Eq let961 let968) := by timed congr lean_s237 lean_s605
have lean_s607 : let849 := by timed rfl
have lean_s608 : let974 := by timed rfl
let lean_s609 := by timed flipCongrArg lean_s608 [Or]
have lean_s610 : (Eq let967 let541) := by timed congr lean_s609 lean_r82
have lean_s611 : (Eq let967 True) := by timed Eq.trans lean_s610 lean_r98
let lean_s612 := by timed congr lean_s607 lean_s611
have lean_s613 : let973 := by timed rfl
let lean_s614 := by timed flipCongrArg lean_s613 [Or]
have lean_s615 : (Eq let966 let528) := by timed congr lean_s614 lean_r102
let lean_s616 := by timed congr lean_s607 lean_s615
have lean_s617 : let972 := by timed rfl
let lean_s618 := by timed flipCongrArg lean_s617 [Or]
have lean_s619 : (Eq let965 let526) := by timed congr lean_s618 lean_r71
let lean_s620 := by timed congr lean_s607 lean_s619
have lean_s621 : let971 := by timed rfl
let lean_s622 := by timed flipCongrArg lean_s621 [Or]
have lean_s623 : (Eq let964 let524) := by timed congr lean_s622 lean_r62
let lean_s624 := by timed congr lean_s607 lean_s623
have lean_s625 : let970 := by timed rfl
let lean_s626 := by timed flipCongrArg lean_s625 [Or]
have lean_s627 : (Eq let963 let522) := by timed congr lean_s626 lean_r67
let lean_s628 := by timed congr lean_s607 lean_s627
have lean_s629 : let969 := by timed rfl
let lean_s630 := by timed flipCongrArg lean_s629 [Or]
have lean_s631 : (Eq let962 let520) := by timed congr lean_s630 lean_r43
...
have lean_s654 : (Eq let968 let530) := by timed congr lean_s612 lean_s653
have lean_s655 : (Eq let968 let529) := by timed Eq.trans lean_s654 lean_r96
have lean_s656 : (Eq let961 let529) := by timed Eq.trans lean_s606 lean_s655
have lean_s657 : (Eq let252 let529) := by timed Eq.trans lean_s229 lean_s656
have lean_s658 : let529 := by timed eqResolve lean_a128 lean_s657
...
have lean_s661 : (Or let991 let23) := by timed @cnfAndPos [let23, let503] 0
have lean_s662 : (Or let23 let991) := by permutateOr lean_s661, [1, 0], (- 1)
have lean_s663 : (Or let995 (Or let993 let992)) := by timed cnfAndNeg [let335, let23]
have lean_s664 : let994 :=
  (scope (fun lean_a134 : let335 =>
    (scope (fun lean_a135 : let23 =>
      have lean_s664 : let853 := by timed rfl
      let lean_s665 := by timed flipCongrArg lean_s664 [op]
      have lean_s666 : let24 := by timed Eq.symm lean_a135
      have lean_s667 : let23 := by timed Eq.symm lean_s666
      let lean_s668 := by timed flipCongrArg lean_s664 [op]
      have lean_s669 : let624 := by timed Eq.symm lean_a134
      have lean_s670 : (Eq let22 let76) := by timed congr lean_s668 lean_s669
      have lean_s671 : let423 := by timed Eq.trans lean_s667 lean_s670
      have lean_s672 : (Eq let21 let79) := by timed congr lean_s665 lean_s671
      have lean_s673 : let425 := by timed Eq.trans lean_a134 lean_s672
      show let425 from lean_s673
  ))))
have lean_s665 : (Implies let995 let425) := by liftOrNToImp lean_s664, 2
have lean_s666 : (Or (Not let995) let425) := by timed impliesElim lean_s665
have lean_s667 : let994 := by R1 lean_s663, lean_s666, let995, [(- 1), (- 1)]
have lean_s668 : (Or let992 (Or let425 let993)) := by permutateOr lean_s667, [1, 2, 0], (- 1)
have lean_s669 : let522 := by andElim lean_s658, 3
have lean_s670 : let849 := by timed rfl
have lean_s671 : (Eq let396 let875) := by timed flipCongrArg lean_r102 [Not]
let lean_s672 := by timed congr lean_s670 lean_s671
have lean_s673 : (Eq let394 let874) := by timed flipCongrArg lean_r71 [Not]
let lean_s674 := by timed congr lean_s670 lean_s673
have lean_s675 : (Eq let393 let873) := by timed flipCongrArg lean_r62 [Not]
let lean_s676 := by timed congr lean_s670 lean_s675
have lean_s677 : (Eq let392 let872) := by timed flipCongrArg lean_r67 [Not]
let lean_s678 := by timed congr lean_s670 lean_s677
have lean_s679 : (Eq let391 let861) := by timed flipCongrArg lean_r43 [Not]
let lean_s680 := by timed congr lean_s670 lean_s679
have lean_s681 : (Eq let390 let871) := by timed flipCongrArg lean_r91 [Not]
let lean_s682 := by timed congr lean_s670 lean_s681
have lean_s683 : (Eq let389 let870) := by timed flipCongrArg lean_r90 [Not]
let lean_s684 := by timed congr lean_s670 lean_s683
have lean_s685 : (Eq let388 let869) := by timed flipCongrArg lean_r95 [Not]
let lean_s686 := by timed congr lean_s670 lean_s685
have lean_s687 : (Eq let386 let868) := by timed flipCongrArg lean_r46 [Not]
let lean_s688 := by timed congr lean_s670 lean_s687
have lean_s689 : (Eq let385 let867) := by timed flipCongrArg lean_r76 [Not]
let lean_s690 := by timed congr lean_s670 lean_s689
have lean_s691 : (Eq let384 let866) := by timed flipCongrArg lean_r80 [Not]
let lean_s692 := by timed congr lean_s670 lean_s691
have lean_s693 : (Eq let383 let865) := by timed flipCongrArg lean_r105 [Not]
let lean_s694 := by timed congr lean_s670 lean_s693
have lean_s695 : (Eq let381 let864) := by timed flipCongrArg lean_r41 [Not]
let lean_s696 := by timed congr lean_s670 lean_s695
have lean_s697 : (Eq let380 let863) := by timed flipCongrArg lean_r72 [Not]
let lean_s698 := by timed congr lean_s670 lean_s697
have lean_s699 : (Eq let379 let862) := by timed flipCongrArg lean_r58 [Not]
...
have lean_s713 : (Eq let397 let876) := by timed congr lean_s672 lean_s712
have lean_s714 : (Eq let398 let876) := by timed Eq.trans lean_r94 lean_s713
have lean_s715 : let876 := by timed eqResolve lean_a131 lean_s714
have lean_s716 : let872 := by andElim lean_s715, 3
have lean_s717 : let521 := by R1 lean_s669, lean_s716, let330, [(- 1), 0]
let lean_s718 := by R1 lean_s668, lean_s717, let425, [(- 1), 0]
have lean_s719 : let849 := by timed rfl
...
have lean_s743 : (Eq let538 let845) := by timed congr lean_s720 lean_s742
have lean_s744 : (Eq let539 let845) := by timed Eq.trans lean_r97 lean_s743
have lean_s745 : let849 := by timed rfl
have lean_s746 : let362 := by timed rfl
let lean_s747 := by timed flipCongrArg lean_s746 [Eq]
let lean_s748 := by timed flipCongrArg lean_a129 [op]
...
have lean_s809 : (Eq let364 let25) := by timed congr lean_s808 lean_a129
have lean_s810 : (Eq let365 let333) := by timed congr lean_s807 lean_s809
let lean_s811 := by timed congr lean_s745 lean_s810
have lean_s812 : let848 := by timed rfl
let lean_s813 := by timed flipCongrArg lean_a129 [Eq]
have lean_s814 : let860 := by timed congr lean_s813 lean_s746
let lean_s815 := by timed congr lean_s812 lean_s814
let lean_s816 := by timed flipCongrArg lean_a129 [Eq]
have lean_s817 : let858 := by timed congr lean_s816 lean_s757
let lean_s818 := by timed congr lean_s812 lean_s817
let lean_s819 := by timed flipCongrArg lean_a129 [Eq]
have lean_s820 : let856 := by timed congr lean_s819 lean_s768
let lean_s821 := by timed congr lean_s812 lean_s820
let lean_s822 := by timed flipCongrArg lean_a129 [Eq]
have lean_s823 : let854 := by timed congr lean_s822 lean_s779
let lean_s824 := by timed congr lean_s812 lean_s823
let lean_s825 := by timed flipCongrArg lean_a129 [Eq]
have lean_s826 : let852 := by timed congr lean_s825 lean_s790
let lean_s827 := by timed congr lean_s812 lean_s826
let lean_s828 := by timed flipCongrArg lean_a129 [Eq]
have lean_s829 : let850 := by timed congr lean_s828 lean_s801
...
have lean_s834 : (Eq let548 let846) := by timed congr lean_s815 lean_s833
...
have lean_s846 : (Eq let845 let847) := by timed congr lean_s751 lean_s845
have lean_s847 : let849 := by timed rfl
...
have lean_s871 : let848 := by timed rfl
...
have lean_s881 : (Eq let846 let369) := by timed congr lean_s872 lean_s880
have lean_s882 : (Eq let846 True) := by timed Eq.trans lean_s881 lean_r86
...
have lean_s894 : (Eq let847 let345) := by timed congr lean_s849 lean_s893
have lean_s895 : (Eq let847 let344) := by timed Eq.trans lean_s894 lean_r69
have lean_s896 : (Eq let845 let344) := by timed Eq.trans lean_s846 lean_s895
...
have lean_s899 : let335 := by andElim lean_s898, 8
have lean_s900 : let992 := by R2 lean_s718, lean_s899, let335, [(- 1), 0]
have lean_s901 : let991 := by R1 lean_s662, lean_s900, let23, [(- 1), 0]
let lean_s902 := by R1 lean_s660, lean_s901, let504, [(- 1), 0]
have lean_s903 : (Or let986 let19) := by timed @cnfAndPos [let19, let506] 0
have lean_s904 : (Or let19 let986) := by permutateOr lean_s903, [1, 0], (- 1)
have lean_s905 : (Or let990 (Or let988 let987)) := by timed cnfAndNeg [let337, let19]
have lean_s906 : let989 :=
  (scope (fun lean_a136 : let337 =>
    (scope (fun lean_a137 : let19 =>
      have lean_s906 : let855 := by timed rfl
      let lean_s907 := by timed flipCongrArg lean_s906 [op]
      have lean_s908 : let20 := by timed Eq.symm lean_a137
      have lean_s909 : let19 := by timed Eq.symm lean_s908
      let lean_s910 := by timed flipCongrArg lean_s906 [op]
      have lean_s911 : let661 := by timed Eq.symm lean_a136
      ...
      have lean_s915 : let372 := by timed Eq.trans lean_a136 lean_s914
      show let372 from lean_s915
  ))))
have lean_s907 : (Implies let990 let372) := by liftOrNToImp lean_s906, 2
have lean_s908 : (Or (Not let990) let372) := by timed impliesElim lean_s907
have lean_s909 : let989 := by R1 lean_s905, lean_s908, let990, [(- 1), (- 1)]
have lean_s910 : (Or let987 (Or let372 let988)) := by permutateOr lean_s909, [1, 2, 0], (- 1)
have lean_s911 : let524 := by andElim lean_s658, 2
have lean_s912 : let873 := by andElim lean_s715, 2
...
have lean_s916 : let987 := by R2 lean_s914, lean_s915, let337, [(- 1), 0]
have lean_s917 : let986 := by R1 lean_s904, lean_s916, let19, [(- 1), 0]
let lean_s918 := by R1 lean_s902, lean_s917, let507, [(- 1), 0]
have lean_s919 : (Or let981 let510) := by timed @cnfAndPos [let510, let509] 0
have lean_s920 : (Or let510 let981) := by permutateOr lean_s919, [1, 0], (- 1)
have lean_s921 : (Or let985 (Or let983 let982)) := by timed cnfAndNeg [let339, let510]
have lean_s922 : let984 :=
  (scope (fun lean_a138 : let339 =>
    (scope (fun lean_a139 : let510 =>
      have lean_s922 : let857 := by timed rfl
      let lean_s923 := by timed flipCongrArg lean_s922 [op]
      have lean_s924 : let228 := by timed Eq.symm lean_a139
      have lean_s925 : let510 := by timed Eq.symm lean_s924
      let lean_s926 := by timed flipCongrArg lean_s922 [op]
      have lean_s927 : let698 := by timed Eq.symm lean_a138
      ...
      have lean_s931 : let267 := by timed Eq.trans lean_a138 lean_s930
      show let267 from lean_s931
  ))))
have lean_s923 : (Implies let985 let267) := by liftOrNToImp lean_s922, 2
have lean_s924 : (Or (Not let985) let267) := by timed impliesElim lean_s923
have lean_s925 : let984 := by R1 lean_s921, lean_s924, let985, [(- 1), (- 1)]
have lean_s926 : (Or let982 (Or let267 let983)) := by permutateOr lean_s925, [1, 2, 0], (- 1)
have lean_s927 : let526 := by andElim lean_s658, 1
have lean_s928 : let874 := by andElim lean_s715, 1
...
have lean_s932 : let982 := by R2 lean_s930, lean_s931, let339, [(- 1), 0]
have lean_s933 : let981 := by R1 lean_s920, lean_s932, let510, [(- 1), 0]
let lean_s934 := by R1 lean_s918, lean_s933, let511, [(- 1), 0]
have lean_s935 : (Or let976 let13) := by timed @cnfAndPos [let13, let513] 0
have lean_s936 : (Or let13 let976) := by permutateOr lean_s935, [1, 0], (- 1)
have lean_s937 : (Or let980 (Or let978 let977)) := by timed cnfAndNeg [let341, let13]
have lean_s938 : let979 :=
  (scope (fun lean_a140 : let341 =>
    (scope (fun lean_a141 : let13 =>
      have lean_s938 : let859 := by timed rfl
      let lean_s939 := by timed flipCongrArg lean_s938 [op]
      have lean_s940 : let14 := by timed Eq.symm lean_a141
      have lean_s941 : let13 := by timed Eq.symm lean_s940
      let lean_s942 := by timed flipCongrArg lean_s938 [op]
      have lean_s943 : let735 := by timed Eq.symm lean_a140
      ...
      have lean_s947 : let31 := by timed Eq.trans lean_a140 lean_s946
      show let31 from lean_s947
  ))))
have lean_s939 : (Implies let980 let31) := by liftOrNToImp lean_s938, 2
have lean_s940 : (Or (Not let980) let31) := by timed impliesElim lean_s939
have lean_s941 : let979 := by R1 lean_s937, lean_s940, let980, [(- 1), (- 1)]
have lean_s942 : (Or let977 (Or let31 let978)) := by permutateOr lean_s941, [1, 2, 0], (- 1)
have lean_s943 : let528 := by andElim lean_s658, 0
have lean_s944 : let875 := by andElim lean_s715, 0
...
have lean_s948 : let977 := by R2 lean_s946, lean_s947, let341, [(- 1), 0]
have lean_s949 : let976 := by R1 lean_s936, lean_s948, let13, [(- 1), 0]
let lean_s950 := by R1 lean_s934, lean_s949, let514, [(- 1), 0]
have lean_s951 : (Or let975 let515) := by timed @cnfAndPos [let7, let515] 1
have lean_s952 : (Or let515 let975) := by permutateOr lean_s951, [1, 0], (- 1)
have lean_s953 : let343 := by andElim lean_s898, 0
have lean_s954 : let975 := by R2 lean_s952, lean_s953, let343, [(- 1), 0]
have lean_s955 : let501 := by R1 lean_s950, lean_s954, let516, [(- 1), 0]
have lean_s956 : let27 := by R2 lean_s7, lean_s955, let501, [(- 1), 0]
let lean_s957 := by R2 lean_s5, lean_s956, let27, [(- 1), 0]
have lean_s958 : let520 := by andElim lean_s658, 4
have lean_s959 : let861 := by andElim lean_s715, 4
have lean_s960 : let519 := by R1 lean_s958, lean_s959, let286, [(- 1), 0]
let lean_s961 := by R1 lean_s957, lean_s960, let402, [(- 1), 0]
have lean_s962 : let333 := by andElim lean_s898, 10
exact (show False from by R2 lean_s961, lean_s962, let333, [0, 0])
