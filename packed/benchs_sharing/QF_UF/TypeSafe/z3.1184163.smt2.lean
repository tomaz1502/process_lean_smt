...
theorem th0 :
  ...
  let let6 := (Eq f10 let1)
  let let7 := (Eq f1 let2)
  let let8 := (Not let7)
  let let9 := (Not let3)
  let let10 := (Eq f1 let5)
(Eq let3 True) → (Eq let4 False) → (Not (Eq f1 f2)) → (Not (Eq let2 f1)) → (Eq let5 f1) → let6 → False :=
  let let1 := (f8 f9)
  let let2 := (f3 f4 f5 f6 f7 let1)
  let let3 := (Eq let2 let2)
  let let4 := (Not True)
...
fun lean_a4 : (Eq let5 f1) =>
fun lean_a5 : let6 => by
have lean_s0 : let8 := by timed negSymm lean_a3
have lean_s1 : let10 := by timed Eq.symm lean_a4
have lean_s2 : (And let6 let10) := by timed And.intro lean_a5 lean_s1
have lean_s3 : let10 := by andElim lean_s2, 1
...
have lean_s12 : let6 := by andElim lean_s2, 0
have lean_s13 : (Eq let5 let2) := by timed congr lean_s11 lean_s12
have lean_s14 : let7 := by timed Eq.trans lean_s3 lean_s13
let lean_s15 := by timed flipCongrArg lean_s14 [Eq]
have lean_s16 : let3 := by timed rfl
have lean_s17 : (Eq let7 let3) := by timed congr lean_s15 lean_s16
have lean_s18 : (Eq let8 let9) := by timed flipCongrArg lean_s17 [Not]
have lean_s19 : (Eq let9 let4) := by timed flipCongrArg lean_r0 [Not]
have lean_s20 : (Eq let9 False) := by timed Eq.trans lean_s19 lean_r1
have lean_s21 : (Eq let8 False) := by timed Eq.trans lean_s18 lean_s20
