...
theorem th0 :
  let let1 := (Eq TRUE gx5fs46x5f61)
  let let2 := (Eq gx5fs46x5f61 TRUE)
  let let3 := (Eq TRUE gx5fs49x5f64)
  let let4 := (Eq gx5fs49x5f64 TRUE)
  let let5 := (Eq gx5fs50x241x5f71 gx5fs52x241x5f73)
  let let6 := (Eq gx5fs52x241x5f73 gx5fs50x241x5f71)
  let let7 := (Eq gx5fs50x241x5f71 gx5fs51x241x5f72)
  let let8 := (Eq gx5fs51x241x5f72 gx5fs50x241x5f71)
  let let9 := (Eq gx5fs51x241x5f72 gx5fs52x241x5f73)
  let let10 := (Eq gx5fs52x241x5f73 gx5fs51x241x5f72)
  let let11 := (Eq empty gx5fs15x5f16)
  let let12 := (Eq gx5fs15x5f16 empty)
  let let13 := (Implies True True)
  let let14 := (x3cx3di (x2bi (idiv (x2bi (x2bi gx5fs20x5f28 gx5fs24x5f32) gx5fs23x5f31) gx5fs17x5f18) e22) gx5fs32x5f47)
  let let15 := (Eq gx5fs32x5f47 (size gx5fs31x5f46))
  let let16 := (mem gx5fs32x5f47 NAT1)
  let let17 := (mem gx5fs31x5f46 (perm gx5fs15x5f16))
  let let18 := (x2ai e45 e24)
  let let19 := (Eq gx5fs30x5f43 let18)
  let let20 := (x2ai e36 e24)
  let let21 := (Eq gx5fs29x5f42 let20)
  let let22 := (x2ai e44 e24)
  let let23 := (Eq gx5fs28x5f41 let22)
  let let24 := (x2ai e27 e24)
  let let25 := (Eq gx5fs27x5f40 let24)
  let let26 := (Eq gx5fs26x5f39 let22)
  let let27 := (mem gx5fs30x5f43 NAT1)
  let let28 := (mem gx5fs29x5f42 NAT1)
  let let29 := (mem gx5fs28x5f41 NAT1)
  let let30 := (mem gx5fs27x5f40 NAT1)
  let let31 := (mem gx5fs26x5f39 NAT1)
  let let32 := (And let31 (And let30 (And let29 (And let28 (And let27 (And let26 (And let25 (And let23 (And let21 (And let19 (And let17 (And let16 (And let15 let14)))))))))))))
  let let33 := (Eq gx5fs25x5f38 e25)
  let let34 := (x3ex3di (idiv gx5fs20x5f28 gx5fs18x5f21) e37)
  let let35 := (x3ex3di (x2bi (x2bi gx5fs22x5f30 gx5fs24x5f32) gx5fs23x5f31) gx5fs17x5f18)
  let let36 := (x3ex3di (x2di gx5fs20x5f28 gx5fs21x5f29) gx5fs17x5f18)
  let let37 := (Eq gx5fs24x5f32 e36)
  let let38 := (Eq gx5fs23x5f31 e35)
  let let39 := (Eq gx5fs22x5f30 e34)
  let let40 := (Eq gx5fs21x5f29 e33)
  let let41 := (Eq gx5fs20x5f28 e24)
  let let42 := (mem gx5fs24x5f32 NAT1)
  let let43 := (mem gx5fs23x5f31 NAT1)
  let let44 := (mem gx5fs22x5f30 NAT1)
  let let45 := (mem gx5fs21x5f29 NAT1)
  let let46 := (mem gx5fs20x5f28 NAT1)
  let let47 := (And let46 (And let45 (And let44 (And let43 (And let42 (And let41 (And let40 (And let39 (And let38 (And let37 (And let36 (And let35 (And let34 (And let33 let32))))))))))))))
  let let48 := (x3cx3di gx5fs19x5f26 e27)
  let let49 := (x3ex3di gx5fs19x5f26 e22)
  let let50 := (Eq gx5fs18x5f21 (x2bi (idiv (x2ai e25 e24) (x2ai e23 e23)) e22))
  let let51 := (mem gx5fs18x5f21 NAT1)
  let let52 := (Eq gx5fs17x5f18 e20)
  let let53 := (Eq gx5fs16x5f17 e19)
  let let54 := (mem gx5fs17x5f18 NAT1)
  let let55 := (mem gx5fs16x5f17 NAT1)
  let let56 := (Not let12)
  let let57 := (Eq gx5fs12x5f13 (SET (mapplet gx5fs14x5f15 gx5fs13x5f14)))
  let let58 := (Eq gx5fs9x5f10 (SET (mapplet gx5fs11x5f12 gx5fs10x5f11)))
  let let59 := (Eq gx5fs6x5f7 (SET (mapplet gx5fs8x5f9 gx5fs7x5f8)))
  let let60 := (Eq gx5fs3x5f4 (SET (mapplet gx5fs5x5f6 gx5fs4x5f5)))
  let let61 := (Eq gx5fs0x5f1 (SET (mapplet gx5fs2x5f3 gx5fs1x5f2)))
  let let62 := (And let61 (And let60 (And let59 (And let58 (And let57 (And let56 (And let55 (And let54 (And let53 (And let52 (And let51 (And let50 (And let49 (And let48 let47))))))))))))))
  let let63 := (And let61 (And let60 (And let59 (And let58 (And let57 (And let56 (And let55 (And let54 (And let53 (And let52 (And let51 (And let50 (And (And let49 let48) let47)))))))))))))
  let let64 := (Eq e24 gx5fs20x5f28)
  let let65 := (Eq gx5fs52x241x5f73 gx5fs52x241x5f73)
  let let66 := (Eq e33 gx5fs21x5f29)
  let let67 := (Eq e35 gx5fs23x5f31)
  let let68 := (Eq gx5fs49x5f64 gx5fs49x5f64)
  let let69 := (Eq e20 gx5fs17x5f18)
  let let70 := (Eq e25 gx5fs25x5f38)
  let let71 := (Not True)
  let let72 := (Eq e36 gx5fs24x5f32)
  let let73 := (Eq e34 gx5fs22x5f30)
  let let74 := (And True (And True (And True True)))
  let let75 := (Eq e19 gx5fs16x5f17)
  let let76 := (And lhx5f1 (And lhx5f2 (And lhx5f3 lhx5f4)))
  let let77 := (Implies let76 let10)
  let let78 := (Not let77)
  let let79 := (Eq INT (interval MinInt MaxInt))
  let let80 := (Eq NAT (interval e0 MaxInt))
  let let81 := (And let80 let79)
  let let82 := (Eq defx5fBx20definitions let81)
  let let83 := (Eq defx5fctx let63)
  let let84 := (Eq defx5fseext (And (mem gx5fs33x5f48 BOOL) (And (mem gx5fs34x5f49 gx5fs9x5f10) (And (mem gx5fs35x5f50 gx5fs9x5f10) (And (mem gx5fs36x5f51 gx5fs9x5f10) (And (mem gx5fs37x5f52 gx5fs9x5f10) (And (mem gx5fs38x5f53 BOOL) (And (mem gx5fs39x5f54 BOOL) (And (mem gx5fs40x5f55 BOOL) (And (mem gx5fs41x5f56 BOOL) (And (mem gx5fs42x5f57 BOOL) (And (mem gx5fs43x5f58 BOOL) (And (mem gx5fs44x5f59 BOOL) (mem gx5fs45x5f60 BOOL))))))))))))))
  let let85 := (Eq defx5fmchcst True)
  let let86 := (Eq defx5faprp True)
  let let87 := (Eq defx5fabs (And (mem gx5fs46x5f61 BOOL) (And (mem gx5fs47x5f62 gx5fs0x5f1) (And (mem gx5fs48x5f63 gx5fs6x5f7) (And (mem gx5fs49x5f64 BOOL) (And (mem gx5fs50x5f65 BOOL) (And (mem gx5fs51x5f66 BOOL) (And (mem gx5fs52x5f67 BOOL) (And (x3ci e20 gx5fs25x5f38) (x3ei (idiv (x2ai (x2ai e27 gx5fs17x5f18) e24) gx5fs25x5f38) e68))))))))))
  let let88 := (Eq gx5fs52x5f67 gx5fs52x241x5f73)
  let let89 := (Eq gx5fs51x5f66 gx5fs51x241x5f72)
  let let90 := (Eq gx5fs50x5f65 gx5fs50x241x5f71)
  let let91 := (Eq gx5fs48x5f63 gx5fs48x241x5f70)
  let let92 := (Eq gx5fs47x5f62 gx5fs47x241x5f69)
  let let93 := (And let92 (And let91 (And let90 (And let89 let88))))
  let let94 := (Eq defx5finv let93)
  let let95 := (Eq defx5fass True)
  let let96 := (Eq defx5fsets True)
  let let97 := (Eq defx5fimlprp True)
  let let98 := (Eq defx5fimprp True)
  let let99 := (Eq defx5fimext True)
  let let100 := (Eq lhx5f1 let2)
  let let101 := (Eq lhx5f2 let4)
  let let102 := (Eq lhx5f3 let6)
  let let103 := (Eq lhx5f4 let8)
  let let104 := (And let1 (And let3 (And let5 let7)))
  let let105 := (Implies let104 let9)
  let let106 := (Not let105)
  let let107 := (And let68 (And let68 (And let65 let65)))
  let let108 := (Implies let107 let65)
  let let109 := (Not let108)
  let let110 := (Eq And And)
  let let111 := (And let70 (And let72 (And let67 (And let73 (And let66 (And let64 (And let50 (And let69 (And let75 (And let57 (And let58 (And let59 (And let60 (And let61 (And let79 let80)))))))))))))))
  let let112 := (x2ai e44 gx5fs20x5f28)
  let let113 := (Eq gx5fs26x5f39 let112)
  let let114 := (And let113 let111)
  let let115 := (x2ai e27 gx5fs20x5f28)
  let let116 := (Eq gx5fs27x5f40 let115)
  let let117 := (And let116 let114)
  let let118 := (Eq gx5fs28x5f41 let112)
  let let119 := (And let118 let117)
  let let120 := (x2ai gx5fs24x5f32 gx5fs20x5f28)
  let let121 := (Eq gx5fs29x5f42 let120)
  let let122 := (And let121 let119)
  let let123 := (x2ai e45 gx5fs20x5f28)
  let let124 := (Eq gx5fs30x5f43 let123)
  let let125 := (Eq gx5fs54x5f74 gx5fs54x241x5f75)
  let let126 := (And let1 (And let125 (And let88 (And let89 (And let90 (And let91 (And let92 (And let15 (And let124 let122)))))))))
  let let127 := (Eq gx5fs46x5f61 gx5fs49x5f64)
  let let128 := (And let5 (And let127 let126))
  let let129 := (Not let11)
  let let130 := (And let61 (And let60 (And let59 (And let58 (And let57 (And let129 (And let55 (And let54 (And let75 (And let69 (And let51 (And let50 (And let49 (And let48 (And let46 (And let45 (And let44 (And let43 (And let42 (And let64 (And let66 (And let73 (And let67 (And let72 (And let36 (And let35 (And let34 (And let70 let32))))))))))))))))))))))))))))
  let let131 := (Eq let22 let112)
  let let132 := (Eq e44 e44)
  let let133 := (And let2 (And let4 (And let6 let8)))
  let let134 := (Implies let133 let10)
  let let135 := (Not let134)
(Eq let2 let1) → (Eq let4 let3) → (Eq let6 let5) → (Eq let8 let7) → (Eq let10 let9) → (Eq let12 let11) → (Eq let13 True) → (Eq let63 let62) → (Eq let41 let64) → (Eq let65 True) → (Eq let40 let66) → (Eq let38 let67) → (Eq let68 True) → (Eq let52 let69) → (Eq let33 let70) → (Eq let71 False) → (Eq let37 let72) → (Eq let39 let73) → (Eq let74 True) → (Eq let53 let75) → (Not (Eq TRUE FALSE)) → defx5fBx20definitions → defx5fctx → defx5fmchcst → defx5faprp → defx5fimlprp → defx5fimprp → defx5fimext → defx5fseext → defx5fabs → defx5finv → defx5fass → (Eq gx5fs54x241x5f75 gx5fs54x5f74) → let78 → let82 → let83 → let84 → let85 → let86 → let87 → let94 → let95 → let96 → let97 → let98 → let99 → let100 → let101 → let102 → let103 → False :=
  let let1 := (Eq TRUE gx5fs46x5f61)
  let let2 := (Eq gx5fs46x5f61 TRUE)
  let let3 := (Eq TRUE gx5fs49x5f64)
  let let4 := (Eq gx5fs49x5f64 TRUE)
...
fun lean_r6 : (Eq let13 True) => -- THEORY_REWRITE_BOOL
fun lean_r7 : (Eq let63 let62) => -- THEORY_REWRITE_BOOL
fun lean_r8 : (Eq let41 let64) => -- THEORY_REWRITE_UF
fun lean_r9 : (Eq let65 True) => -- THEORY_REWRITE_UF
fun lean_r10 : (Eq let40 let66) => -- THEORY_REWRITE_UF
fun lean_r11 : (Eq let38 let67) => -- THEORY_REWRITE_UF
fun lean_r12 : (Eq let68 True) => -- THEORY_REWRITE_UF
fun lean_r13 : (Eq let52 let69) => -- THEORY_REWRITE_UF
fun lean_r14 : (Eq let33 let70) => -- THEORY_REWRITE_UF
fun lean_r15 : (Eq let71 False) => -- THEORY_REWRITE_BOOL
fun lean_r16 : (Eq let37 let72) => -- THEORY_REWRITE_UF
fun lean_r17 : (Eq let39 let73) => -- THEORY_REWRITE_UF
fun lean_r18 : (Eq let74 True) => -- THEORY_REWRITE_BOOL
fun lean_r19 : (Eq let53 let75) => -- THEORY_REWRITE_UF
...
fun lean_a47 : let101 =>
fun lean_a48 : let102 =>
fun lean_a49 : let103 => by
have lean_s0 : let110 := by timed rfl
...
have lean_s15 : (And let103 (And let102 (And let101 (And let100 (And let99 (And let98 (And let97 (And let96 (And let95 (And let94 (And let87 (And let86 (And let85 (And let84 (And let83 let82))))))))))))))) := by timed And.intro lean_a49 lean_s14
have lean_s16 : let100 := by andElim lean_s15, 3
let lean_s17 := by timed congr lean_s0 lean_s16
have lean_s18 : let101 := by andElim lean_s15, 2
let lean_s19 := by timed congr lean_s0 lean_s18
have lean_s20 : let102 := by andElim lean_s15, 1
let lean_s21 := by timed congr lean_s0 lean_s20
have lean_s22 : let103 := by andElim lean_s15, 0
let lean_s23 := by timed congr lean_s21 lean_s22
let lean_s24 := by timed congr lean_s19 lean_s23
have lean_s25 : (Eq let76 let133) := by timed congr lean_s17 lean_s24
let lean_s26 := by timed flipCongrArg lean_s25 [Implies]
have lean_s27 : (Eq let10 let10) := by timed rfl
have lean_s28 : (Eq let77 let134) := by timed congr lean_s26 lean_s27
have lean_s29 : (Eq let78 let135) := by timed flipCongrArg lean_s28 [Not]
have lean_s30 : let110 := by timed rfl
...
have lean_s36 : (Eq let133 let104) := by timed congr lean_s31 lean_s35
let lean_s37 := by timed flipCongrArg lean_s36 [Implies]
have lean_s38 : (Eq let134 let105) := by timed congr lean_s37 lean_r4
have lean_s39 : (Eq let135 let106) := by timed flipCongrArg lean_s38 [Not]
have lean_s40 : (Eq let78 let106) := by timed Eq.trans lean_s29 lean_s39
have lean_s41 : let110 := by timed rfl
have lean_s42 : let106 := by timed eqResolve lean_a33 lean_s40
have lean_s43 : let104 := by timed notImplies1 lean_s42
have lean_s44 : let7 := by andElim lean_s43, 3
have lean_s45 : let104 := by timed notImplies1 lean_s42
have lean_s46 : let5 := by andElim lean_s45, 2
have lean_s47 : let104 := by timed notImplies1 lean_s42
have lean_s48 : let3 := by andElim lean_s47, 1
have lean_s49 : let104 := by timed notImplies1 lean_s42
have lean_s50 : let1 := by andElim lean_s49, 0
have lean_s51 : let125 := by timed Eq.symm lean_a32
have lean_s52 : let93 := by timed eqResolve lean_a30 lean_a40
have lean_s53 : let88 := by andElim lean_s52, 4
have lean_s54 : let93 := by timed eqResolve lean_a30 lean_a40
have lean_s55 : let89 := by andElim lean_s54, 3
have lean_s56 : let93 := by timed eqResolve lean_a30 lean_a40
have lean_s57 : let90 := by andElim lean_s56, 2
have lean_s58 : let93 := by timed eqResolve lean_a30 lean_a40
have lean_s59 : let91 := by andElim lean_s58, 1
have lean_s60 : let93 := by timed eqResolve lean_a30 lean_a40
have lean_s61 : let92 := by andElim lean_s60, 0
have lean_s62 : let83 := by andElim lean_s15, 14
have lean_s63 : let110 := by timed rfl
have lean_s64 : (Eq let61 let61) := by timed rfl
let lean_s65 := by timed congr lean_s63 lean_s64
have lean_s66 : (Eq let60 let60) := by timed rfl
let lean_s67 := by timed congr lean_s63 lean_s66
have lean_s68 : (Eq let59 let59) := by timed rfl
...
have lean_s72 : (Eq let57 let57) := by timed rfl
let lean_s73 := by timed congr lean_s63 lean_s72
have lean_s74 : (Eq let56 let129) := by timed flipCongrArg lean_r5 [Not]
let lean_s75 := by timed congr lean_s63 lean_s74
have lean_s76 : (Eq let55 let55) := by timed rfl
let lean_s77 := by timed congr lean_s63 lean_s76
have lean_s78 : (Eq let54 let54) := by timed rfl
...
have lean_s82 : (Eq let51 let51) := by timed rfl
let lean_s83 := by timed congr lean_s63 lean_s82
have lean_s84 : (Eq let50 let50) := by timed rfl
let lean_s85 := by timed congr lean_s63 lean_s84
have lean_s86 : (Eq let49 let49) := by timed rfl
let lean_s87 := by timed congr lean_s63 lean_s86
have lean_s88 : (Eq let48 let48) := by timed rfl
let lean_s89 := by timed congr lean_s63 lean_s88
have lean_s90 : (Eq let46 let46) := by timed rfl
let lean_s91 := by timed congr lean_s63 lean_s90
have lean_s92 : (Eq let45 let45) := by timed rfl
...
have lean_s96 : (Eq let43 let43) := by timed rfl
let lean_s97 := by timed congr lean_s63 lean_s96
have lean_s98 : (Eq let42 let42) := by timed rfl
...
have lean_s124 : (Eq let25 let25) := by timed rfl
let lean_s125 := by timed congr lean_s63 lean_s124
have lean_s126 : (Eq let23 let23) := by timed rfl
let lean_s127 := by timed congr lean_s63 lean_s126
have lean_s128 : (Eq let21 let21) := by timed rfl
let lean_s129 := by timed congr lean_s63 lean_s128
have lean_s130 : (Eq let19 let19) := by timed rfl
let lean_s131 := by timed congr lean_s63 lean_s130
have lean_s132 : (Eq let17 let17) := by timed rfl
let lean_s133 := by timed congr lean_s63 lean_s132
have lean_s134 : (Eq let16 let16) := by timed rfl
let lean_s135 := by timed congr lean_s63 lean_s134
have lean_s136 : (Eq let15 let15) := by timed rfl
let lean_s137 := by timed congr lean_s63 lean_s136
have lean_s138 : (Eq let14 let14) := by timed rfl
...
have lean_s179 : (Eq let62 let130) := by timed congr lean_s65 lean_s178
have lean_s180 : (Eq let63 let130) := by timed Eq.trans lean_r7 lean_s179
have lean_s181 : (Eq defx5fctx let130) := by timed Eq.trans lean_s62 lean_s180
have lean_s182 : let130 := by timed eqResolve lean_a22 lean_s181
have lean_s183 : let15 := by andElim lean_s182, 40
have lean_s184 : let130 := by timed eqResolve lean_a22 lean_s181
have lean_s185 : let19 := by andElim lean_s184, 37
...
have lean_s190 : let130 := by timed eqResolve lean_a22 lean_s181
have lean_s191 : let21 := by andElim lean_s190, 36
have lean_s192 : (Eq gx5fs29x5f42 gx5fs29x5f42) := by timed rfl
let lean_s193 := by timed flipCongrArg lean_s192 [Eq]
have lean_s194 : let130 := by timed eqResolve lean_a22 lean_s181
have lean_s195 : let23 := by andElim lean_s194, 35
have lean_s196 : (Eq gx5fs28x5f41 gx5fs28x5f41) := by timed rfl
let lean_s197 := by timed flipCongrArg lean_s196 [Eq]
have lean_s198 : let132 := by timed rfl
let lean_s199 := by timed flipCongrArg lean_s198 [x2ai]
have lean_s200 : let130 := by timed eqResolve lean_a22 lean_s181
have lean_s201 : let25 := by andElim lean_s200, 34
...
have lean_s206 : let130 := by timed eqResolve lean_a22 lean_s181
have lean_s207 : let26 := by andElim lean_s206, 33
have lean_s208 : (Eq gx5fs26x5f39 gx5fs26x5f39) := by timed rfl
let lean_s209 := by timed flipCongrArg lean_s208 [Eq]
have lean_s210 : let132 := by timed rfl
let lean_s211 := by timed flipCongrArg lean_s210 [x2ai]
have lean_s212 : let130 := by timed eqResolve lean_a22 lean_s181
have lean_s213 : let70 := by andElim lean_s212, 27
have lean_s214 : let130 := by timed eqResolve lean_a22 lean_s181
have lean_s215 : let72 := by andElim lean_s214, 23
have lean_s216 : let130 := by timed eqResolve lean_a22 lean_s181
have lean_s217 : let67 := by andElim lean_s216, 22
have lean_s218 : let130 := by timed eqResolve lean_a22 lean_s181
have lean_s219 : let73 := by andElim lean_s218, 21
have lean_s220 : let130 := by timed eqResolve lean_a22 lean_s181
have lean_s221 : let66 := by andElim lean_s220, 20
have lean_s222 : let130 := by timed eqResolve lean_a22 lean_s181
have lean_s223 : let64 := by andElim lean_s222, 19
have lean_s224 : let130 := by timed eqResolve lean_a22 lean_s181
have lean_s225 : let50 := by andElim lean_s224, 11
have lean_s226 : let130 := by timed eqResolve lean_a22 lean_s181
have lean_s227 : let69 := by andElim lean_s226, 9
have lean_s228 : let130 := by timed eqResolve lean_a22 lean_s181
have lean_s229 : let75 := by andElim lean_s228, 8
have lean_s230 : let130 := by timed eqResolve lean_a22 lean_s181
have lean_s231 : let57 := by andElim lean_s230, 4
have lean_s232 : let130 := by timed eqResolve lean_a22 lean_s181
have lean_s233 : let58 := by andElim lean_s232, 3
have lean_s234 : let130 := by timed eqResolve lean_a22 lean_s181
have lean_s235 : let59 := by andElim lean_s234, 2
have lean_s236 : let130 := by timed eqResolve lean_a22 lean_s181
have lean_s237 : let60 := by andElim lean_s236, 1
have lean_s238 : let130 := by timed eqResolve lean_a22 lean_s181
have lean_s239 : let61 := by andElim lean_s238, 0
have lean_s240 : let81 := by timed eqResolve lean_a21 lean_a34
have lean_s241 : let79 := by andElim lean_s240, 1
have lean_s242 : let81 := by timed eqResolve lean_a21 lean_a34
have lean_s243 : let80 := by andElim lean_s242, 0
...
have lean_s258 : let111 := by timed And.intro lean_s213 lean_s257
have lean_s259 : let64 := by andElim lean_s258, 5
have lean_s260 : let131 := by timed congr lean_s211 lean_s259
have lean_s261 : (Eq let26 let113) := by timed congr lean_s209 lean_s260
have lean_s262 : let113 := by timed eqResolve lean_s207 lean_s261
...
have lean_s278 : let114 := by timed And.intro lean_s262 lean_s277
have lean_s279 : let64 := by andElim lean_s278, 6
have lean_s280 : (Eq let24 let115) := by timed congr lean_s205 lean_s279
have lean_s281 : (Eq let25 let116) := by timed congr lean_s203 lean_s280
have lean_s282 : let116 := by timed eqResolve lean_s201 lean_s281
...
have lean_s299 : let117 := by timed And.intro lean_s282 lean_s298
have lean_s300 : let64 := by andElim lean_s299, 7
have lean_s301 : let131 := by timed congr lean_s199 lean_s300
have lean_s302 : (Eq let23 let118) := by timed congr lean_s197 lean_s301
have lean_s303 : let118 := by timed eqResolve lean_s195 lean_s302
...
have lean_s321 : let119 := by timed And.intro lean_s303 lean_s320
have lean_s322 : let72 := by andElim lean_s321, 4
let lean_s323 := by timed flipCongrArg lean_s322 [x2ai]
have lean_s324 : let64 := by andElim lean_s321, 8
have lean_s325 : (Eq let20 let120) := by timed congr lean_s323 lean_s324
have lean_s326 : (Eq let21 let121) := by timed congr lean_s193 lean_s325
have lean_s327 : let121 := by timed eqResolve lean_s191 lean_s326
...
have lean_s346 : let122 := by timed And.intro lean_s327 lean_s345
have lean_s347 : let64 := by andElim lean_s346, 9
have lean_s348 : (Eq let18 let123) := by timed congr lean_s189 lean_s347
have lean_s349 : (Eq let19 let124) := by timed congr lean_s187 lean_s348
have lean_s350 : let124 := by timed eqResolve lean_s185 lean_s349
...
have lean_s378 : let126 := by timed And.intro lean_s50 lean_s377
have lean_s379 : let1 := by andElim lean_s378, 0
let lean_s380 := by timed flipCongrArg lean_s379 [Eq]
have lean_s381 : let68 := by timed rfl
have lean_s382 : (Eq let3 let127) := by timed congr lean_s380 lean_s381
have lean_s383 : let127 := by timed eqResolve lean_s48 lean_s382
...
have lean_s413 : let128 := by timed And.intro lean_s46 lean_s412
have lean_s414 : let5 := by andElim lean_s413, 0
let lean_s415 := by timed flipCongrArg lean_s414 [Eq]
have lean_s416 : (Eq gx5fs51x241x5f72 gx5fs51x241x5f72) := by timed rfl
have lean_s417 : (Eq let7 let10) := by timed congr lean_s415 lean_s416
have lean_s418 : (Eq let7 let9) := by timed Eq.trans lean_s417 lean_r4
have lean_s419 : let9 := by timed eqResolve lean_s44 lean_s418
...
have lean_s450 : (And let9 let128) := by timed And.intro lean_s419 lean_s449
have lean_s451 : let1 := by andElim lean_s450, 3
have lean_s452 : let127 := by andElim lean_s450, 2
have lean_s453 : let3 := by timed Eq.trans lean_s451 lean_s452
let lean_s454 := by timed flipCongrArg lean_s453 [Eq]
have lean_s455 : (Eq let1 let68) := by timed congr lean_s454 lean_s452
let lean_s456 := by timed congr lean_s41 lean_s455
let lean_s457 := by timed flipCongrArg lean_s453 [Eq]
have lean_s458 : let68 := by timed rfl
have lean_s459 : (Eq let3 let68) := by timed congr lean_s457 lean_s458
let lean_s460 := by timed congr lean_s41 lean_s459
have lean_s461 : let5 := by andElim lean_s450, 1
let lean_s462 := by timed flipCongrArg lean_s461 [Eq]
have lean_s463 : let65 := by timed rfl
have lean_s464 : (Eq let5 let65) := by timed congr lean_s462 lean_s463
let lean_s465 := by timed congr lean_s41 lean_s464
let lean_s466 := by timed flipCongrArg lean_s461 [Eq]
have lean_s467 : let9 := by andElim lean_s450, 0
have lean_s468 : (Eq let7 let65) := by timed congr lean_s466 lean_s467
let lean_s469 := by timed congr lean_s465 lean_s468
let lean_s470 := by timed congr lean_s460 lean_s469
have lean_s471 : (Eq let104 let107) := by timed congr lean_s456 lean_s470
let lean_s472 := by timed flipCongrArg lean_s471 [Implies]
let lean_s473 := by timed flipCongrArg lean_s467 [Eq]
have lean_s474 : (Eq let9 let65) := by timed congr lean_s473 lean_s463
have lean_s475 : (Eq let105 let108) := by timed congr lean_s472 lean_s474
have lean_s476 : (Eq let106 let109) := by timed flipCongrArg lean_s475 [Not]
have lean_s477 : let110 := by timed rfl
...
have lean_s483 : (Eq let107 let74) := by timed congr lean_s478 lean_s482
have lean_s484 : (Eq let107 True) := by timed Eq.trans lean_s483 lean_r18
let lean_s485 := by timed flipCongrArg lean_s484 [Implies]
have lean_s486 : (Eq let108 let13) := by timed congr lean_s485 lean_r9
have lean_s487 : (Eq let108 True) := by timed Eq.trans lean_s486 lean_r6
have lean_s488 : (Eq let109 let71) := by timed flipCongrArg lean_s487 [Not]
have lean_s489 : (Eq let109 False) := by timed Eq.trans lean_s488 lean_r15
have lean_s490 : (Eq let106 False) := by timed Eq.trans lean_s476 lean_s489
have lean_s491 : (Eq let78 False) := by timed Eq.trans lean_s40 lean_s490
