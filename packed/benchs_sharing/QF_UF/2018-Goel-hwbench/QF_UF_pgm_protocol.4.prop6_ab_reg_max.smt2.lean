...
theorem th0 :
  let let1 := (Eq yx249022 yx24prop)
  let let2 := (Eq yx24prop yx249022)
  let let3 := (Not yx2481)
  let let4 := (Not yx249150)
  let let5 := (And yx24ax5fr4 yx24v3x5f1517448503x5f177x5fop)
  let let6 := (And yx24111 yx24v3x5f1517448503x5f178x5fop)
  let let7 := (Eq yx24id180x5fop let6)
  let let8 := (Not yx249022)
  let let9 := (Eq yx249023 let2)
...
fun lean_a1 : (Ne yx24n0s8 yx24n3s8 yx24n1s8 yx24n2s8 yx24n4s8 yx24n5s8 yx24n6s8 yx24n9s8 yx24n7s8) =>
fun lean_a2 : (Ne yx24n0s32 yx24n1s32 yx24n2s32 yx24n3s32 yx24n4s32 yx24n5s32 yx24n6s32 yx24n7s32 yx24n9s32) =>
...
fun lean_a171 : (Eq yx24prop let4) =>
...
fun lean_a174 : (Eq yx24v3x5f1517448503x5f178x5fop let5) =>
fun lean_a175 : let7 =>
fun lean_a176 : (Eq yx24id180x5fop let8) =>
fun lean_a177 : let9 =>
fun lean_a178 : (Eq yx249163 let10) =>
fun lean_a179 : yx249163 => by
have lean_s0 : (Or let11 (Or (Not yx24id180x5fop) let6)) := by timed cnfEquivPos1
have lean_s1 : let10 := by timed eqResolve lean_a179 lean_a178
...
have lean_s6 : let17 := by timed eqResolve lean_a177 lean_s5
have lean_s7 : let1 := by timed eqResolve lean_s2 lean_s6
have lean_s8 : (Or let8 yx24prop) := by timed equivElim1 lean_s7
have lean_s9 : (Or let16 let4) := by timed equivElim1 lean_a171
have lean_s10 : let10 := by timed eqResolve lean_a179 lean_a178
have lean_s11 : yx249150 := by andElim lean_s10, 168
have lean_s12 : let16 := by R2 lean_s9, lean_s11, yx249150, [(- 1), 0]
have lean_s13 : let8 := by R1 lean_s8, lean_s12, yx24prop, [(- 1), 0]
have lean_s14 : (Eq let8 yx24id180x5fop) := by timed Eq.symm lean_a176
have lean_s15 : yx24id180x5fop := by timed eqResolve lean_s13 lean_s14
let lean_s16 := by R2 lean_s0, lean_s15, yx24id180x5fop, [(- 1), 0]
have lean_s17 : (Or let12 yx24v3x5f1517448503x5f178x5fop) := by timed @cnfAndPos [yx24111, yx24v3x5f1517448503x5f178x5fop] 1
have lean_s18 : (Or let13 let5) := by timed equivElim1 lean_a174
have lean_s19 : (Or let14 yx24ax5fr4) := by timed @cnfAndPos [yx24ax5fr4, yx24v3x5f1517448503x5f177x5fop] 0
have lean_s20 : (Or let15 let3) := by timed equivElim1 lean_a43
have lean_s21 : let10 := by timed eqResolve lean_a179 lean_a178
...
have lean_s26 : let12 := by R1 lean_s17, lean_s25, yx24v3x5f1517448503x5f178x5fop, [(- 1), 0]
