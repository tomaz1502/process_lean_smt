...
theorem th0 :
  let let1 := (Not yx2412)
  let let2 := (Not yx24174)
  let let3 := (Eq yx2412 yx24prop)
  let let4 := (And yx24L0 (And yx242 (And yx244 (And yx246 (And yx248 (And yx2410 (And yx2412 (And yx24LoneHot (And yx2416 (And yx24174 yx24167))))))))))
  let let5 := (Not let3)
  let let6 := (Not yx24prop)
(Ne yx24n1s6 yx24n19s6 yx24n3s6 yx24n17s6) → (Eq yx24L1 (Not yx242)) → (Eq yx24L2 (Not yx244)) → (Eq yx24L3 (Not yx246)) → (Eq yx24L4 (Not yx248)) → (Eq yx24L5 (Not yx2410)) → (Eq yx24L6 let1) → (Eq yx2416 (Eq yx24n1s6 yx24X)) → (Eq yx24prop let2) → (Eq yx24167 let3) → (Eq yx24178 let4) → yx24178 → False :=
  let let1 := (Not yx2412)
  let let2 := (Not yx24174)
  let let3 := (Eq yx2412 yx24prop)
  let let4 := (And yx24L0 (And yx242 (And yx244 (And yx246 (And yx248 (And yx2410 (And yx2412 (And yx24LoneHot (And yx2416 (And yx24174 yx24167))))))))))
...
fun lean_a6 : (Eq yx24L6 let1) =>
fun lean_a7 : (Eq yx2416 (Eq yx24n1s6 yx24X)) =>
fun lean_a8 : (Eq yx24prop let2) =>
fun lean_a9 : (Eq yx24167 let3) =>
fun lean_a10 : (Eq yx24178 let4) =>
fun lean_a11 : yx24178 => by
have lean_s0 : let4 := by timed eqResolve lean_a11 lean_a10
have lean_s1 : yx24167 := by andElim lean_s0, 10
have lean_s2 : let3 := by timed eqResolve lean_s1 lean_a9
have lean_s3 : (Or let5 (Or let1 yx24prop)) := by timed cnfEquivPos1
have lean_s4 : let4 := by timed eqResolve lean_a11 lean_a10
have lean_s5 : yx2412 := by andElim lean_s4, 6
let lean_s6 := by R2 lean_s3, lean_s5, yx2412, [(- 1), 0]
have lean_s7 : (Or let6 let2) := by timed equivElim1 lean_a8
have lean_s8 : let4 := by timed eqResolve lean_a11 lean_a10
have lean_s9 : yx24174 := by andElim lean_s8, 9
have lean_s10 : let6 := by R2 lean_s7, lean_s9, yx24174, [(- 1), 0]
