...
theorem th0 :
  let let1 := (Eq yx242072 yx24prop)
  let let2 := (Eq yx24prop yx242072)
  let let3 := (Not yx2429)
  let let4 := (Not yx242113)
  ...
  let let8 := (Not yx242072)
  let let9 := (Eq yx242073 let2)
...
fun lean_a2 : (Ne yx24n0s16 yx24n3s16 yx24n30s16 yx24n31s16) =>
fun lean_a3 : (Ne yx24n16s32 yx24n1s32 yx24n0s32 yx24n4s32 yx24n2s32 yx24n30s32 yx24n5s32 yx24n3s32 yx24n6s32) =>
...
fun lean_a53 : (Eq yx24v3x5f1517448493x5f53x5fop (BitWiseXorx5f16x5f16x5f16 yx24n30s16 yx24vx5fSYNC)) =>
...
fun lean_a66 : let9 =>
fun lean_a67 : (Eq yx242155 let10) =>
...
have lean_s12 : let16 := by R2 lean_s9, lean_s11, yx242113, [(- 1), 0]
