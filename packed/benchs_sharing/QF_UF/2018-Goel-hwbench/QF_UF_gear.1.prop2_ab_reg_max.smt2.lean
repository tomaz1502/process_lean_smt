...
theorem th0 :
  ...
  let let5 := (And yx24ax5ferrorx5fopen yx24101)
...
fun lean_a27 : (Eq yx24ax5ferrorx5fopen let3) =>
...
have lean_s2 : (Or let14 yx24ax5ferrorx5fopen) := by timed @cnfAndPos [yx24ax5ferrorx5fopen, yx24101] 0
...
have lean_s6 : let15 := by R2 lean_s3, lean_s5, yx2449, [(- 1), 0]
have lean_s7 : let14 := by R1 lean_s2, lean_s6, yx24ax5ferrorx5fopen, [(- 1), 0]
