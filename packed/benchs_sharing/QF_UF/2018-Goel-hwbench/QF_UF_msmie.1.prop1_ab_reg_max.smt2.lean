...
theorem th0 :
  let let1 := (Eq yx243387 yx24prop)
  let let2 := (Eq yx24prop yx243387)
  let let3 := (Not yx247)
  let let4 := (Not yx243480)
  let let5 := (And yx24ax5ferrorx5fstatex5fslavex5f1 yx2479)
  let let6 := (Not yx243387)
  let let7 := (Eq yx24id48x5fop let6)
  let let8 := (Eq yx243388 let2)
...
fun lean_a6 : (Eq yx24ax5ferrorx5fstatex5fslavex5f1 let3) =>
...
fun lean_a50 : (Eq yx24id48x5fop let5) =>
fun lean_a51 : let7 =>
fun lean_a52 : let8 =>
fun lean_a53 : (Eq yx243487 let9) =>
fun lean_a54 : yx243487 => by
have lean_s0 : (Or let10 (Or yx24id48x5fop (Not let6))) := by timed cnfEquivPos2
have lean_s1 : (Or let13 let5) := by timed equivElim1 lean_a50
have lean_s2 : (Or let14 yx24ax5ferrorx5fstatex5fslavex5f1) := by timed @cnfAndPos [yx24ax5ferrorx5fstatex5fslavex5f1, yx2479] 0
have lean_s3 : (Or let15 let3) := by timed equivElim1 lean_a6
have lean_s4 : let9 := by timed eqResolve lean_a54 lean_a53
...
have lean_s10 : let9 := by timed eqResolve lean_a54 lean_a53
...
have lean_s15 : let12 := by timed eqResolve lean_a52 lean_s14
have lean_s16 : let1 := by timed eqResolve lean_s11 lean_s15
have lean_s17 : (Or let6 yx24prop) := by timed equivElim1 lean_s16
have lean_s18 : (Or let11 let4) := by timed equivElim1 lean_a49
have lean_s19 : let9 := by timed eqResolve lean_a54 lean_a53
have lean_s20 : yx243480 := by andElim lean_s19, 46
have lean_s21 : let11 := by R2 lean_s18, lean_s20, yx243480, [(- 1), 0]
