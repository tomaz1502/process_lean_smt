...
theorem th0 :
  let let1 := (Eq yx242169 yx24prop)
  let let2 := (Eq yx24prop yx242169)
  let let3 := (Not yx247)
  let let4 := (Not yx242212)
  let let5 := (And yx24ax5fconsume yx2449)
  let let6 := (Not yx242169)
  let let7 := (Eq yx24id54x5fop let6)
  let let8 := (Eq yx242170 let2)
...
fun lean_a55 : (Eq yx24id54x5fop let5) =>
fun lean_a56 : let7 =>
fun lean_a57 : let8 =>
fun lean_a58 : (Eq yx242219 let9) =>
...
have lean_s21 : let11 := by R2 lean_s18, lean_s20, yx242212, [(- 1), 0]
