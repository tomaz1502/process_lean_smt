...
theorem th0 :
  let let1 := (Eq yx242249 yx24prop)
  let let2 := (Eq yx24prop yx242249)
  let let3 := (Not yx247)
  let let4 := (Not yx242292)
  let let5 := (And yx24ax5fconsume yx2449)
  let let6 := (Not yx242249)
  let let7 := (Eq yx24id58x5fop let6)
  let let8 := (Eq yx242250 let2)
...
fun lean_a59 : (Eq yx24id58x5fop let5) =>
fun lean_a60 : let7 =>
fun lean_a61 : let8 =>
fun lean_a62 : (Eq yx242299 let9) =>
fun lean_a63 : yx242299 => by
have lean_s0 : (Or let10 (Or yx24id58x5fop (Not let6))) := by timed cnfEquivPos2
...
have lean_s21 : let11 := by R2 lean_s18, lean_s20, yx242292, [(- 1), 0]
