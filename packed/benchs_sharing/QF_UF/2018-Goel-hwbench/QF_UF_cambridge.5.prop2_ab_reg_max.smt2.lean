...
theorem th0 :
  let let1 := (Eq yx243920 yx24prop)
  let let2 := (Eq yx24prop yx243920)
  let let3 := (Not yx2435)
  let let4 := (Not yx243986)
  let let5 := (And yx24ax5fqx5ferrorx5fReceiver yx2451)
  let let6 := (Not yx243920)
  let let7 := (Eq yx24id56x5fop let6)
  let let8 := (Eq yx243921 let2)
...
fun lean_a56 : (Eq yx24prop let4) =>
fun lean_a57 : (Eq yx24id56x5fop let5) =>
fun lean_a58 : let7 =>
fun lean_a59 : let8 =>
fun lean_a60 : (Eq yx243993 let9) =>
fun lean_a61 : yx243993 => by
have lean_s0 : (Or let10 (Or yx24id56x5fop (Not let6))) := by timed cnfEquivPos2
have lean_s1 : (Or let13 let5) := by timed equivElim1 lean_a57
...
have lean_s4 : let9 := by timed eqResolve lean_a61 lean_a60
...
have lean_s10 : let9 := by timed eqResolve lean_a61 lean_a60
...
have lean_s15 : let12 := by timed eqResolve lean_a59 lean_s14
have lean_s16 : let1 := by timed eqResolve lean_s11 lean_s15
have lean_s17 : (Or let6 yx24prop) := by timed equivElim1 lean_s16
have lean_s18 : (Or let11 let4) := by timed equivElim1 lean_a56
have lean_s19 : let9 := by timed eqResolve lean_a61 lean_a60
have lean_s20 : yx243986 := by andElim lean_s19, 52
have lean_s21 : let11 := by R2 lean_s18, lean_s20, yx243986, [(- 1), 0]
