...
theorem th0 :
  let let1 := (Eq yx241244 yx24prop)
  let let2 := (Eq yx24prop yx241244)
  let let3 := (Not yx241)
  let let4 := (Not yx241272)
  let let5 := (And yx24ax5fdone yx247)
  let let6 := (Not yx241244)
  let let7 := (Eq yx24id19x5fop let6)
  let let8 := (Eq yx241245 let2)
  let let9 := (And yx241 (And yx243 (And yx245 (And yx247 (And yx2410 (And yx2412 (And yx2414 (And yx2416 (And yx2418 (And yx2420 (And yx2422 (And yx2424 (And yx2426 (And yx2428 (And yx2430 (And yx2432 (And yx2434 (And yx241272 yx241245))))))))))))))))))
  let let10 := (Not let7)
  let let11 := (Not yx24prop)
  let let12 := (Eq yx241245 let1)
  let let13 := (Not yx24id19x5fop)
  let let14 := (Not let5)
  let let15 := (Not yx24ax5fdone)
(Eq let2 let1) → (Ne yx24n0s8 yx24n2s8 yx24n253s8 yx24n254s8 yx24n5s8 yx24n4s8 yx24n3s8 yx24n1s8 yx24n255s8) → (Eq yx24ax5fdone let3) → (Eq yx24ax5femptyhand (Not yx243)) → (Eq yx24ax5ffullhand (Not yx245)) → (Eq yx24dvex5finvalid (Not yx247)) → (Eq yx2410 (Eq yx24n0s8 yx24vx5fclearx5f0)) → (Eq yx2412 (Eq yx24n0s8 yx24vx5fclearx5f1)) → (Eq yx2414 (Eq yx24n0s8 yx24vx5fclearx5f2)) → (Eq yx2416 (Eq yx24n0s8 yx24vx5fclearx5f3)) → (Eq yx2418 (Eq yx24n0s8 yx24vx5fclearx5f4)) → (Eq yx2420 (Eq yx24n0s8 yx24vx5fclearx5f5)) → (Eq yx2422 (Eq yx24n0s8 yx24vx5fholding)) → (Eq yx2424 (Eq yx24n0s8 yx24vx5fonx5f0)) → (Eq yx2426 (Eq yx24n0s8 yx24vx5fonx5f1)) → (Eq yx2428 (Eq yx24n0s8 yx24vx5fonx5f2)) → (Eq yx2430 (Eq yx24n0s8 yx24vx5fonx5f3)) → (Eq yx2432 (Eq yx24n0s8 yx24vx5fonx5f4)) → (Eq yx2434 (Eq yx24n0s8 yx24vx5fonx5f5)) → (Eq yx24prop let4) → (Eq yx24id19x5fop let5) → let7 → let8 → (Eq yx241279 let9) → yx241279 → False :=
  let let1 := (Eq yx241244 yx24prop)
  let let2 := (Eq yx24prop yx241244)
  let let3 := (Not yx241)
  let let4 := (Not yx241272)
...
fun lean_a19 : (Eq yx24prop let4) =>
fun lean_a20 : (Eq yx24id19x5fop let5) =>
fun lean_a21 : let7 =>
fun lean_a22 : let8 =>
fun lean_a23 : (Eq yx241279 let9) =>
fun lean_a24 : yx241279 => by
have lean_s0 : (Or let10 (Or yx24id19x5fop (Not let6))) := by timed cnfEquivPos2
have lean_s1 : (Or let13 let5) := by timed equivElim1 lean_a20
...
have lean_s4 : let9 := by timed eqResolve lean_a24 lean_a23
...
have lean_s10 : let9 := by timed eqResolve lean_a24 lean_a23
...
have lean_s15 : let12 := by timed eqResolve lean_a22 lean_s14
have lean_s16 : let1 := by timed eqResolve lean_s11 lean_s15
have lean_s17 : (Or let6 yx24prop) := by timed equivElim1 lean_s16
have lean_s18 : (Or let11 let4) := by timed equivElim1 lean_a19
have lean_s19 : let9 := by timed eqResolve lean_a24 lean_a23
have lean_s20 : yx241272 := by andElim lean_s19, 17
have lean_s21 : let11 := by R2 lean_s18, lean_s20, yx241272, [(- 1), 0]
