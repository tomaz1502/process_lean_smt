...
theorem th0 :
  let let1 := (Eq yx241406 yx24prop)
  let let2 := (Eq yx24prop yx241406)
  let let3 := (Not yx245)
  let let4 := (Not yx241437)
  let let5 := (And yx24ax5fCrossx5fTrainx5f1 yx24ax5fCrossx5fTrainx5f2)
  let let6 := (And yx2445 yx24v3x5f1517448508x5f35x5fop)
  let let7 := (Eq yx24id37x5fop let6)
  let let8 := (Not yx241406)
  let let9 := (Eq yx241407 let2)
...
fun lean_a5 : (Eq yx24ax5fCrossx5fTrainx5f1 let3) =>
...
fun lean_a35 : (Eq yx24prop let4) =>
fun lean_a36 : (Eq yx24v3x5f1517448508x5f35x5fop let5) =>
fun lean_a37 : let7 =>
fun lean_a38 : (Eq yx24id37x5fop let8) =>
fun lean_a39 : let9 =>
fun lean_a40 : (Eq yx241446 let10) =>
fun lean_a41 : yx241446 => by
have lean_s0 : (Or let11 (Or (Not yx24id37x5fop) let6)) := by timed cnfEquivPos1
have lean_s1 : let10 := by timed eqResolve lean_a41 lean_a40
...
have lean_s6 : let17 := by timed eqResolve lean_a39 lean_s5
have lean_s7 : let1 := by timed eqResolve lean_s2 lean_s6
have lean_s8 : (Or let8 yx24prop) := by timed equivElim1 lean_s7
have lean_s9 : (Or let16 let4) := by timed equivElim1 lean_a35
have lean_s10 : let10 := by timed eqResolve lean_a41 lean_a40
have lean_s11 : yx241437 := by andElim lean_s10, 32
have lean_s12 : let16 := by R2 lean_s9, lean_s11, yx241437, [(- 1), 0]
have lean_s13 : let8 := by R1 lean_s8, lean_s12, yx24prop, [(- 1), 0]
have lean_s14 : (Eq let8 yx24id37x5fop) := by timed Eq.symm lean_a38
have lean_s15 : yx24id37x5fop := by timed eqResolve lean_s13 lean_s14
let lean_s16 := by R2 lean_s0, lean_s15, yx24id37x5fop, [(- 1), 0]
have lean_s17 : (Or let12 yx24v3x5f1517448508x5f35x5fop) := by timed @cnfAndPos [yx2445, yx24v3x5f1517448508x5f35x5fop] 1
have lean_s18 : (Or let13 let5) := by timed equivElim1 lean_a36
...
have lean_s20 : (Or let15 let3) := by timed equivElim1 lean_a5
have lean_s21 : let10 := by timed eqResolve lean_a41 lean_a40
have lean_s22 : yx245 := by andElim lean_s21, 2
have lean_s23 : let15 := by R2 lean_s20, lean_s22, yx245, [(- 1), 0]
...
have lean_s26 : let12 := by R1 lean_s17, lean_s25, yx24v3x5f1517448508x5f35x5fop, [(- 1), 0]
