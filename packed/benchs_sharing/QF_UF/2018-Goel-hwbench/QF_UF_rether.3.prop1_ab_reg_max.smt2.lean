...
theorem th0 :
  let let1 := (Eq yx245888 yx24prop)
  let let2 := (Eq yx24prop yx245888)
  let let3 := (Not yx2441)
  let let4 := (Not yx246007)
  let let5 := (And yx24ax5ferrorx5fstx5fNodex5f0 yx24147)
  let let6 := (Not yx245888)
  let let7 := (Eq yx24id102x5fop let6)
  let let8 := (Eq yx245889 let2)
...
fun lean_a23 : (Eq yx24ax5ferrorx5fstx5fNodex5f0 let3) =>
...
fun lean_a103 : (Eq yx24prop let4) =>
fun lean_a104 : (Eq yx24id102x5fop let5) =>
fun lean_a105 : let7 =>
fun lean_a106 : let8 =>
fun lean_a107 : (Eq yx246014 let9) =>
fun lean_a108 : yx246014 => by
have lean_s0 : (Or let10 (Or yx24id102x5fop (Not let6))) := by timed cnfEquivPos2
have lean_s1 : (Or let13 let5) := by timed equivElim1 lean_a104
have lean_s2 : (Or let14 yx24ax5ferrorx5fstx5fNodex5f0) := by timed @cnfAndPos [yx24ax5ferrorx5fstx5fNodex5f0, yx24147] 0
have lean_s3 : (Or let15 let3) := by timed equivElim1 lean_a23
have lean_s4 : let9 := by timed eqResolve lean_a108 lean_a107
...
have lean_s10 : let9 := by timed eqResolve lean_a108 lean_a107
...
have lean_s15 : let12 := by timed eqResolve lean_a106 lean_s14
have lean_s16 : let1 := by timed eqResolve lean_s11 lean_s15
have lean_s17 : (Or let6 yx24prop) := by timed equivElim1 lean_s16
have lean_s18 : (Or let11 let4) := by timed equivElim1 lean_a103
have lean_s19 : let9 := by timed eqResolve lean_a108 lean_a107
have lean_s20 : yx246007 := by andElim lean_s19, 100
have lean_s21 : let11 := by R2 lean_s18, lean_s20, yx246007, [(- 1), 0]
