...
theorem th0 :
  let let1 := (Eq yx247139 yx24prop)
  let let2 := (Eq yx24prop yx247139)
  let let3 := (Not yx2413)
  let let4 := (Not yx247320)
  let let5 := (And yx24ax5ferrorx5fstatex5fslavex5f1 yx24193)
  let let6 := (Not yx247139)
  let let7 := (Eq yx24id104x5fop let6)
  let let8 := (Eq yx247140 let2)
...
fun lean_a105 : (Eq yx24prop let4) =>
fun lean_a106 : (Eq yx24id104x5fop let5) =>
fun lean_a107 : let7 =>
fun lean_a108 : let8 =>
fun lean_a109 : (Eq yx247327 let9) =>
fun lean_a110 : yx247327 => by
have lean_s0 : (Or let10 (Or yx24id104x5fop (Not let6))) := by timed cnfEquivPos2
have lean_s1 : (Or let13 let5) := by timed equivElim1 lean_a106
...
have lean_s4 : let9 := by timed eqResolve lean_a110 lean_a109
...
have lean_s10 : let9 := by timed eqResolve lean_a110 lean_a109
...
have lean_s15 : let12 := by timed eqResolve lean_a108 lean_s14
have lean_s16 : let1 := by timed eqResolve lean_s11 lean_s15
have lean_s17 : (Or let6 yx24prop) := by timed equivElim1 lean_s16
have lean_s18 : (Or let11 let4) := by timed equivElim1 lean_a105
have lean_s19 : let9 := by timed eqResolve lean_a110 lean_a109
have lean_s20 : yx247320 := by andElim lean_s19, 102
have lean_s21 : let11 := by R2 lean_s18, lean_s20, yx247320, [(- 1), 0]
