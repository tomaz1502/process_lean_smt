...
theorem th0 :
  let let1 := (Eq yx2416247 yx24prop)
  let let2 := (Eq yx24prop yx2416247)
  let let3 := (Not yx2421)
  let let4 := (Not yx2416705)
  let let5 := (And yx24ax5ferrorx5fstatex5fslavex5f1 yx24301)
  let let6 := (Not yx2416247)
  let let7 := (Eq yx24id161x5fop let6)
  let let8 := (Eq yx2416248 let2)
...
fun lean_a13 : (Eq yx24ax5ferrorx5fstatex5fslavex5f1 let3) =>
...
fun lean_a162 : (Eq yx24prop let4) =>
fun lean_a163 : (Eq yx24id161x5fop let5) =>
fun lean_a164 : let7 =>
fun lean_a165 : let8 =>
fun lean_a166 : (Eq yx2416712 let9) =>
fun lean_a167 : yx2416712 => by
have lean_s0 : (Or let10 (Or yx24id161x5fop (Not let6))) := by timed cnfEquivPos2
have lean_s1 : (Or let13 let5) := by timed equivElim1 lean_a163
have lean_s2 : (Or let14 yx24ax5ferrorx5fstatex5fslavex5f1) := by timed @cnfAndPos [yx24ax5ferrorx5fstatex5fslavex5f1, yx24301] 0
have lean_s3 : (Or let15 let3) := by timed equivElim1 lean_a13
have lean_s4 : let9 := by timed eqResolve lean_a167 lean_a166
...
have lean_s10 : let9 := by timed eqResolve lean_a167 lean_a166
...
have lean_s15 : let12 := by timed eqResolve lean_a165 lean_s14
have lean_s16 : let1 := by timed eqResolve lean_s11 lean_s15
have lean_s17 : (Or let6 yx24prop) := by timed equivElim1 lean_s16
have lean_s18 : (Or let11 let4) := by timed equivElim1 lean_a162
have lean_s19 : let9 := by timed eqResolve lean_a167 lean_a166
have lean_s20 : yx2416705 := by andElim lean_s19, 159
have lean_s21 : let11 := by R2 lean_s18, lean_s20, yx2416705, [(- 1), 0]
