...
theorem th0 :
  let let1 := (Not yx242)
  let let2 := (Not yx24255)
  let let3 := (Eq yx242 yx24prop)
  let let4 := (And yx24L1 (And yx242 (And yx244 (And yx246 (And yx248 (And yx2410 (And yx2412 (And yx2414 (And yx2416 (And yx24LoneHot (And yx2420 (And yx2422 (And yx24255 yx24247)))))))))))))
  let let5 := (Not let3)
  let let6 := (Not yx24prop)
(Ne yx24n0s32 yx24n1s32 yx24n2s32) → (Eq yx24L10 let1) → (Eq yx24L3 (Not yx244)) → (Eq yx24L4 (Not yx246)) → (Eq yx24L5 (Not yx248)) → (Eq yx24L6 (Not yx2410)) → (Eq yx24L7 (Not yx2412)) → (Eq yx24L8 (Not yx2414)) → (Eq yx24L9 (Not yx2416)) → (Eq yx2420 (Eq yx24n0s32 yx24S)) → (Eq yx24X (Not yx2422)) → (Eq yx24prop let2) → (Eq yx24247 let3) → (Eq yx24259 let4) → yx24259 → False :=
  let let1 := (Not yx242)
  let let2 := (Not yx24255)
  let let3 := (Eq yx242 yx24prop)
  let let4 := (And yx24L1 (And yx242 (And yx244 (And yx246 (And yx248 (And yx2410 (And yx2412 (And yx2414 (And yx2416 (And yx24LoneHot (And yx2420 (And yx2422 (And yx24255 yx24247)))))))))))))
...
fun lean_a11 : (Eq yx24prop let2) =>
fun lean_a12 : (Eq yx24247 let3) =>
fun lean_a13 : (Eq yx24259 let4) =>
fun lean_a14 : yx24259 => by
have lean_s0 : let4 := by timed eqResolve lean_a14 lean_a13
have lean_s1 : yx24247 := by andElim lean_s0, 13
have lean_s2 : let3 := by timed eqResolve lean_s1 lean_a12
have lean_s3 : (Or let5 (Or let1 yx24prop)) := by timed cnfEquivPos1
have lean_s4 : let4 := by timed eqResolve lean_a14 lean_a13
have lean_s5 : yx242 := by andElim lean_s4, 1
let lean_s6 := by R2 lean_s3, lean_s5, yx242, [(- 1), 0]
have lean_s7 : (Or let6 let2) := by timed equivElim1 lean_a11
have lean_s8 : let4 := by timed eqResolve lean_a14 lean_a13
have lean_s9 : yx24255 := by andElim lean_s8, 12
have lean_s10 : let6 := by R2 lean_s7, lean_s9, yx24255, [(- 1), 0]
