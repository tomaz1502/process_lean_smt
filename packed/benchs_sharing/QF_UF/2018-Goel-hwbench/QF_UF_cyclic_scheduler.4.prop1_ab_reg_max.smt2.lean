...
theorem th0 :
  let let1 := (Eq yx243079 yx24prop)
  let let2 := (Eq yx24prop yx243079)
  let let3 := (Not yx2437)
  let let4 := (Not yx243141)
  let let5 := (And yx24ax5fqx5ferrorx5fcustomerx5f0 yx24127)
  let let6 := (Not yx243079)
  let let7 := (Eq yx24id84x5fop let6)
  let let8 := (Eq yx243080 let2)
...
fun lean_a20 : (Eq yx24ax5fqx5ferrorx5fcustomerx5f0 let3) =>
...
fun lean_a84 : (Eq yx24prop let4) =>
fun lean_a85 : (Eq yx24id84x5fop let5) =>
fun lean_a86 : let7 =>
fun lean_a87 : let8 =>
fun lean_a88 : (Eq yx243148 let9) =>
fun lean_a89 : yx243148 => by
have lean_s0 : (Or let10 (Or yx24id84x5fop (Not let6))) := by timed cnfEquivPos2
have lean_s1 : (Or let13 let5) := by timed equivElim1 lean_a85
have lean_s2 : (Or let14 yx24ax5fqx5ferrorx5fcustomerx5f0) := by timed @cnfAndPos [yx24ax5fqx5ferrorx5fcustomerx5f0, yx24127] 0
have lean_s3 : (Or let15 let3) := by timed equivElim1 lean_a20
have lean_s4 : let9 := by timed eqResolve lean_a89 lean_a88
...
have lean_s10 : let9 := by timed eqResolve lean_a89 lean_a88
...
have lean_s15 : let12 := by timed eqResolve lean_a87 lean_s14
have lean_s16 : let1 := by timed eqResolve lean_s11 lean_s15
have lean_s17 : (Or let6 yx24prop) := by timed equivElim1 lean_s16
have lean_s18 : (Or let11 let4) := by timed equivElim1 lean_a84
have lean_s19 : let9 := by timed eqResolve lean_a89 lean_a88
have lean_s20 : yx243141 := by andElim lean_s19, 82
have lean_s21 : let11 := by R2 lean_s18, lean_s20, yx243141, [(- 1), 0]
