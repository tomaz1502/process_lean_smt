...
theorem th0 :
  let let1 := (Eq yx243851 yx24prop)
  let let2 := (Eq yx24prop yx243851)
  let let3 := (Not yx2417)
  let let4 := (Not yx243924)
  let let5 := (And yx24ax5fCrossx5fTrainx5f1 yx24ax5fCrossx5fTrainx5f2)
  let let6 := (And yx24105 yx24v3x5f1517448509x5f83x5fop)
  let let7 := (Eq yx24id85x5fop let6)
  let let8 := (Not yx243851)
  let let9 := (Eq yx243852 let2)
...
fun lean_a11 : (Eq yx24ax5fCrossx5fTrainx5f1 let3) =>
...
fun lean_a77 : (Eq yx24prop let4) =>
fun lean_a78 : (Eq yx24v3x5f1517448509x5f83x5fop let5) =>
fun lean_a79 : let7 =>
fun lean_a80 : (Eq yx24id85x5fop let8) =>
fun lean_a81 : let9 =>
fun lean_a82 : (Eq yx243933 let10) =>
fun lean_a83 : yx243933 => by
have lean_s0 : (Or let11 (Or (Not yx24id85x5fop) let6)) := by timed cnfEquivPos1
have lean_s1 : let10 := by timed eqResolve lean_a83 lean_a82
...
have lean_s6 : let17 := by timed eqResolve lean_a81 lean_s5
have lean_s7 : let1 := by timed eqResolve lean_s2 lean_s6
have lean_s8 : (Or let8 yx24prop) := by timed equivElim1 lean_s7
have lean_s9 : (Or let16 let4) := by timed equivElim1 lean_a77
have lean_s10 : let10 := by timed eqResolve lean_a83 lean_a82
have lean_s11 : yx243924 := by andElim lean_s10, 74
have lean_s12 : let16 := by R2 lean_s9, lean_s11, yx243924, [(- 1), 0]
have lean_s13 : let8 := by R1 lean_s8, lean_s12, yx24prop, [(- 1), 0]
have lean_s14 : (Eq let8 yx24id85x5fop) := by timed Eq.symm lean_a80
have lean_s15 : yx24id85x5fop := by timed eqResolve lean_s13 lean_s14
let lean_s16 := by R2 lean_s0, lean_s15, yx24id85x5fop, [(- 1), 0]
have lean_s17 : (Or let12 yx24v3x5f1517448509x5f83x5fop) := by timed @cnfAndPos [yx24105, yx24v3x5f1517448509x5f83x5fop] 1
have lean_s18 : (Or let13 let5) := by timed equivElim1 lean_a78
...
have lean_s20 : (Or let15 let3) := by timed equivElim1 lean_a11
have lean_s21 : let10 := by timed eqResolve lean_a83 lean_a82
have lean_s22 : yx2417 := by andElim lean_s21, 8
have lean_s23 : let15 := by R2 lean_s20, lean_s22, yx2417, [(- 1), 0]
...
have lean_s26 : let12 := by R1 lean_s17, lean_s25, yx24v3x5f1517448509x5f83x5fop, [(- 1), 0]
