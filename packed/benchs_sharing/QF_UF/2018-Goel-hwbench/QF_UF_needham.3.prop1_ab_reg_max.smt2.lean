...
theorem th0 :
  let let1 := (Eq yx244922 yx24prop)
  let let2 := (Eq yx24prop yx244922)
  let let3 := (Not yx2427)
  let let4 := (Not yx245041)
  let let5 := (And yx24ax5ffinishedx5finitiatorx5f0 yx24ax5ffinishedx5fresponderx5f0)
  let let6 := (And yx2481 yx24v3x5f1517448501x5f60x5fop)
  let let7 := (Eq yx24id62x5fop let6)
  let let8 := (Not yx244922)
  let let9 := (Eq yx244923 let2)
...
fun lean_a17 : (Eq yx24ax5ffinishedx5finitiatorx5f0 let3) =>
...
fun lean_a64 : (Eq yx24v3x5f1517448501x5f60x5fop let5) =>
fun lean_a65 : let7 =>
fun lean_a66 : (Eq yx24id62x5fop let8) =>
fun lean_a67 : let9 =>
fun lean_a68 : (Eq yx245050 let10) =>
fun lean_a69 : yx245050 => by
have lean_s0 : (Or let11 (Or (Not yx24id62x5fop) let6)) := by timed cnfEquivPos1
...
have lean_s12 : let16 := by R2 lean_s9, lean_s11, yx245041, [(- 1), 0]
have lean_s13 : let8 := by R1 lean_s8, lean_s12, yx24prop, [(- 1), 0]
have lean_s14 : (Eq let8 yx24id62x5fop) := by timed Eq.symm lean_a66
have lean_s15 : yx24id62x5fop := by timed eqResolve lean_s13 lean_s14
let lean_s16 := by R2 lean_s0, lean_s15, yx24id62x5fop, [(- 1), 0]
have lean_s17 : (Or let12 yx24v3x5f1517448501x5f60x5fop) := by timed @cnfAndPos [yx2481, yx24v3x5f1517448501x5f60x5fop] 1
...
have lean_s26 : let12 := by R1 lean_s17, lean_s25, yx24v3x5f1517448501x5f60x5fop, [(- 1), 0]
