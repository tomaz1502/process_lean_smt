...
theorem th0 :
  let let1 := (Eq yx242049 yx24prop)
  let let2 := (Eq yx24prop yx242049)
  let let3 := (Not yx2441)
  let let4 := (Not yx242100)
  let let5 := (And yx24ax5fstx5ferror yx2451)
  let let6 := (Not yx242049)
  let let7 := (Eq yx24id40x5fop let6)
  let let8 := (Eq yx242050 let2)
...
have lean_s21 : let11 := by R2 lean_s18, lean_s20, yx242100, [(- 1), 0]
