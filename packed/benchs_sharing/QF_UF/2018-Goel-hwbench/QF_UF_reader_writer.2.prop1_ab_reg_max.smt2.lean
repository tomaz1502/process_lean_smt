...
theorem th0 :
  let let1 := (Eq yx243303 yx24prop)
  let let2 := (Eq yx24prop yx243303)
  let let3 := (Not yx2439)
  let let4 := (Not yx243392)
  let let5 := (And yx24ax5fqx5ferror yx2485)
  let let6 := (Not yx243303)
  let let7 := (Eq yx24id46x5fop let6)
  let let8 := (Eq yx243304 let2)
...
fun lean_a22 : (Eq yx24ax5fqx5ferror let3) =>
...
fun lean_a47 : (Eq yx24prop let4) =>
fun lean_a48 : (Eq yx24id46x5fop let5) =>
fun lean_a49 : let7 =>
fun lean_a50 : let8 =>
fun lean_a51 : (Eq yx243399 let9) =>
fun lean_a52 : yx243399 => by
have lean_s0 : (Or let10 (Or yx24id46x5fop (Not let6))) := by timed cnfEquivPos2
have lean_s1 : (Or let13 let5) := by timed equivElim1 lean_a48
have lean_s2 : (Or let14 yx24ax5fqx5ferror) := by timed @cnfAndPos [yx24ax5fqx5ferror, yx2485] 0
have lean_s3 : (Or let15 let3) := by timed equivElim1 lean_a22
have lean_s4 : let9 := by timed eqResolve lean_a52 lean_a51
have lean_s5 : yx2439 := by andElim lean_s4, 19
have lean_s6 : let15 := by R2 lean_s3, lean_s5, yx2439, [(- 1), 0]
...
have lean_s10 : let9 := by timed eqResolve lean_a52 lean_a51
...
have lean_s15 : let12 := by timed eqResolve lean_a50 lean_s14
have lean_s16 : let1 := by timed eqResolve lean_s11 lean_s15
have lean_s17 : (Or let6 yx24prop) := by timed equivElim1 lean_s16
have lean_s18 : (Or let11 let4) := by timed equivElim1 lean_a47
have lean_s19 : let9 := by timed eqResolve lean_a52 lean_a51
have lean_s20 : yx243392 := by andElim lean_s19, 44
have lean_s21 : let11 := by R2 lean_s18, lean_s20, yx243392, [(- 1), 0]
