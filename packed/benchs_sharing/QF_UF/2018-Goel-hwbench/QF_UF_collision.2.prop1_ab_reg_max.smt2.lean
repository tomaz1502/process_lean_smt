...
theorem th0 :
  let let1 := (Eq yx241616 yx24prop)
  let let2 := (Eq yx24prop yx241616)
  let let3 := (Not yx243)
  let let4 := (Not yx241655)
  let let5 := (And yx24ax5fcollision yx2437)
  let let6 := (Not yx241616)
  let let7 := (Eq yx24id29x5fop let6)
  let let8 := (Eq yx241617 let2)
...
fun lean_a31 : (Eq yx24id29x5fop let5) =>
fun lean_a32 : let7 =>
fun lean_a33 : let8 =>
fun lean_a34 : (Eq yx241662 let9) =>
fun lean_a35 : yx241662 => by
have lean_s0 : (Or let10 (Or yx24id29x5fop (Not let6))) := by timed cnfEquivPos2
have lean_s1 : (Or let13 let5) := by timed equivElim1 lean_a31
have lean_s2 : (Or let14 yx24ax5fcollision) := by timed @cnfAndPos [yx24ax5fcollision, yx2437] 0
have lean_s3 : (Or let15 let3) := by timed equivElim1 lean_a5
have lean_s4 : let9 := by timed eqResolve lean_a35 lean_a34
...
have lean_s10 : let9 := by timed eqResolve lean_a35 lean_a34
...
have lean_s15 : let12 := by timed eqResolve lean_a33 lean_s14
have lean_s16 : let1 := by timed eqResolve lean_s11 lean_s15
have lean_s17 : (Or let6 yx24prop) := by timed equivElim1 lean_s16
have lean_s18 : (Or let11 let4) := by timed equivElim1 lean_a30
have lean_s19 : let9 := by timed eqResolve lean_a35 lean_a34
have lean_s20 : yx241655 := by andElim lean_s19, 26
have lean_s21 : let11 := by R2 lean_s18, lean_s20, yx241655, [(- 1), 0]
