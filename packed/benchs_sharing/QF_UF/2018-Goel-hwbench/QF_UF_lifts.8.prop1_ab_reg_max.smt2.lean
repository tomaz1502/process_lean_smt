...
theorem th0 :
  let let1 := (Eq yx2411991 yx24prop)
  let let2 := (Eq yx24prop yx2411991)
  let let3 := (Not yx2441)
  let let4 := (Not yx2412266)
  let let5 := (And yx24ax5ferrorx5fstatex5fWheels yx24177)
  let let6 := (Not yx2411991)
  let let7 := (Eq yx24id120x5fop let6)
  let let8 := (Eq yx2411992 let2)
...
fun lean_a23 : (Eq yx24ax5ferrorx5fstatex5fWheels let3) =>
...
fun lean_a121 : (Eq yx24prop let4) =>
fun lean_a122 : (Eq yx24id120x5fop let5) =>
fun lean_a123 : let7 =>
fun lean_a124 : let8 =>
fun lean_a125 : (Eq yx2412273 let9) =>
fun lean_a126 : yx2412273 => by
have lean_s0 : (Or let10 (Or yx24id120x5fop (Not let6))) := by timed cnfEquivPos2
have lean_s1 : (Or let13 let5) := by timed equivElim1 lean_a122
have lean_s2 : (Or let14 yx24ax5ferrorx5fstatex5fWheels) := by timed @cnfAndPos [yx24ax5ferrorx5fstatex5fWheels, yx24177] 0
have lean_s3 : (Or let15 let3) := by timed equivElim1 lean_a23
have lean_s4 : let9 := by timed eqResolve lean_a126 lean_a125
...
have lean_s10 : let9 := by timed eqResolve lean_a126 lean_a125
...
have lean_s15 : let12 := by timed eqResolve lean_a124 lean_s14
have lean_s16 : let1 := by timed eqResolve lean_s11 lean_s15
have lean_s17 : (Or let6 yx24prop) := by timed equivElim1 lean_s16
have lean_s18 : (Or let11 let4) := by timed equivElim1 lean_a121
have lean_s19 : let9 := by timed eqResolve lean_a126 lean_a125
have lean_s20 : yx2412266 := by andElim lean_s19, 118
have lean_s21 : let11 := by R2 lean_s18, lean_s20, yx2412266, [(- 1), 0]
