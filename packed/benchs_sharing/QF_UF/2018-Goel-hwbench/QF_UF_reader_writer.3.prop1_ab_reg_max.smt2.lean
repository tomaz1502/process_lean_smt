...
theorem th0 :
  let let1 := (Eq yx244579 yx24prop)
  let let2 := (Eq yx24prop yx244579)
  let let3 := (Not yx2457)
  let let4 := (Not yx244699)
  let let5 := (And yx24ax5fqx5ferror yx24121)
  let let6 := (Not yx244579)
  let let7 := (Eq yx24id64x5fop let6)
  let let8 := (Eq yx244580 let2)
...
fun lean_a31 : (Eq yx24ax5fqx5ferror let3) =>
...
fun lean_a65 : (Eq yx24prop let4) =>
fun lean_a66 : (Eq yx24id64x5fop let5) =>
fun lean_a67 : let7 =>
fun lean_a68 : let8 =>
fun lean_a69 : (Eq yx244706 let9) =>
fun lean_a70 : yx244706 => by
have lean_s0 : (Or let10 (Or yx24id64x5fop (Not let6))) := by timed cnfEquivPos2
have lean_s1 : (Or let13 let5) := by timed equivElim1 lean_a66
have lean_s2 : (Or let14 yx24ax5fqx5ferror) := by timed @cnfAndPos [yx24ax5fqx5ferror, yx24121] 0
have lean_s3 : (Or let15 let3) := by timed equivElim1 lean_a31
have lean_s4 : let9 := by timed eqResolve lean_a70 lean_a69
have lean_s5 : yx2457 := by andElim lean_s4, 28
have lean_s6 : let15 := by R2 lean_s3, lean_s5, yx2457, [(- 1), 0]
have lean_s7 : let14 := by R1 lean_s2, lean_s6, yx24ax5fqx5ferror, [(- 1), 0]
have lean_s8 : let13 := by R1 lean_s1, lean_s7, let5, [(- 1), 0]
let lean_s9 := by R1 lean_s0, lean_s8, yx24id64x5fop, [(- 1), 0]
have lean_s10 : let9 := by timed eqResolve lean_a70 lean_a69
...
have lean_s15 : let12 := by timed eqResolve lean_a68 lean_s14
have lean_s16 : let1 := by timed eqResolve lean_s11 lean_s15
have lean_s17 : (Or let6 yx24prop) := by timed equivElim1 lean_s16
have lean_s18 : (Or let11 let4) := by timed equivElim1 lean_a65
have lean_s19 : let9 := by timed eqResolve lean_a70 lean_a69
have lean_s20 : yx244699 := by andElim lean_s19, 62
have lean_s21 : let11 := by R2 lean_s18, lean_s20, yx244699, [(- 1), 0]
