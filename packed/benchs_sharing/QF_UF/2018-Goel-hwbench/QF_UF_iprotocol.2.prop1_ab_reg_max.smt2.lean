...
theorem th0 :
  let let1 := (Eq yx242009 yx24prop)
  let let2 := (Eq yx24prop yx242009)
  let let3 := (Not yx247)
  let let4 := (Not yx242052)
  let let5 := (And yx24ax5fconsume yx2449)
  let let6 := (Not yx242009)
  let let7 := (Eq yx24id46x5fop let6)
  let let8 := (Eq yx242010 let2)
...
fun lean_a47 : (Eq yx24id46x5fop let5) =>
fun lean_a48 : let7 =>
fun lean_a49 : let8 =>
fun lean_a50 : (Eq yx242059 let9) =>
fun lean_a51 : yx242059 => by
have lean_s0 : (Or let10 (Or yx24id46x5fop (Not let6))) := by timed cnfEquivPos2
...
have lean_s21 : let11 := by R2 lean_s18, lean_s20, yx242052, [(- 1), 0]
