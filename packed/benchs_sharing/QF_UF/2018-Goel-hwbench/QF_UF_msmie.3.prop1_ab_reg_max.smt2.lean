...
theorem th0 :
  let let1 := (Eq yx249387 yx24prop)
  let let2 := (Eq yx24prop yx249387)
  let let3 := (Not yx2413)
  let let4 := (Not yx249646)
  let let5 := (And yx24ax5ferrorx5fstatex5fslavex5f1 yx24193)
  let let6 := (Not yx249387)
  let let7 := (Eq yx24id106x5fop let6)
  let let8 := (Eq yx249388 let2)
...
fun lean_a9 : (Eq yx24ax5ferrorx5fstatex5fslavex5f1 let3) =>
...
fun lean_a107 : (Eq yx24prop let4) =>
fun lean_a108 : (Eq yx24id106x5fop let5) =>
fun lean_a109 : let7 =>
fun lean_a110 : let8 =>
fun lean_a111 : (Eq yx249653 let9) =>
fun lean_a112 : yx249653 => by
have lean_s0 : (Or let10 (Or yx24id106x5fop (Not let6))) := by timed cnfEquivPos2
have lean_s1 : (Or let13 let5) := by timed equivElim1 lean_a108
have lean_s2 : (Or let14 yx24ax5ferrorx5fstatex5fslavex5f1) := by timed @cnfAndPos [yx24ax5ferrorx5fstatex5fslavex5f1, yx24193] 0
have lean_s3 : (Or let15 let3) := by timed equivElim1 lean_a9
have lean_s4 : let9 := by timed eqResolve lean_a112 lean_a111
have lean_s5 : yx2413 := by andElim lean_s4, 6
have lean_s6 : let15 := by R2 lean_s3, lean_s5, yx2413, [(- 1), 0]
have lean_s7 : let14 := by R1 lean_s2, lean_s6, yx24ax5ferrorx5fstatex5fslavex5f1, [(- 1), 0]
have lean_s8 : let13 := by R1 lean_s1, lean_s7, let5, [(- 1), 0]
let lean_s9 := by R1 lean_s0, lean_s8, yx24id106x5fop, [(- 1), 0]
have lean_s10 : let9 := by timed eqResolve lean_a112 lean_a111
...
have lean_s15 : let12 := by timed eqResolve lean_a110 lean_s14
have lean_s16 : let1 := by timed eqResolve lean_s11 lean_s15
have lean_s17 : (Or let6 yx24prop) := by timed equivElim1 lean_s16
have lean_s18 : (Or let11 let4) := by timed equivElim1 lean_a107
have lean_s19 : let9 := by timed eqResolve lean_a112 lean_a111
have lean_s20 : yx249646 := by andElim lean_s19, 104
have lean_s21 : let11 := by R2 lean_s18, lean_s20, yx249646, [(- 1), 0]
