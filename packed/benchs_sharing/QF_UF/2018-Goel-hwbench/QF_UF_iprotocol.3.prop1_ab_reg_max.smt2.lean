...
theorem th0 :
  let let1 := (Eq yx242089 yx24prop)
  let let2 := (Eq yx24prop yx242089)
  let let3 := (Not yx247)
  let let4 := (Not yx242132)
  let let5 := (And yx24ax5fconsume yx2449)
  let let6 := (Not yx242089)
  let let7 := (Eq yx24id50x5fop let6)
  let let8 := (Eq yx242090 let2)
...
fun lean_a50 : (Eq yx24prop let4) =>
fun lean_a51 : (Eq yx24id50x5fop let5) =>
fun lean_a52 : let7 =>
fun lean_a53 : let8 =>
fun lean_a54 : (Eq yx242139 let9) =>
fun lean_a55 : yx242139 => by
have lean_s0 : (Or let10 (Or yx24id50x5fop (Not let6))) := by timed cnfEquivPos2
have lean_s1 : (Or let13 let5) := by timed equivElim1 lean_a51
...
have lean_s4 : let9 := by timed eqResolve lean_a55 lean_a54
...
have lean_s10 : let9 := by timed eqResolve lean_a55 lean_a54
...
have lean_s15 : let12 := by timed eqResolve lean_a53 lean_s14
have lean_s16 : let1 := by timed eqResolve lean_s11 lean_s15
have lean_s17 : (Or let6 yx24prop) := by timed equivElim1 lean_s16
have lean_s18 : (Or let11 let4) := by timed equivElim1 lean_a50
have lean_s19 : let9 := by timed eqResolve lean_a55 lean_a54
have lean_s20 : yx242132 := by andElim lean_s19, 47
have lean_s21 : let11 := by R2 lean_s18, lean_s20, yx242132, [(- 1), 0]
