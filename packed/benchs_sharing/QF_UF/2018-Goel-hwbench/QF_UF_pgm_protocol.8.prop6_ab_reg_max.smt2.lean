...
theorem th0 :
  let let1 := (Eq yx249176 yx24prop)
  let let2 := (Eq yx24prop yx249176)
  let let3 := (Not yx2481)
  let let4 := (Not yx249304)
  let let5 := (And yx24ax5fr4 yx24v3x5f1517448504x5f182x5fop)
  let let6 := (And yx24111 yx24v3x5f1517448504x5f183x5fop)
  let let7 := (Eq yx24id185x5fop let6)
  let let8 := (Not yx249176)
  let let9 := (Eq yx249177 let2)
...
fun lean_a43 : (Eq yx24ax5fr4 let3) =>
...
fun lean_a176 : (Eq yx24prop let4) =>
...
fun lean_a179 : (Eq yx24v3x5f1517448504x5f183x5fop let5) =>
fun lean_a180 : let7 =>
fun lean_a181 : (Eq yx24id185x5fop let8) =>
fun lean_a182 : let9 =>
fun lean_a183 : (Eq yx249317 let10) =>
fun lean_a184 : yx249317 => by
have lean_s0 : (Or let11 (Or (Not yx24id185x5fop) let6)) := by timed cnfEquivPos1
have lean_s1 : let10 := by timed eqResolve lean_a184 lean_a183
...
have lean_s6 : let17 := by timed eqResolve lean_a182 lean_s5
have lean_s7 : let1 := by timed eqResolve lean_s2 lean_s6
have lean_s8 : (Or let8 yx24prop) := by timed equivElim1 lean_s7
have lean_s9 : (Or let16 let4) := by timed equivElim1 lean_a176
have lean_s10 : let10 := by timed eqResolve lean_a184 lean_a183
have lean_s11 : yx249304 := by andElim lean_s10, 173
have lean_s12 : let16 := by R2 lean_s9, lean_s11, yx249304, [(- 1), 0]
have lean_s13 : let8 := by R1 lean_s8, lean_s12, yx24prop, [(- 1), 0]
have lean_s14 : (Eq let8 yx24id185x5fop) := by timed Eq.symm lean_a181
have lean_s15 : yx24id185x5fop := by timed eqResolve lean_s13 lean_s14
let lean_s16 := by R2 lean_s0, lean_s15, yx24id185x5fop, [(- 1), 0]
have lean_s17 : (Or let12 yx24v3x5f1517448504x5f183x5fop) := by timed @cnfAndPos [yx24111, yx24v3x5f1517448504x5f183x5fop] 1
have lean_s18 : (Or let13 let5) := by timed equivElim1 lean_a179
have lean_s19 : (Or let14 yx24ax5fr4) := by timed @cnfAndPos [yx24ax5fr4, yx24v3x5f1517448504x5f182x5fop] 0
have lean_s20 : (Or let15 let3) := by timed equivElim1 lean_a43
have lean_s21 : let10 := by timed eqResolve lean_a184 lean_a183
have lean_s22 : yx2481 := by andElim lean_s21, 40
have lean_s23 : let15 := by R2 lean_s20, lean_s22, yx2481, [(- 1), 0]
have lean_s24 : let14 := by R1 lean_s19, lean_s23, yx24ax5fr4, [(- 1), 0]
have lean_s25 : let13 := by R1 lean_s18, lean_s24, let5, [(- 1), 0]
have lean_s26 : let12 := by R1 lean_s17, lean_s25, yx24v3x5f1517448504x5f183x5fop, [(- 1), 0]
