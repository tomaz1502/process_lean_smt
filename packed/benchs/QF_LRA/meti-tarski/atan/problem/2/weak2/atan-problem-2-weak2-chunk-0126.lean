...
theorem th0 : (Eq (binrel% GT.gt (Rat.ofInt 1) (Int.ofNat 0)) True) → (Eq (binrel% LT.lt skoT (Rat.ofInt 0)) (Not (binrel% GE.ge skoT (Rat.ofInt 0)))) → (Eq (binrel% GE.ge skoT (Rat.ofInt 0)) (binrel% GE.ge skoT (Int.ofNat 0))) → (Eq (binrel% HMul.hMul (Rat.ofInt 1) skoT) skoT) → (Eq (binrel% HMul.hMul (Rat.ofInt 1) (Rat.ofInt 0)) (Rat.ofInt 0)) → (Eq (binrel% HMul.hMul (Neg.neg (Rat.ofInt 1)) (Rat.ofInt 1)) (Neg.neg (Rat.ofInt 1))) → (Eq (binrel% LE.le skoT (Rat.ofInt 1)) (binrel% GE.ge (binrel% HMul.hMul (Neg.neg (Int.ofNat 1)) skoT) (Neg.neg (Int.ofNat 1)))) → (Eq (binrel% GT.gt skoT (Rat.ofInt 1)) (Not (binrel% LE.le skoT (Rat.ofInt 1)))) → (Eq (Not True) False) → (Eq (binrel% GE.ge (Rat.ofInt 0) (Neg.neg (Rat.ofInt 1))) True) → (Eq (binrel% HMul.hMul skoA (Neg.neg (Rat.ofInt 1))) (binrel% HMul.hMul (Neg.neg (Int.ofNat 1)) skoA)) → (Eq (binrel% LT.lt (binrel% HAdd.hAdd (binrel% HMul.hMul (Rat.ofInt 1) skoT) (binrel% HMul.hMul (Neg.neg (Rat.ofInt 1)) skoT)) (binrel% HAdd.hAdd (binrel% HMul.hMul (Rat.ofInt 1) (Rat.ofInt 0)) (binrel% HMul.hMul (Neg.neg (Rat.ofInt 1)) (Rat.ofInt 1)))) (Not (binrel% GE.ge (binrel% HAdd.hAdd (binrel% HMul.hMul (Rat.ofInt 1) skoT) (binrel% HMul.hMul (Neg.neg (Rat.ofInt 1)) skoT)) (binrel% HAdd.hAdd (binrel% HMul.hMul (Rat.ofInt 1) (Rat.ofInt 0)) (binrel% HMul.hMul (Neg.neg (Rat.ofInt 1)) (Rat.ofInt 1)))))) → (Eq (binrel% LE.le skoB skoT) (binrel% GE.ge (binrel% HAdd.hAdd (binrel% HMul.hMul (Neg.neg (Int.ofNat 1)) skoB) skoT) (Int.ofNat 0))) → (Eq (binrel% HMul.hMul (Neg.neg (Rat.ofInt 1)) skoT) (binrel% HMul.hMul (Neg.neg (Int.ofNat 1)) skoT)) → (Eq (binrel% LE.le skoB skoA) (binrel% GE.ge (binrel% HAdd.hAdd (binrel% HMul.hMul (Neg.neg (Int.ofNat 1)) skoB) skoA) (Int.ofNat 0))) → (Eq (Neg.neg (Rat.ofInt 1)) (Neg.neg (Rat.ofInt 1))) → (Eq (And (Not (binrel% LE.le (Rat.ofInt 0) skoT)) (And (Not (binrel% LE.le skoB skoT)) (And (Not (binrel% LE.le skoB (binrel% HMul.hMul skoA (Neg.neg (Rat.ofInt 1))))) (And (Not (binrel% LE.le skoT (Rat.ofInt 1))) (Not (binrel% LE.le skoB skoA)))))) (And (Not (binrel% LE.le (Rat.ofInt 0) skoT)) (And (Not (binrel% LE.le skoB skoT)) (And (Not (binrel% LE.le skoB (binrel% HMul.hMul skoA (Neg.neg (Rat.ofInt 1))))) (And (Not (binrel% LE.le skoT (Rat.ofInt 1))) (Not (binrel% LE.le skoB skoA))))))) → (Eq (binrel% HAdd.hAdd skoT (binrel% HMul.hMul (Neg.neg (Int.ofNat 1)) skoT)) (Rat.ofInt 0)) → (Eq (Not (Not (binrel% GE.ge (binrel% HMul.hMul (Neg.neg (Int.ofNat 1)) skoT) (Neg.neg (Int.ofNat 1))))) (binrel% GE.ge (binrel% HMul.hMul (Neg.neg (Int.ofNat 1)) skoT) (Neg.neg (Int.ofNat 1)))) → (Eq (binrel% LT.lt (Neg.neg (Rat.ofInt 1)) (Int.ofNat 0)) True) → (Eq (Not (Not (binrel% GE.ge skoT (Int.ofNat 0)))) (binrel% GE.ge skoT (Int.ofNat 0))) → (Eq (binrel% LE.le (Rat.ofInt 0) skoT) (binrel% GE.ge skoT (Int.ofNat 0))) → (Eq (binrel% LE.le skoB (binrel% HMul.hMul (Neg.neg (Int.ofNat 1)) skoA)) (binrel% GE.ge (binrel% HAdd.hAdd (binrel% HMul.hMul (Neg.neg (Int.ofNat 1)) skoB) (binrel% HMul.hMul (Neg.neg (Int.ofNat 1)) skoA)) (Int.ofNat 0))) → (Eq (binrel% HAdd.hAdd (Rat.ofInt 0) (Neg.neg (Rat.ofInt 1))) (Neg.neg (Rat.ofInt 1))) → (And (Not (binrel% LE.le (Rat.ofInt 0) skoT)) (And (Not (binrel% LE.le skoB skoT)) (And (Not (binrel% LE.le skoB (binrel% HMul.hMul skoA (Neg.neg (Rat.ofInt 1))))) (And (Not (binrel% LE.le skoT (Rat.ofInt 1))) (Not (binrel% LE.le skoB skoA)))))) → False :=
...
fun lean_r12 : (Eq (binrel% LE.le skoB skoT) (binrel% GE.ge (binrel% HAdd.hAdd (binrel% HMul.hMul (Neg.neg (Int.ofNat 1)) skoB) skoT) (Int.ofNat 0))) => -- THEORY_REWRITE_ARITH
...
fun lean_a24 : (And (Not (binrel% LE.le (Rat.ofInt 0) skoT)) (And (Not (binrel% LE.le skoB skoT)) (And (Not (binrel% LE.le skoB (binrel% HMul.hMul skoA (Neg.neg (Rat.ofInt 1))))) (And (Not (binrel% LE.le skoT (Rat.ofInt 1))) (Not (binrel% LE.le skoB skoA)))))) => by
...
have lean_s9 : (Eq (Not (binrel% LE.le skoB skoT)) (Not (binrel% GE.ge (binrel% HAdd.hAdd (binrel% HMul.hMul (Neg.neg (Int.ofNat 1)) skoB) skoT) (Int.ofNat 0)))) := by timed flipCongrArg lean_r12 [Not]
...
have lean_s27 : (Eq (And (Not (binrel% LE.le (Rat.ofInt 0) skoT)) (And (Not (binrel% LE.le skoB skoT)) (And (Not (binrel% LE.le skoB (binrel% HMul.hMul skoA (Neg.neg (Rat.ofInt 1))))) (And (Not (binrel% LE.le skoT (Rat.ofInt 1))) (Not (binrel% LE.le skoB skoA)))))) (And (Not (binrel% GE.ge skoT (Int.ofNat 0))) (And (Not (binrel% GE.ge (binrel% HAdd.hAdd (binrel% HMul.hMul (Neg.neg (Int.ofNat 1)) skoB) skoT) (Int.ofNat 0))) (And (Not (binrel% GE.ge (binrel% HAdd.hAdd (binrel% HMul.hMul (Neg.neg (Int.ofNat 1)) skoB) (binrel% HMul.hMul (Neg.neg (Int.ofNat 1)) skoA)) (Int.ofNat 0))) (And (Not (binrel% GE.ge (binrel% HMul.hMul (Neg.neg (Int.ofNat 1)) skoT) (Neg.neg (Int.ofNat 1)))) (Not (binrel% GE.ge (binrel% HAdd.hAdd (binrel% HMul.hMul (Neg.neg (Int.ofNat 1)) skoB) skoA) (Int.ofNat 0)))))))) := by timed congr lean_s8 lean_s26
have lean_s28 : (Eq (And (Not (binrel% LE.le (Rat.ofInt 0) skoT)) (And (Not (binrel% LE.le skoB skoT)) (And (Not (binrel% LE.le skoB (binrel% HMul.hMul skoA (Neg.neg (Rat.ofInt 1))))) (And (Not (binrel% LE.le skoT (Rat.ofInt 1))) (Not (binrel% LE.le skoB skoA)))))) (And (Not (binrel% GE.ge skoT (Int.ofNat 0))) (And (Not (binrel% GE.ge (binrel% HAdd.hAdd (binrel% HMul.hMul (Neg.neg (Int.ofNat 1)) skoB) skoT) (Int.ofNat 0))) (And (Not (binrel% GE.ge (binrel% HAdd.hAdd (binrel% HMul.hMul (Neg.neg (Int.ofNat 1)) skoB) (binrel% HMul.hMul (Neg.neg (Int.ofNat 1)) skoA)) (Int.ofNat 0))) (And (Not (binrel% GE.ge (binrel% HMul.hMul (Neg.neg (Int.ofNat 1)) skoT) (Neg.neg (Int.ofNat 1)))) (Not (binrel% GE.ge (binrel% HAdd.hAdd (binrel% HMul.hMul (Neg.neg (Int.ofNat 1)) skoB) skoA) (Int.ofNat 0)))))))) := by timed Eq.trans lean_r16 lean_s27
