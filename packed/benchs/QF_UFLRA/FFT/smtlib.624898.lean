...
theorem th0 : (Eq (Neg.neg (Rat.ofInt 1)) (Neg.neg (Rat.ofInt 1))) → (Eq (Not (Not (Eq (f3 f4) (Rat.ofInt 1)))) (Eq (f3 f4) (Rat.ofInt 1))) → (Eq (Eq (Neg.neg (Rat.ofInt 1)) (Rat.ofInt 1)) False) → (Not (Eq f1 f2)) → (Not (Not (Eq (f3 f4) (Rat.ofInt 1)))) → (Eq f4 f5) → (Eq (f3 f5) (Neg.neg (Rat.ofInt 1))) → False :=
...
fun lean_a6 : (Eq (f3 f5) (Neg.neg (Rat.ofInt 1))) => by
have lean_s0 : (Eq (f3 f4) (f3 f5)) := by timed flipCongrArg lean_a5 [f3]
...
have lean_s8 : (Eq (f3 f5) (Neg.neg (Rat.ofInt 1))) := by timed eqResolve lean_a6 lean_s7
