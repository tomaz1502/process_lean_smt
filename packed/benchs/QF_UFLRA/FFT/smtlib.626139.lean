...
fun lean_a11 : (binrel% LT.lt f4 f3) => by
...
have lean_s15 : (Not (binrel% GE.ge (binrel% HAdd.hAdd (binrel% HMul.hMul (Neg.neg (Int.ofNat 1)) f3) f4) (Int.ofNat 0))) := by timed eqResolve lean_a11 lean_s14
