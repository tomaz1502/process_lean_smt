...
theorem th0 : x5f993 → x5f2 → (Eq x5f7 (Rat.ofInt 0)) → (Eq x5f541 mainx3ax3aldvx5fsx5fpcapx5fkeysx5fdevicex5fdriverx5fplatformx5fdriverx401) → (Eq x5f542 (Eq x5f541 x5f7)) → (Eq x5f991 ldvx5fspinx401) → (Eq x5f992 (Eq x5f991 x5f7)) → (Eq x5f993 (And x5f542 x5f992)) → (Eq x5f2 False) → False :=
fun lean_a0 : x5f993 =>
fun lean_a1 : x5f2 =>
