...
theorem th0 : x5f537 → x5f2 → (Eq x5f7 (Rat.ofInt 0)) → (Eq x5f299 mainx3ax3aldvx5fsx5fab8500x5fponkeyx5fdriverx5fplatformx5fdriverx401) → (Eq x5f300 (Eq x5f299 x5f7)) → (Eq x5f535 ldvx5fspinx401) → (Eq x5f536 (Eq x5f535 x5f7)) → (Eq x5f537 (And x5f300 x5f536)) → (Eq x5f2 False) → False :=
fun lean_a0 : x5f537 =>
fun lean_a1 : x5f2 =>
