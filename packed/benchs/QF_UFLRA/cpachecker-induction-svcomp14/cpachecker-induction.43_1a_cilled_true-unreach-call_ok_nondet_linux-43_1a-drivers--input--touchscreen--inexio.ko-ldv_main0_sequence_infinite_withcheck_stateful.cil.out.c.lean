...
theorem th0 : x5f3127 → x5f2 → (Eq x5f7 (Rat.ofInt 0)) → (Eq x5f111 (Rat.ofInt 1)) → (Eq x5f1412 mainx3ax3aldvx5fsx5finexiox5fdrvx5fseriox5fdriverx401) → (Eq x5f3113 (binrel% LE.le x5f1412 x5f111)) → (Eq x5f3114 (binrel% LE.le x5f7 x5f1412)) → (Eq x5f3115 (And x5f3113 x5f3114)) → (Eq x5f3116 mainx3ax3atmpx401) → (Eq x5f3117 (Eq x5f3116 x5f7)) → (Eq x5f3118 inexiox5finitx3ax3atmpx401) → (Eq x5f3119 (Eq x5f3118 x5f7)) → (Eq x5f3120 inexiox5finitx3ax3ax5fx5fx5fcpax5ftempx5fresultx5fvarx5fx401) → (Eq x5f3121 (Eq x5f3120 x5f7)) → (Eq x5f3122 ldvx5fspinx401) → (Eq x5f3123 (Eq x5f3122 x5f7)) → (Eq x5f3124 (And x5f3121 x5f3123)) → (Eq x5f3125 (And x5f3119 x5f3124)) → (Eq x5f3126 (And x5f3117 x5f3125)) → (Eq x5f3127 (And x5f3115 x5f3126)) → (Eq x5f2 False) → False :=
fun lean_a0 : x5f3127 =>
fun lean_a1 : x5f2 =>
