...
theorem th0 : x5f182 → x5f2 → (Eq x5f7 (Rat.ofInt 0)) → (Eq x5f140 gcdx5ftestx3ax3abx401) → (Eq x5f144 gcdx5ftestx3ax3aax401) → (Eq x5f180 (binrel% LE.le x5f7 x5f144)) → (Eq x5f181 (binrel% LE.le x5f7 x5f140)) → (Eq x5f182 (And x5f180 x5f181)) → (Eq x5f2 False) → False :=
fun lean_a0 : x5f182 =>
fun lean_a1 : x5f2 =>
