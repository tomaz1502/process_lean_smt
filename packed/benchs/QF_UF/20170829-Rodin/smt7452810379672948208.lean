...
theorem th0 : circuit → rd2 → redx5fMR → (Or grnx5fSR orgx5fSR) → (Implies grn (And (Not org) (And (Not rd1) (Not rd2)))) → (Implies org (And (Not rd1) (Not rd2))) → (Implies rd1 (Not rd2)) → (Eq grnx5fMR grn) → (Eq orgx5fMR org) → (Eq grnx5fSR rd1) → (Eq orgx5fSR rd2) → (Eq redx5fSR (Or grn org)) → (Not (Eq org (And prt grn))) → False :=
fun lean_a0 : circuit =>
fun lean_a1 : rd2 =>
...
fun lean_a12 : (Not (Eq org (And prt grn))) => by
have lean_s0 : (Or (Eq org (And prt grn)) (Or org (And prt grn))) := by timed cnfEquivNeg1
have lean_s1 : (Or (Not org) (And (Not rd1) (Not rd2))) := by timed impliesElim lean_a5
have lean_s2 : (Or (Not (And (Not rd1) (Not rd2))) (Not rd2)) := by timed @cnfAndPos [(Not rd1), (Not rd2)] 1
have lean_s3 : (Not (And (Not rd1) (Not rd2))) := by R2 lean_s2, lean_a1, rd2, [(- 1), 0]
...
have lean_s7 : (Or (Not grn) (And (Not org) (And (Not rd1) (Not rd2)))) := by timed impliesElim lean_a4
have lean_s8 : (Or (Not (And (Not org) (And (Not rd1) (Not rd2)))) (Not rd2)) := by timed @cnfAndPos [(Not org), (Not rd1), (Not rd2)] 2
have lean_s9 : (Not (And (Not org) (And (Not rd1) (Not rd2)))) := by R2 lean_s8, lean_a1, rd2, [(- 1), 0]
