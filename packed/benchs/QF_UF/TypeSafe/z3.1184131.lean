...
theorem th0 : (Eq (Eq (f3 f4 f5 f6 f7 (f8 f9)) (f3 f4 f5 f6 f7 (f8 f9))) True) → (Eq (Not True) False) → (Not (Eq f1 f2)) → (Not (Eq (f3 f4 f5 f6 f7 (f8 f9)) f1)) → (Eq (f3 f4 f5 f6 f7 f10) f1) → (Eq f10 (f8 f9)) → (Eq f10 (f8 f9)) → (Eq (f3 f4 f5 f6 f7 f10) f1) → False :=
...
fun lean_a5 : (Eq f10 (f8 f9)) =>
fun lean_a6 : (Eq f10 (f8 f9)) =>
fun lean_a7 : (Eq (f3 f4 f5 f6 f7 f10) f1) => by
have lean_s0 : (Not (Eq f1 (f3 f4 f5 f6 f7 (f8 f9)))) := by timed negSymm lean_a3
have lean_s1 : (Eq f1 (f3 f4 f5 f6 f7 f10)) := by timed Eq.symm lean_a7
have lean_s2 : (And (Eq f10 (f8 f9)) (Eq f1 (f3 f4 f5 f6 f7 f10))) := by timed And.intro lean_a6 lean_s1
