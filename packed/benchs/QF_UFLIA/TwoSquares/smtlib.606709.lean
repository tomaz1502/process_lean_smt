...
theorem th0 : (Eq (binrel% LT.lt (Int.ofNat 2) (binrel% HAdd.hAdd (binrel% HMul.hMul (Int.ofNat 4) f3) (Int.ofNat 1))) (Not (binrel% GE.ge (Int.ofNat 2) (binrel% HAdd.hAdd (binrel% HMul.hMul (Int.ofNat 4) f3) (Int.ofNat 1))))) → (Eq (binrel% HAdd.hAdd (binrel% HMul.hMul (Int.ofNat 4) f3) (Int.ofNat 1)) (binrel% HAdd.hAdd (Int.ofNat 1) (binrel% HMul.hMul (Int.ofNat 4) f3))) → (Eq (binrel% GE.ge (Int.ofNat 2) (binrel% HAdd.hAdd (Int.ofNat 1) (binrel% HMul.hMul (Int.ofNat 4) f3))) (Not (binrel% GE.ge f3 (Int.ofNat 1)))) → (Eq (binrel% LE.le (Int.ofNat 1) f3) (binrel% GE.ge f3 (Int.ofNat 1))) → (Eq (Not (Not (binrel% GE.ge f3 (Int.ofNat 1)))) (binrel% GE.ge f3 (Int.ofNat 1))) → (Not (Eq f1 f2)) → (Not (binrel% LT.lt (Int.ofNat 2) (binrel% HAdd.hAdd (binrel% HMul.hMul (Int.ofNat 4) f3) (Int.ofNat 1)))) → (binrel% LE.le (Int.ofNat 1) f3) → False :=
...
fun lean_a7 : (binrel% LE.le (Int.ofNat 1) f3) => by
have lean_s0 : (binrel% GE.ge f3 (Int.ofNat 1)) := by timed eqResolve lean_a7 lean_r3
