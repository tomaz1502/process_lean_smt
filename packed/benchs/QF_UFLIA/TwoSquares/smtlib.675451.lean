...
fun lean_a14 : (And (binrel% LE.le (Int.ofNat 0) f3) (And (binrel% LT.lt f3 (binrel% HAdd.hAdd (binrel% HMul.hMul (Int.ofNat 4) f4) (Int.ofNat 1))) (Eq (f5 f6 f3 (binrel% HAdd.hAdd (binrel% HMul.hMul (Int.ofNat 4) f4) (Int.ofNat 1))) f1))) =>
fun lean_a15 : (And (binrel% LE.le (Int.ofNat 0) f3) (And (binrel% LT.lt f3 (binrel% HAdd.hAdd (binrel% HMul.hMul (Int.ofNat 4) f4) (Int.ofNat 1))) (Eq (f5 f6 f3 (binrel% HAdd.hAdd (binrel% HMul.hMul (Int.ofNat 4) f4) (Int.ofNat 1))) f1))) => by
...
have lean_s33 : (And (binrel% GE.ge f3 (Int.ofNat 0)) (And (Not (binrel% GE.ge (binrel% HAdd.hAdd f3 (binrel% HMul.hMul (Neg.neg (Int.ofNat 4)) f4)) (Int.ofNat 1))) (Eq f1 (f5 f6 f3 (binrel% HAdd.hAdd (Int.ofNat 1) (binrel% HMul.hMul (Int.ofNat 4) f4)))))) := by timed eqResolve lean_a15 lean_s32
