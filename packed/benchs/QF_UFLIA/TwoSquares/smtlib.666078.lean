...
fun lean_a12 : (Not (binrel% LT.lt f4 (binrel% HAdd.hAdd (binrel% HMul.hMul (Int.ofNat 4) f3) (Int.ofNat 1)))) =>
fun lean_a13 : (Not (binrel% LT.lt f4 (binrel% HAdd.hAdd (binrel% HMul.hMul (Int.ofNat 4) f3) (Int.ofNat 1)))) => by
...
have lean_s23 : (Not (binrel% GE.ge (binrel% HAdd.hAdd (binrel% HMul.hMul (Int.ofNat 4) f3) (binrel% HMul.hMul (Neg.neg (Int.ofNat 1)) f4)) (Int.ofNat 0))) := by timed eqResolve lean_a13 lean_s22
