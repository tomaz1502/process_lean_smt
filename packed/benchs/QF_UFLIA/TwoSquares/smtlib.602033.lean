...
theorem th0 : (Eq (binrel% HAdd.hAdd (binrel% HMul.hMul (Int.ofNat 4) f3) (Int.ofNat 1)) (binrel% HAdd.hAdd (Int.ofNat 1) (binrel% HMul.hMul (Int.ofNat 4) f3))) → (Eq (binrel% LE.le (binrel% HAdd.hAdd (Int.ofNat 1) (binrel% HMul.hMul (Int.ofNat 4) f3)) (Int.ofNat 1)) (Not (binrel% GE.ge f3 (Int.ofNat 1)))) → (Eq (Not (Not (binrel% GE.ge f3 (Int.ofNat 1)))) (binrel% GE.ge f3 (Int.ofNat 1))) → (Eq (binrel% LE.le f3 (Int.ofNat 0)) (Not (binrel% GE.ge f3 (Int.ofNat 1)))) → (Not (Eq f1 f2)) → (Not (binrel% LE.le (binrel% HAdd.hAdd (binrel% HMul.hMul (Int.ofNat 4) f3) (Int.ofNat 1)) (Int.ofNat 1))) → (binrel% LE.le f3 (Int.ofNat 0)) → (binrel% LE.le f3 (Int.ofNat 0)) → False :=
...
fun lean_a6 : (binrel% LE.le f3 (Int.ofNat 0)) =>
fun lean_a7 : (binrel% LE.le f3 (Int.ofNat 0)) => by
...
have lean_s7 : (Not (binrel% GE.ge f3 (Int.ofNat 1))) := by timed eqResolve lean_a7 lean_r3
